...
--- @class TestMultipositionSwitchWithCycle
--- @field module Module
TestMultipositionSwitchWithCycle = {}
local moduleName = "MyModule"
local moduleAddress = 0x4200

function TestMultipositionSwitchWithCycle:setUp()
	self.module = Module:new(moduleName, moduleAddress, {})
	Input_Processor_Device = MockDevice:new(0)
end

local id = "MY_MULTIPOSITION_SWITCH_WITH_CYCLE"
local device_id = 1
local command = 2
local arg_number = 3
local num_positions = 5
local increment = 0.1
local category = "Cycling Multiposition Switches"
local description = "This is a multiposition switch which cycles"

function TestMultipositionSwitchWithCycle:testAddMultipositionSwitch()
...
function TestMultipositionSwitchWithCycle:testValue()
	self.module:defineMultipositionSwitchWithCycle(id, device_id, command, arg_number, num_positions, increment, true, category, description)
...
function TestMultipositionSwitchWithCycle:testInputInc()
	self.module:defineMultipositionSwitchWithCycle(id, device_id, command, arg_number, num_positions, increment, true, category, description)
...
function TestMultipositionSwitchWithCycle:testInputIncOverflow()
	self.module:defineMultipositionSwitchWithCycle(id, device_id, command, arg_number, num_positions, increment, true, category, description)
	local input_processor = self.module.inputProcessors[id]
...
function TestMultipositionSwitchWithCycle:testInputDec()
	self.module:defineMultipositionSwitchWithCycle(id, device_id, command, arg_number, num_positions, increment, true, category, description)
	local input_processor = self.module.inputProcessors[id]
...
function TestMultipositionSwitchWithCycle:testInputDecOverflow()
	self.module:defineMultipositionSwitchWithCycle(id, device_id, command, arg_number, num_positions, increment, true, category, description)
	local input_processor = self.module.inputProcessors[id]
...
function TestMultipositionSwitchWithCycle:testInputN()
	self.module:defineMultipositionSwitchWithCycle(id, device_id, command, arg_number, num_positions, increment, true, category, description)
	local input_processor = self.module.inputProcessors[id]
