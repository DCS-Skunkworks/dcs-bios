...
--- @class TestRotaryWithRange
--- @field module Module
TestRotaryWithRange = {}
local moduleName = "MyModule"
local moduleAddress = 0x4200

function TestRotaryWithRange:setUp()
...
function TestRotaryWithRange:testAddRotary()
	local control = self.module:defineRotaryWithRange(id, device_id, command, arg_number, limits, category, description)
...
function TestRotaryWithRange:testRotaryValue()
	self.module:defineRotaryWithRange(id, device_id, command, arg_number, limits, category, description)
...
function TestRotaryWithRange:testInputVariableStepPositive()
	self.module:defineRotaryWithRange(id, device_id, command, arg_number, limits, category, description)
	...
	lu.assertAlmostEquals(action[command], 6400 / 65535)
end

function TestRotaryWithRange:testInputVariableStepPositiveOverflow()
	self.module:defineRotaryWithRange(id, device_id, command, arg_number, limits, category, description)
...
function TestRotaryWithRange:testInputVariableStepNegative()
	self.module:defineRotaryWithRange(id, device_id, command, arg_number, limits, category, description)
...
function TestRotaryWithRange:testInputVariableStepNegativeOverflow()
	self.module:defineRotaryWithRange(id, device_id, command, arg_number, limits, category, description)
