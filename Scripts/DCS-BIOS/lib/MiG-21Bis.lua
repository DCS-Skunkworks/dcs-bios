...
--Warning Lights
defineIndicatorLight("CAN_WARN_LIGHT", 541, "Canopy Frame", "Canopy Warning Light (red)")
defineIndicatorLight("MASTER_CAUTION", 542, "Flight Status/Navigation Panel", "Master Caution/SORC Light (red)")
...
defineIndicatorLight("CHK_GEAR_LIGHT", 520, "Landing Gear Control", "Check Gear Light (yellow)")
defineIndicatorLight("FLAPS_LIGHT", 521, "Landing Gear Control", "Flaps Light (green)")
defineIndicatorLight("AIRBRK_LIGHT", 522, "Landing Gear Control", "Airbrakes Light (green)")
defineIndicatorLight("CENT_PYL_LIGHT", 523, "Center Pedestal Panel", "Central Pylon Light (green)")
defineIndicatorLight("RATO_L_LIGHT", 524, "Center Pedestal Panel", "RATO Left Light (green)")
defineIndicatorLight("RATO_R_LIGHT", 525, "Center Pedestal Panel", "RATO Right Light (green)")
defineIndicatorLight("PYL1_LIGHT", 526, "Center Pedestal Panel", "Pylon 1 On Light (green)")
defineIndicatorLight("PYL2_LIGHT", 527, "Center Pedestal Panel", "Pylon 2 On Light (green)")
defineIndicatorLight("PYL3_LIGHT", 528, "Center Pedestal Panel", "Pylon 3 On Light (green)")
defineIndicatorLight("PYL4_LIGHT", 529, "Center Pedestal Panel", "Pylon 4 On Light (green)")
defineIndicatorLight("PYL1_OFF_LIGHT", 530, "Center Pedestal Panel", "Pylon 1 Off Light (green)")
defineIndicatorLight("PYL2_OFF_LIGHT", 531, "Center Pedestal Panel", "Pylon 2 Off Light (green)")
defineIndicatorLight("PYL3_OFF_LIGHT", 532, "Center Pedestal Panel", "Pylon 3 Off Light (green)")
defineIndicatorLight("PYL4_OFF_LIGHT", 533, "Center Pedestal Panel", "Pylon 4 Off Light (green)")

--Gyro Devices
defineIndicatorLight("GYRO_RST_LIGHT", 536, "Engine Status Panel", "Gyro Reset Light (red)")

--ASP/RADAR/fire control systems
defineIndicatorLight("ASP_LOCK_LIGHT", 539, "ASP Gunsight", "ASP Lock Light (green)")
defineIndicatorLight("ASP_LNCH", 538, "ASP Gunsight", "ASP Launch Light (red)")
defineIndicatorLight("ASP_BRK", 540, "ASP Gunsight", "ASP Break Attack Light (red)")
...
defineIndicatorLight("RADAR_ERR", 553, "RADAR Power", "Radar Error Light (red)")
defineIndicatorLight("RADAR_LOW_LIGHT", 554, "RADAR Power", "Radar Low Light (green)")
defineIndicatorLight("RADAR_FIX_BM_LIGHT", 555, "RADAR Power", "Radar Fixed Beam Light (green)")
defineIndicatorLight("RADAR_LNCH", 558, "RADAR Scope, Interrupts", "Radar Launch Light (red)")
defineIndicatorLight("MSL_HEAD_RDY", 559, "RADAR Scope, Interrupts", "Missile Head Ready Light (red)")
defineIndicatorLight("RADAR_JMD", 560, "RADAR Scope, Interrupts", "Radar Jammed Light (red)")
defineIndicatorLight("RADAR_BRKN", 561, "RADAR Scope, Interrupts", "Radar Broken Light (red)")
defineIndicatorLight("RADAR_DENG", 562, "RADAR Scope, Interrupts", "Radar Disengage Light (red)")
defineIndicatorLight("RADAR_19A_1", 571, "RADAR Scope, Interrupts", "Radar Continuous Interferes Light (red)")
defineIndicatorLight("RADAR_19A_2", 572, "RADAR Scope, Interrupts", "Radar Temporary Interferes Light (red)")
defineIndicatorLight("RADAR_19A_3", 573, "RADAR Scope, Interrupts", "Radar Passive Interferes Light (red)")
defineIndicatorLight("RADAR_19A_4", 574, "RADAR Scope, Interrupts", "Radar Weather Interferes Light (red)")
defineIndicatorLight("RADAR_19A_5", 575, "RADAR Scope, Interrupts", "Radar IFF Light (red)")
defineIndicatorLight("RADAR_19A_6", 576, "RADAR Scope, Interrupts", "Radar Low Speed Light (red)")
defineIndicatorLight("RADAR_19A_7", 577, "RADAR Scope, Interrupts", "Radar Self-Test Light (red)")
defineIndicatorLight("RADAR_19A_8", 578, "RADAR Scope, Interrupts", "Radar Reset Light (red)")
...
defineIndicatorLight("TAC_DRP_ARM", 63, "Center Pedestal Panel", "Tactical Drop Armed (red)")
defineIndicatorLight("SPS_RDY", 592, "SPS-141-100 Panel", "SPS 141-100 Ready (green)")
defineIndicatorLight("SPS_ILL", 593, "SPS-141-100 Panel", "SPS 141-100 Illuminated (red)")
defineIndicatorLight("SPS_LNCH", 594, "SPS-141-100 Panel", "SPS 141-100 Countermeasures Ready/Launching (green)")
defineIndicatorLight("GUV_PWR_LGHT", 701, "UPK-23-250-2 Panel", "UPK-23-250-2 On Light (green)")
...
--SPO Lights
defineIndicatorLight("SPO_LF", 601, "SPO RWR", "SPO RWR Left Front Light (yellow)")
defineIndicatorLight("SPO_RF", 602, "SPO RWR", "SPO RWR Right Front Light (yellow)")
defineIndicatorLight("SPO_RB", 603, "SPO RWR", "SPO RWR Right Rear Light (yellow)")
defineIndicatorLight("SPO_LB", 604, "SPO RWR", "SPO RWR Left Rear Light (yellow)")
defineIndicatorLight("SPO_MUTE", 605, "SPO RWR", "SPO RWR Mute Light (red)")

--SOD
defineIndicatorLight("SOD_ANS", 606, "SPO RWR", "SOD Answer Light (yellow)")

--SRZO
defineIndicatorLight("SRZO_PWR_LGHT", 607, "Avionics Power Panel", "SRZO Power Light (green)")
defineIndicatorLight("SRZO_CODE_L", 608, "Avionics Power Panel", "SRZO Code Light (green)")
defineIndicatorLight("SRZO_CIPH_L", 609, "Avionics Power Panel", "SRZO Cipher Light (green)")
defineIndicatorLight("SRZO_ERR_L", 611, "SRZO/Fuse Panel", "SOD Error Light (red)")
...
defineFloat("WHT_PAN_INT", 620, {0, 1}, "Backlighting", "White Panel Light Intensity (white)")
