...
defineIndicatorLight("WAL_RALT_HOLD", 170, "Warning and Advisory Lamps", "R-ALT hold (green)")
defineIndicatorLight("WAL_AUTO_HOVER", 175, "Warning and Advisory Lamps", "Auto hover (green)")
defineIndicatorLight("WAL_AUTO_DESCENT", 172, "Warning and Advisory Lamps", "Auto descent (green)")
defineIndicatorLight("WAL_ENR_NAV", 165, "Warning and Advisory Lamps", "Route heading steering (green)")
defineIndicatorLight("WAL_ENR_COURSE", 171, "Warning and Advisory Lamps", "Route course steering (green)")
defineIndicatorLight("WAL_NEXT_WPT", 176, "Warning and Advisory Lamps", "Next waypoint (green)")
defineIndicatorLight("WAL_ENR_END", 166, "Warning and Advisory Lamps", "End of route (green)")
defineIndicatorLight("WAL_NAV_CALC", 164, "Warning and Advisory Lamps", "Rough NAV calc (green)")
defineIndicatorLight("WAL_WEAPONS_ARM", 178, "Warning and Advisory Lamps", "Weapons armed (red)")
defineIndicatorLight("WAL_CANNON", 173, "Warning and Advisory Lamps", "Cannon away from boresight (green)")
defineIndicatorLight("WAL_CANNON2", 177, "Warning and Advisory Lamps", "Cannon downward away from boresight (green)")
defineIndicatorLight("WAL_XFEED_VLV_OPEN", 211, "Warning and Advisory Lamps", "Fuel crossfeed ON (green)")
defineIndicatorLight("WAL_TURBO_GEARBOX_OFF", 187, "Warning and Advisory Lamps", "Gearbox disconnected (green)")
defineIndicatorLight("WAL_GEARBOX_OIL_PRESS", 204, "Warning and Advisory Lamps", "Gearbox oil pressure normal (green)")
defineIndicatorLight("WAL_SLING_OPEN", 213, "Warning and Advisory Lamps", "Sling load lock (hook) is open (green)")
--Message Lamps
defineIndicatorLight("ML_MASTER_ARM", 167, "Message Lamps", "Master ARM is ON (green)")
defineIndicatorLight("ML_WEAPONS_TRAIN", 180, "Message Lamps", "Training mode is ON (green)")
defineIndicatorLight("ML_HMS_FAIL", 179, "Message Lamps", "Helmet-Mounted sight mailfunction (yellow)")
defineIndicatorLight("ML_HUD_NOT_READY", 188, "Message Lamps", "HUD failure or not ready (yellow)")
defineIndicatorLight("ML_COMPUTER_DIAG", 189, "Message Lamps", "Computers in diagnostic mode (yellow)")
defineIndicatorLight("ML_COMPUTER_FAIL", 206, "Message Lamps", "Computer(s) failure (yellow)")
defineIndicatorLight("ML_INVERTER", 212, "Message Lamps", "DC/AC inverter is ON (green)")
defineIndicatorLight("ML_SHKVAL_FAIL", 205, "Message Lamps", "SHKVAL failure (yellow)")
defineIndicatorLight("ML_L_ENG_ANTIICE", 181, "Message Lamps", "Left engine de-icing (green)")
defineIndicatorLight("ML_L_ENG_DUST", 190, "Message Lamps", "Left engine dust protector (green)")
defineIndicatorLight("ML_L_ENG_POWER_LIMIT", 207, "Message Lamps", "Left engine limited by governor (yellow)")
defineIndicatorLight("ML_ROTOR_ANTIICE", 183, "Message Lamps", "Rotor de-icing (green)")
defineIndicatorLight("ML_R_ENG_ANTIICE", 182, "Message Lamps", "Right engine deicing (green)")
defineIndicatorLight("ML_R_ENG_DUST", 191, "Message Lamps", "Right engine dust protector (green)")
defineIndicatorLight("ML_R_ENG_POWER_LIMIT", 208, "Message Lamps", "Right engine limited by governor (yellow)")
defineIndicatorLight("ML_WINDSHIELD_HEAT", 184, "Message Lamps", "Windshield heater is ON (green)")
defineIndicatorLight("ML_FWD_TANK_PUMP", 200, "Message Lamps", "Forward fuel pump ON (green)")
defineIndicatorLight("ML_L_ENG_VLV_CLOSED", 209, "Message Lamps", "Left engine fuel valve is closed (yellow)")
defineIndicatorLight("ML_L_OUTER_TANK_PUMP", 185, "Message Lamps", "Left outer fuel tank pump is ON (green)")
defineIndicatorLight("ML_L_INNER_TANK_PUMP", 202, "Message Lamps", "Left inner fuel tank pump is ON (green)")
defineIndicatorLight("ML_AFT_TANK_PUMP", 201, "Message Lamps", "Aft fuel tank pump is ON (green)")
defineIndicatorLight("ML_R_ENG_VLV_CLOSED", 210, "Message Lamps", "Right engine fuel valve is closed (yellow)")
defineIndicatorLight("ML_R_OUTER_TANK_PUMP", 186, "Message Lamps", "Right outer fuel tank pump is ON (green)")
defineIndicatorLight("ML_R_INNER_TANK_PUMP", 203, "Message Lamps", "Right inner fuel tank pump is ON (green)")
--PRTz Data Link Control Panel
defineLedPushButton("DLNK_SEND_BTN", 25, 3001, 159, "Datalink Control Panel", "Send/Memory button")
definePushButtonLed("DLNK_SEND_LED", 159, "Datalink Control Panel", "Send/Memory LED (yellow)")
defineLedPushButton("DLNK_ESCAPE_BTN", 25, 3002, 150, "Datalink Control Panel", "Ingress to target button")
definePushButtonLed("DLNK_ESCAPE_LED", 150, "Datalink Control Panel", "Ingress to target LED (yellow)")
defineLedPushButton("DLNK_ERASE_BTN", 25, 3003, 161, "Datalink Control Panel", "Erase button")
definePushButtonLed("DLNK_ERASE_LED", 161, "Datalink Control Panel", "Erase LED (yellow)")
defineLedPushButton("DLNK_CLEAN_BTN", 25, 3004, 15, "Datalink Control Panel", "N/A button")
definePushButtonLed("DLNK_CLEAN_LED", 15, "Datalink Control Panel", "N/A LED (green)")
defineLedPushButton("DLNK_WINGMAN_ALL_BTN", 25, 3005, 16, "Datalink Control Panel", "To aLL button")
definePushButtonLed("DLNK_WINGMAN_ALL_LED", 16, "Datalink Control Panel", "To all LED (green)")
defineLedPushButton("DLNK_WINGMAN_1_BTN", 25, 3006, 17, "Datalink Control Panel", "To wingman 1 button")
definePushButtonLed("DLNK_WINGMAN_1_LED", 17, "Datalink Control Panel", "To wingman 1 LED (green)")
defineLedPushButton("DLNK_WINGMAN_2_BTN", 25, 3007, 18, "Datalink Control Panel", "To wingman 2 button")
definePushButtonLed("DLNK_WINGMAN_2_LED", 18, "Datalink Control Panel", "To wingman 2 LED (green)")
defineLedPushButton("DLNK_WINGMAN_3_BTN", 25, 3008, 19, "Datalink Control Panel", "To wingman 3 button")
definePushButtonLed("DLNK_WINGMAN_3_LED", 19, "Datalink Control Panel", "To wingman 3 LED (green)")
defineLedPushButton("DLNK_WINGMAN_4_BTN", 25, 3009, 20, "Datalink Control Panel", "To wingman 4 button")
definePushButtonLed("DLNK_WINGMAN_4_LED", 20, "Datalink Control Panel", "To wingman 4 LED (green)")
defineLedPushButton("DLNK_TARGET_VEHICLE_BTN", 25, 3010, 21, "Datalink Control Panel", "Target #1/Vehicle button")
definePushButtonLed("DLNK_TARGET_VEHICLE_LED", 21, "Datalink Control Panel", "Target #1/Vehicle LED (green)")
defineLedPushButton("DLNK_TARGET_SAM_BTN", 25, 3011, 22, "Datalink Control Panel", "Target #2/SAM button")
definePushButtonLed("DLNK_TARGET_SAM_LED", 22, "Datalink Control Panel", "Target #2/SAM LED (green)")
defineLedPushButton("DLNK_TARGET_OTHER_BTN", 25, 3012, 23, "Datalink Control Panel", "Target #3/Other type button")
definePushButtonLed("DLNK_TARGET_OTHER_LED", 23, "Datalink Control Panel", "Target #3/Other type LED (green)")
defineLedPushButton("DLNK_TARGET_POINT_BTN", 25, 3013, 50, "Datalink Control Panel", "Ingress point button")
definePushButtonLed("DLNK_TARGET_POINT_LED", 50, "Datalink Control Panel", "Ingress point LED (green)")
--Laser Warning Receiver
defineIndicatorLight("LWR_AZI_0", 25, "LWR", "Lamp azimuth 0 (red)")
defineIndicatorLight("LWR_AZI_90", 28, "LWR", "Lamp azimuth 90 (red)")
defineIndicatorLight("LWR_AZI_180", 26, "LWR", "Lamp azimuth 180 (red)")
defineIndicatorLight("LWR_AZI_270", 27, "LWR", "Lamp azimuth 270 (red)")
defineIndicatorLight("LWR_HEMI_UPPER", 31, "LWR", "Lamp hemisphere Upper (yellow)")
...
defineIndicatorLight("UV26_L_DISPENSER", 541, "UV-26 Control Panel", "Left dispenser Light (red)")
...
defineToggleSwitch("SC_ODS_MODE", 64, 3001, 49, "System Controller", "ODS Operation Mode Switch")
--Caution Lights Panel
defineIndicatorLight("CL_LASER_WARN", 47, "Caution Lights Panel", "Under fire warning (red)")
defineIndicatorLight("CL_EXTEND_GEAR", 48, "Caution Lights Panel", "Extend landing Gear (red)")
defineIndicatorLight("CL_L_ENG_OVERSPEED", 78, "Caution Lights Panel", "Left engine power turbine over-speed (red)")
defineIndicatorLight("CL_R_ENG_OVERSPEED", 79, "Caution Lights Panel", "Right engine power turbine over-speed (red)")
defineIndicatorLight("CL_OVER_G", 80, "Caution Lights Panel", "G over-limit (red)")
defineIndicatorLight("CL_L_ENG_VIBRATION", 81, "Caution Lights Panel", "Left engine vibration exceeded (red)")
defineIndicatorLight("CL_R_ENG_VIBRATION", 82, "Caution Lights Panel", "Right engine vibration exceeded (red)")
defineIndicatorLight("CL_IAS_MAX", 83, "Caution Lights Panel", "Maximum allowed IAS exceeded (red)")
defineIndicatorLight("CL_MAIN_GEARBOX", 84, "Caution Lights Panel", "Minimum main Gearbox oil pressure / Main Gearbox oil overheat / Oil metallic chip detected (red)")
defineIndicatorLight("CL_FIRE", 85, "Caution Lights Panel", "Left engine / Right engine / APU / Hydraulics bay / Main Gearbox fire (red)")
defineIndicatorLight("CL_IFF_FAIL", 86, "Caution Lights Panel", "IFF failure (red)")
...
defineIndicatorLight("RALT_SAFE_ALT_LAMP", 92, "Radar Altimeter", "Safe altitude Lamp  (yellow)")
...
defineIndicatorLight("GEAR_NOSE_UP", 63, "Landing Gear Control Panel", "Nose Gear Up Lamp (red)")
defineIndicatorLight("GEAR_NOSE_DOWN", 64, "Landing Gear Control Panel", "Nose Gear down Lamp (green)")
defineIndicatorLight("GEAR_R_MAIN_UP", 61, "Landing Gear Control Panel", "Right main Gear Up Lamp (red)")
defineIndicatorLight("GEAR_R_MAIN_DOWN", 62, "Landing Gear Control Panel", "Right main Gear down Lamp (green)")
defineIndicatorLight("GEAR_L_MAIN_UP", 59, "Landing Gear Control Panel", "Left main Gear Up Lamp (red)")
defineIndicatorLight("GEAR_L_MAIN_DOWN", 60, "Landing Gear Control Panel", "Left main Gear down Lamp (green)")
...
defineIndicatorLight("WEAPONS_PRESENT_STATION_1", 392, "Weapons Control Panel", "Weapon is present on station 1 light (yellow)")
defineIndicatorLight("WEAPONS_PRESENT_STATION_2", 393, "Weapons Control Panel", "Weapon is present on station 2 light (yellow)")
defineIndicatorLight("WEAPONS_PRESENT_STATION_3", 394, "Weapons Control Panel", "Weapon is present on station 3 light (yellow)")
defineIndicatorLight("WEAPONS_PRESENT_STATION_4", 395, "Weapons Control Panel", "Weapon is present on station 4 light (yellow)")
defineIndicatorLight("WEAPONS_RDY_STATION_1", 388, "Weapons Control Panel", "Weapon is ready to fire on station 1 light (green)")
defineIndicatorLight("WEAPONS_RDY_STATION_2", 389, "Weapons Control Panel", "Weapon is ready to fire on station 2 light (green)")
defineIndicatorLight("WEAPONS_RDY_STATION_3", 390, "Weapons Control Panel", "Weapon is ready to fire on station 3 light (green)")
defineIndicatorLight("WEAPONS_RDY_STATION_4", 391, "Weapons Control Panel", "Weapon is ready to fire on station 4 light (green)")
local indPUI800 = nil
...
defineIndicatorLight("FUEL_FORWARD_TANK_TEST", 139, "Fuel Quantity", "Forward tank test Lamp (yellow)")
defineIndicatorLight("FUEL_REAR_TANK_TEST", 140, "Fuel Quantity", "Rear tank test Lamp (yellow)")
--ABRIS Display
...
defineIndicatorLight("R800_TEST_LAMP", 419, "R-800 VHF-2", "BIT Lamp (green)")
...
definePushButtonLed("WEAPONS_AUTO_TURN_LED", 437, "Targeting Mode Control Panel", "Automatic turn on target LED (green)")
defineLedPushButton("WEAPONS_AIRBORNE_TARGET_BTN", 12, 3011, 438, "Targeting Mode Control Panel", "Airborne target button")
definePushButtonLed("WEAPONS_AIRBORNE_TARGET_LED", 438, "Targeting Mode Control Panel", "Airborne target LED (green)")
...
definePushButtonLed("WEAPONS_FORWARD_HEMI_TARGET_LED", 439, "Targeting Mode Control Panel", "Head-on airborne target LED (green)")
defineLedPushButton("WEAPONS_GROUND_TARGET_BTN", 12, 3013, 440, "Targeting Mode Control Panel", "Ground moving target button")
definePushButtonLed("WEAPONS_GROUND_TARGET_LED", 440, "Targeting Mode Control Panel", "Ground moving target LED (green)")
...
definePushButtonLed("WEAPONS_TARGET_RESET_LED", 441, "Targeting Mode Control Panel", "Targeting mode reset LED (green)")
...
defineIndicatorLight("ENG_START_VLV_OPEN", 163, "Engines Start-Up Control Panel", "Engines start valve open Lamp (green)")
...
defineIndicatorLight("APU_FUEL_VLV_OPEN", 162, "APU control panel", "APU fuel shutoff valve is open Lamp (green)")
defineIndicatorLight("APU_OIL_PRESS", 168, "APU control panel", "APU oil pressure Lamp (green)")
defineIndicatorLight("APU_STOP_RPM", 169, "APU control panel", "APU shutdown due to RPM limit Lamp (green)")
defineIndicatorLight("APU_OPER", 174, "APU control panel", "APU operating Lamp (green)")
...
definePushButtonLed("PVI_WAYPOINTS_LED", 315, "PVI-800 Control Panel", "Waypoints LED (green)")
defineLedPushButton("PVI_INU_INFLIGHT_REALIGN_BTN", 20, 3012, 519, "PVI-800 Control Panel", "Inflight INU Realignment button")
definePushButtonLed("PVI_INU_INFLIGHT_REALIGN_LED", 519, "PVI-800 Control Panel", "Inflight INU Realignment LED (green)")
defineLedPushButton("PVI_FIXPOINTS_BTN", 20, 3013, 316, "PVI-800 Control Panel", "Fixpoints button")
definePushButtonLed("PVI_FIXPOINTS_LED", 316, "PVI-800 Control Panel", "Fixpoints LED (green)")
defineLedPushButton("PVI_INU_PRECISE_ALIGN_BTN", 20, 3014, 520, "PVI-800 Control Panel", "Precise INU Alignment button")
definePushButtonLed("PVI_INU_PRECISE_ALIGN_LED", 520, "PVI-800 Control Panel", "Precise INU Alignment LED (green)")
defineLedPushButton("PVI_AIRFIELDS_BTN", 20, 3015, 317, "PVI-800 Control Panel", "Airfields button")
definePushButtonLed("PVI_AIRFIELDS_LED", 317, "PVI-800 Control Panel", "Airfields LED (green)")
defineLedPushButton("PVI_INU_NORMAL_ALIGN_BTN", 20, 3016, 521, "PVI-800 Control Panel", "Normal INU Alignment button")
definePushButtonLed("PVI_INU_NORMAL_ALIGN_LED", 521, "PVI-800 Control Panel", "Normal INU Alignment LED (green)")
defineLedPushButton("PVI_TARGETS_BTN", 20, 3017, 318, "PVI-800 Control Panel", "Targets button")
definePushButtonLed("PVI_TARGETS_LED", 318, "PVI-800 Control Panel", "Targets LED (green)")
defineLedPushButton("PVI_ENTER_BTN", 20, 3018, 313, "PVI-800 Control Panel", "Enter button")
definePushButtonLed("PVI_ENTER_LED", 313, "PVI-800 Control Panel", "Enter LED (yellow)")
defineLedPushButton("PVI_RESET_BTN", 20, 3019, 314, "PVI-800 Control Panel", "Cancel button")
definePushButtonLed("PVI_RESET_LED", 314, "PVI-800 Control Panel", "Cancel LED (yellow)")
defineLedPushButton("PVI_INIT_PNT_BTN", 20, 3020, 522, "PVI-800 Control Panel", "Initial Nav Pos button")
definePushButtonLed("PVI_INIT_PNT_LED", 522, "PVI-800 Control Panel", "Initial Nav Pos LED (green)")
defineLedPushButton("PVI_SELF_COOR_BTN", 20, 3021, 319, "PVI-800 Control Panel", "Self coordinates button")
definePushButtonLed("PVI_SELF_COOR_LED", 319, "PVI-800 Control Panel", "Self coordinates LED (green)")
defineLedPushButton("PVI_DTA_DH_BTN", 20, 3022, 320, "PVI-800 Control Panel", "Course:Course Deviation/Time/Range to WPT button")
definePushButtonLed("PVI_DTA_DH_LED", 320, "PVI-800 Control Panel", "Course:Course Deviation/Time/Range to WPT LED (green)")
defineLedPushButton("PVI_WIND_HDG_SPEED_BTN", 20, 3023, 321, "PVI-800 Control Panel", "Wind Heading/Speed button")
definePushButtonLed("PVI_WIND_HDG_SPEED_LED", 321, "PVI-800 Control Panel", "Wind Heading/Speed LED (green)")
...
definePushButtonLed("PVI_THDG_TIME_RANGE_LED", 322, "PVI-800 Control Panel", "True Heading/Time/Range to final WPT LED (green)")
defineLedPushButton("PVI_BEARING_RANGE_BTN", 20, 3025, 323, "PVI-800 Control Panel", "Bearing/Range to target button")
definePushButtonLed("PVI_BEARING_RANGE_LED", 323, "PVI-800 Control Panel", "Bearing/Range to target LED (green)")
...
definePushButtonLed("AP_HDG_HOLD_LED", 332, "Autopilot Panel", "Heading hold LED (green)")
defineLedPushButton("AP_PITCH_HOLD_BTN", 33, 3003, 331, "Autopilot Panel", "Pitch hold button")
definePushButtonLed("AP_PITCH_HOLD_LED", 331, "Autopilot Panel", "Pitch hold LED (green)")
defineLedPushButton("AP_ALT_HOLD_BTN", 33, 3004, 333, "Autopilot Panel", "Altitude hold button")
definePushButtonLed("AP_ALT_HOLD_LED", 333, "Autopilot Panel", "Altitude hold LED (green)")
defineLedPushButton("AP_FD_BTN", 33, 3005, 334, "Autopilot Panel", "Flight director button")
definePushButtonLed("AP_FD_LED", 334, "Autopilot Panel", "Flight director LED (green)")
...
defineIndicatorLight("R828_TUNER_LAMP", 375, "R-828 VHF-1", "Tuner indicator Lamp (green)")
--Signal Flare Panel
...
defineIndicatorLight("ELEC_LAMP_AC_GROUND_POWER", 586, "Electrics Power", "AC ground power Lamp (green)")
...
defineIndicatorLight("FIREEXT_L_ENG_FIRE", 237, "Fire Extinguishers Control Panel", "Left engine fire Lamp (red)")
defineIndicatorLight("FIREEXT_APU_FIRE", 239, "Fire Extinguishers Control Panel", "APU fire Lamp (red)")
defineIndicatorLight("FIREEXT_HYDRAULICS_FIRE", 568, "Fire Extinguishers Control Panel", "Hydraulics fire Lamp (red)")
defineIndicatorLight("FIREEXT_R_ENG_FIRE", 241, "Fire Extinguishers Control Panel", "Right engine fire Lamp (red)")
defineIndicatorLight("FIREEXT_VENT_FIRE", 243, "Fire Extinguishers Control Panel", "Ventilator fire Lamp (red)")
defineIndicatorLight("FIREEXT_BOTTLE1", 244, "Fire Extinguishers Control Panel", "Extinguishing bottle 1 is ready Lamp (yellow)")
defineIndicatorLight("FIREEXT_BOTTLE2", 245, "Fire Extinguishers Control Panel", "Extinguishing bottle 2 is ready Lamp (yellow)")
...
defineIndicatorLight("EJECT_SYS_TEST_LAMP", 461, "Ejection System BIT Panel", "Ejection system test Lamp (green)")
...
defineIndicatorLight("HYD_MAIN_VLV", 469, "Hydraulic Temperature and Pressure", "Main hydraulic valve Lamp (green)")
defineIndicatorLight("HYD_COMMON_VLV", 470, "Hydraulic Temperature and Pressure", "Common hydraulic valve Lamp (green)")
...
defineIndicatorLight("LWS_OPER", 582, "LWS", "Operating Lamp (green)")
...
defineIndicatorLight("ABRIS_BTN_2_L", 562, "ABRIS Display", "Button 2 Light (green)")
defineIndicatorLight("ABRIS_BTN_3_L", 563, "ABRIS Display", "Button 3 Light (green)")
defineIndicatorLight("ABRIS_BTN_4_L", 564, "ABRIS Display", "Button 4 Light (green)")
defineIndicatorLight("ABRIS_BTN_5_L", 565, "ABRIS Display", "Button 5 Light (green)")
defineIndicatorLight("LWS_BIT_L", 582, "LWS", "Weapon system built-in test (green)")
defineFloat("BACK_L_BTN", 551, {0, 1}, "Lighting Control Panel", "Button Backlights (white)")
defineFloat("BACK_L_PIT", 803, {0, 1}, "Lighting Control Panel", "Cockpit Backlights (white)")
