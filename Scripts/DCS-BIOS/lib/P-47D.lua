...
defineToggleSwitch("GUNS_SW_C", 13, 3003, 67, "Port Wall", "Guns Switch Cover")
define3PosTumb("GUNS_SW", 13, 3005, 68, "Port Wall", "Guns Switch")
defineTumb("FLAPS_LVR", 2, 3029, 94, 0.5, {0, 1}, nil, false, "Port Wall", "Landing Flaps Lever")
definePotentiometer("LH_C5_CAP", 17, 3004, 166, {0, 1}, "Port Wall", "LH C5 Assy. Cover")
...
definePushButton("PROP_CB", 7, 3085, 73, "Circuit Brakers", "Propellor Control CB")
definePushButton("MSB_CB_GUN_LI", 7, 3051, 204, "Circuit Brakers", "LH Inboard Guns CB")
definePushButton("MSB_CB_GUN_LO", 7, 3053, 205, "Circuit Brakers", "LH Outboard Guns CB")
definePushButton("MSB_CB_GUN_RI", 7, 3055, 206, "Circuit Brakers", "LH Inboard Guns CB")
definePushButton("MSB_CB_GUN_RO", 7, 3057, 207, "Circuit Brakers", "LH Outboard Guns CB")
definePushButton("MSB_CB_FPUMP", 7, 3059, 208, "Circuit Brakers", "Fuel Pumps CB")
definePushButton("MSB_CB_OILCLR", 7, 3061, 209, "Circuit Brakers", "Oil Cooler CB")
definePushButton("MSB_CB_INTRCLR", 7, 3063, 210, "Circuit Brakers", "Intercooler CB")
definePushButton("MSB_CB_GUNRELAY", 7, 3065, 211, "Circuit Brakers", "Gun Relay and Gun Camera Guns CB")
definePushButton("MSB_CB_GUNSIGHT", 7, 3067, 212, "Circuit Brakers", "Gun Sight, Camera Heat & Water Injection CB")
definePushButton("MSB_CB_CANOPY", 7, 3069, 213, "Circuit Brakers", "Canopy Motor CB")
definePushButton("MSB_CB_LLIGHT", 7, 3071, 214, "Circuit Brakers", "Landing Light CB")
definePushButton("MSB_CB_WARN", 7, 3073, 215, "Circuit Brakers", "Warn. Instruments CB")
definePushButton("MSB_CB_CLIGHT", 7, 3075, 216, "Circuit Brakers", "Internal Lighting CB")
definePushButton("MSB_CB_PITOT", 7, 3077, 217, "Circuit Brakers", "Pitot & Starter CB")
definePushButton("MSB_CB_NLIGHT", 7, 3079, 218, "Circuit Brakers", "Position Lights CB")
definePushButton("MSB_CB_RLIGHT", 7, 3081, 219, "Circuit Brakers", "Recognition Lights CB")
definePushButton("MSB_CB_RADIO", 7, 3083, 220, "Circuit Brakers", "Radio CB")
definePushButton("MSB_CB_BOMBS", 7, 3087, 158, "Circuit Brakers", "Drop Ordinance CB")
definePushButton("MSB_CB_CRFLAPS", 7, 3089, 159, "Circuit Brakers", "Recovery Flaps CB")
...
--Starboard Wall
definePushButton("IFF_DESTR_1", 14, 3087, 185, "Starboard Wall", "Secret Radio Destruction Box 1")
definePushButton("IFF_DESTR_2", 14, 3089, 186, "Starboard Wall", "Secret Radio Destruction Box 2")
definePotentiometer("RH_C5_CAP", 18, 3004, 168, {0, 1}, "Starboard Wall", "RH C5 Assy. Cover")
