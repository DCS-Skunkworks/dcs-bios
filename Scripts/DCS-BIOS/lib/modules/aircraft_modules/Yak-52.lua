...
Yak_52:defineTumb("FRONT_PRIMER_PUMP", 3, 3044, 76, 1.0, { -1, 1 }, nil, false, "Fore Main Panel", "Fore Primer Pump Selector", { positions = { "OFF", "Trunk", "Cylinders" } })
----- Clock
...
Yak_52:define3PosTumb("FRONT_SDG_CONTROL", 20, 3005, 260, "GMK-1A", "Fore Gyro Test Switch", { positions = { "0 deg", "OFF", "300deg" } })
Yak_52:define3PosTumb("FRONT_SDG_COURSE", 20, 3007, 261, "GMK-1A", "Fore Gyro Heading Selector", { positions = { "Counter-Clockwise", "OFF", "Clockwise" } })
