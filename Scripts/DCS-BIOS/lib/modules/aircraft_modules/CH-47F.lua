...
local devices = {
	...
	COMPASS = 29,
	REMOTE_COMPASS = 30,
	EXTERNAL_CARGO_EQUIPMENT = 31,
	EXTERNAL_CARGO_SPEECH = 32,
	GRIPS = 33,
	HEATER = 34,
	-- EMERGENCY_PANEL = 35,
	LIGHTING_REFLECTS = 36,
	TERTIARY_REFLECTS = 37,
	GPS1 = 38,
	GPS2 = 39,
	EGI1 = 40,
	EGI2 = 41,
	...
	COMM_PANEL_LEFT = 54,
	COMM_PANEL_RIGHT = 55,
	COMM_PANEL_TROOP_COMMANDER = 56,
	COMM_PANEL_LH_GUNNER = 57,
	COMM_PANEL_RH_GUNNER = 58,
	COMM_PANEL_AFT_ENGINEER = 59,
	-- TURN_IND = 60,
	INTERCOM = 61,
	CREWE = 62,
	WORKSTATIONS = 63,
...
CH_47F:defineMultipositionSwitch("EMERG_AUX_RADIO_MODE", devices.CANTED_CONSOLE, 3001, 583, 3, 0.1, EMERGENCY_AUX_PANEL, "Radio Mode", { positions = { "MAN", "NORM", "GUARD" } })
CH_47F:defineToggleSwitch("EMERG_AUX_IDENT", devices.CANTED_CONSOLE, 3002, 584, EMERGENCY_AUX_PANEL, "Ident Switch")
CH_47F:defineMultipositionSwitch("EMERG_AUX_IFF", devices.CANTED_CONSOLE, 3003, 585, 3, 0.1, EMERGENCY_AUX_PANEL, "IFF Mode", { positions = { "HOLD", "OFF", "EMER" } })
CH_47F:defineToggleSwitch("EMERG_AUX_ZEROIZE", devices.CANTED_CONSOLE, 3004, 586, EMERGENCY_AUX_PANEL, "Zeroize Switch")
