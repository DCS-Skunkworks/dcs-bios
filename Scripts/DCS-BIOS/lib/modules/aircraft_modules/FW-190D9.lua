...
FW_190D9:definePotentiometer("SIGHT_DISC_CTRL", 21, 3003, 4, { 0, 1 }, "Gun Sight", "EZ42 Gunsight Target Distance Control")
FW_190D9:definePotentiometer("SIGHT_BRIGHT", 21, 3004, 135, { 0, 1 }, "Gun Sight", "EZ42 Gunsight Brightness Control")
FW_190D9:definePotentiometer("SIGHT_ALT_KNOB", 21, 3012, 191, { 0, 1 }, "Gun Sight", "EZ42 Gunsight Altitude Aiming Correction Adjusting Knob I")
...
FW_190D9:defineTumb("FUEL_TNK_SEL", 6, 3001, 90, 0.1, { 0, 0.3 }, nil, false, "Cockpit", "Fuel Tank Selector Valve", { positions = { "CLOSE", "FORWARD", "AFT", "BOTH" } })
FW_190D9:defineTumb("FUEL_GAUGE_SEL", 6, 3002, 99, 0.5, { 0, 1 }, nil, false, "Cockpit", "Fuel Gauge Selector", { positions = { "FORWARD", "NONE", "AFT" } })
