...
I_16:defineFloat("COMP_BANK", 7, { 0, 1 }, "Gauges", "Compass Bank")
I_16:defineFloat("COMP_PITCH", 8, { 0, 1 }, "Gauges", "Compass Pitch")
...
I_16:defineFloat("PANEL_SHAKE_VERT", 56, { 0, 1 }, "Gauges", "Cockpit Panel Vertikal Shake")
I_16:defineFloat("PANEL_SHAKE_HOR", 57, { 0, 1 }, "Gauges", "Cockpit Panel Horizontal Shake")
I_16:defineFloat("PANEL_SHAKE_FWD", 58, { 0, 1 }, "Gauges", "Cockpit Panel Forward Shake")
I_16:defineFloat("PANEL_SHAKE_CLOCK", 59, { 0, 1 }, "Gauges", "Cockpit Panel Clockwise Shake")
