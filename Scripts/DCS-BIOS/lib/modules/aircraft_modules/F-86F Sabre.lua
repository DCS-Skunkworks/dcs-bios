...
F_86F_Sabre:define3PosTumb("BAT_START", 1, 3001, 653, "Electrics", "Battery-Starter Switch", { positions = { "BATTERY", "OFF", "STARTER" } })
...
F_86F_Sabre:define3PosTumb("GEN_SWITCH", 1, 3005, 670, "Electrics", "Generator Switch", { positions = { "ON", "OFF", "RESET" } })
...
F_86F_Sabre:define3PosTumb("HYD_PRESS_SEL", 2, 3004, 631, "Hydraulics", "Hydraulic Pressure Gage and Selector Switch", { positions = { "UTILITY", "NORMAL", "ALTERNATE" } })
...
F_86F_Sabre:define3PosTumb("FL_CTRL_SWITCH", 2, 3003, 647, "Hydraulics", "Flight Control Switch", { positions = { "ALTERNATE ON", "NORMAL", "RESET" } })
...
F_86F_Sabre:define3PosTumb("SPD_BRAKE_SW", 2, 3005, 211, "Throttle", "Speed Brake Switch", { positions = { "OUT", "HOLD", "IN" } })
...
F_86F_Sabre:define3PosTumb("LND_TAXI_LGHT", 18, 3001, 661, "Navigation Lights", "Landing & Taxi Lights Switch", { positions = { "EXTEND&ON", "OFF", "RETRACT" } })
F_86F_Sabre:define3PosTumb("POS_LGHT_SEL", 18, 3002, 656, "Navigation Lights", "Position and Fuselage Light Selector Switch", { positions = { "STEADY", "OFF", "FLASH" } })
...
F_86F_Sabre:define3PosTumb("ARN_6_LGHT", 27, 3007, 657, "Radio", "AN/ARN-6 Scale Light Switch", { positions = { "HI", "OFF", "LO" } })
F_86F_Sabre:defineToggleSwitch("ARN_6_CW", 27, 3006, 658, "Radio", "AN/ARN-6 CW-VOICE Switch, CW/VOICE")
F_86F_Sabre:define3PosTumb("APX6_IFF_2", 29, 3002, 659, "Radio", "AN/APX-6 IFF Mode 2 Switch", { positions = { "MODE 2/OUT", "I", "P" } })
...
F_86F_Sabre:define3PosTumb("WPN_RKT_REL", 5, 3009, 751, "Weapon System", "Rocket Release Selector Switch", { positions = { "SINGLE", "OFF", "AUTO" } })
...
F_86F_Sabre:define3PosTumb("MISS_CTRL", 5, 3018, 820, "Cockpit", "Missile Control Switch", { positions = { "LH & RH", "RH", "SALVO" } })
...
F_86F_Sabre:define3PosTumb("CANOPY", 25, 3001, 718, "Cockpit", "Canopy Switch", { positions = { "OPEN", "OFF", "CLOSE" } })
...
F_86F_Sabre:defineTumb("CPIT_HEAT_MODE", 16, 3005, 737, 0.1, { 0, 0.5 }, nil, false, "Cockpit", "Cockpit Air Temperature Control Switch")
F_86F_Sabre:define3PosTumb("AIR_OUTLET_SEL", 16, 3008, 741, "Cockpit", "Air Outlet Selector Lever", { positions = { "FLOOR", "BOTH", "DEFROST" } })
...
F_86F_Sabre:define3PosTumb("RUDDER_TRIM_SWITCH", 13, 3010, 648, "Cockpit", "Rudder Trim Switch", { positions = { "LEFT", "OFF", "RIGHT" } })
...
F_86F_Sabre:defineTumb("ARC27_PWR_SEL", 26, 3003, 805, 0.1, { 0, 0.3 }, nil, false, "Radio", "AN/ARC-27 UHF Power Switch", { positions = { "OFF", "T/R", "T/R + G REC", "ADF" } })
...
F_86F_Sabre:defineTumb("APX6_MASTER", 29, 3001, 810, 0.1, { 0, 0.4 }, nil, false, "Radio", "AN/APX-6 IFF Master Switch", { positions = { "EMERGENCY", "NORM", "LOW", "STDBY", "OFF" } })
...
F_86F_Sabre:defineTumb("A4_SGHT_FUNC", 22, 3011, 721, 0.1, { 0, 0.2 }, nil, false, "Sight", "Variable Sight Selector Unit - Sight Function Selector Lever", { positions = { "ROCKET", "GUN", "BOMB" } })
F_86F_Sabre:defineTumb("A4_SGHT_TRG_SPD", 22, 3012, 720, 0.5, { 0, 1 }, nil, false, "Sight", "Variable Sight Selector Unit - Target Speed Switch", { positions = { "TR", "HI", "LO" } })
...
F_86F_Sabre:define3PosTumb("WPN_DEM_BMB_ARM", 5, 3007, 641, "Weapon System", "Demolition Bomb Arming Switch (Fuze Selection)", { positions = { "ARM NOSE&TAIL", "OFF", "TAIL ONLY" } })
F_86F_Sabre:define3PosTumb("WPN_RKT_FUSE", 5, 3011, 638, "Weapon System", "Rocket Fuze (Arming) Switch", { positions = { "DELAY", "OFF", "INSTANT" } })
...
F_86F_Sabre:defineTumb("WPN_GUN_MISS", 5, 3002, 665, 0.1, { 0, 0.3 }, nil, false, "Weapon System", "Gun-Missile Selector Switch", { positions = { "OFF", "SIGHT CAMERA & RADAR", "GUNS", "MISSILE" } })
