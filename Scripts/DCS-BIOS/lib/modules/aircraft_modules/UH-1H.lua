...
UH_1H:defineTumb("IFF_MODE1_WHEEL2", 17, 3002, 69, 1 / 9, { 0, 7 / 9 }, nil, true, "IFF", "Mode-1 Wheel 2")
UH_1H:defineTumb("IFF_MODE1_WHEEL1", 17, 3001, 68, 1 / 3, { 0, 1 }, nil, true, "IFF", "Mode-1 Wheel 1")
UH_1H:defineTumb("IFF_MODE3A_WHEEL1", 17, 3003, 70, 1 / 9, { 0, 7 / 9 }, nil, true, "IFF", "Mode-3A Wheel 1")
UH_1H:defineTumb("IFF_MODE3A_WHEEL2", 17, 3004, 71, 1 / 9, { 0, 7 / 9 }, nil, true, "IFF", "Mode-3A Wheel 2")
UH_1H:defineTumb("IFF_MODE3A_WHEEL3", 17, 3005, 72, 1 / 9, { 0, 7 / 9 }, nil, true, "IFF", "Mode-3A Wheel 3")
UH_1H:defineTumb("IFF_MODE3A_WHEEL4", 17, 3006, 73, 1 / 9, { 0, 7 / 9 }, nil, true, "IFF", "Mode-3A Wheel 4")
