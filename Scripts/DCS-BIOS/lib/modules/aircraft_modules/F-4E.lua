...
F_4E:defineToggleSwitch("PLT_CB_FEEL_TRIM_RW", CIRCUIT_BREAKERS_DEVICE_ID, 3004, 1384, PILOT_BREAKER_PANEL, "STAB Feel-Trim CB")
F_4E:defineToggleSwitch("PLT_CB_SPEED_BRAKE_RW", CIRCUIT_BREAKERS_DEVICE_ID, 3005, 1385, PILOT_BREAKER_PANEL, "Speed Brake CB")
F_4E:defineToggleSwitch("PT_CB_FLAPS_RW", CIRCUIT_BREAKERS_DEVICE_ID, 3006, 1387, PILOT_BREAKER_PANEL, "Flaps CB")
F_4E:defineToggleSwitch("PLT_CB_TRIM_CONT_RW", CIRCUIT_BREAKERS_DEVICE_ID, 3007, 1388, PILOT_BREAKER_PANEL, "Trim Controls CB")
F_4E:defineToggleSwitch("PLT_CB_RUD_TRIM_RW", CIRCUIT_BREAKERS_DEVICE_ID, 3008, 1389, PILOT_BREAKER_PANEL, "Rudder Trim CB")
F_4E:defineToggleSwitch("PLT_CB_FLOODLIGHT_INSTRUMENTS", CIRCUIT_BREAKERS_DEVICE_ID, 3009, 2710, PILOT_BREAKER_PANEL, "Pilot Instruments Lights CB")
F_4E:defineToggleSwitch("PLT_CB_INDICATOR_WARNING_LIGHTS_BRIGHTNESS", CIRCUIT_BREAKERS_DEVICE_ID, 3010, 2889, PILOT_BREAKER_PANEL, "Pilot Warning Lights CB")
F_4E:defineToggleSwitch("PLT_CB_LANDING_GEAR_RW", CIRCUIT_BREAKERS_DEVICE_ID, 3011, 1386, PILOT_BREAKER_PANEL, "Landing Gear CB")

F_4E:defineToggleSwitch("WSO_FLOODLIGHT_INSTRUMENTS", CIRCUIT_BREAKERS_DEVICE_ID, 3012, 2713, WSO_BREAKER_PANEL, "WSO Instruments Lights CB")
F_4E:defineToggleSwitch("WSO_INDICATOR_WARNING_LIGHTS_BRIGHTNESS", CIRCUIT_BREAKERS_DEVICE_ID, 3013, 2890, WSO_BREAKER_PANEL, "WSO Warning Lights CB")
