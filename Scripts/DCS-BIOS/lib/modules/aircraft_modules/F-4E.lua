...
F_4E:defineToggleSwitch("PILOT_LEFT_WALL_SAI_CIRCUIT_BREAKER", CIRCUIT_BREAKERS_DEVICE_ID, 3001, 2861, PILOT_BREAKER_PANEL, "Standby Attitude Indicator CB")
F_4E:defineToggleSwitch("ARI_CIRCUIT_BREAKER", CIRCUIT_BREAKERS_DEVICE_ID, 3001, 1382, PILOT_BREAKER_PANEL, "Aileron-Rudder Interconnect (ARI) CB")
F_4E:defineToggleSwitch("PILOT_RIGHT_WALL_AIL_FEEL_TRIM_CIRCUIT_BREAKER", CIRCUIT_BREAKERS_DEVICE_ID, 3001, 1382, PILOT_BREAKER_PANEL, "AIL Feel-Trim CB")
F_4E:defineToggleSwitch("PILOT_RIGHT_WALL_FEEL_TRIM_CIRCUIT_BREAKER", CIRCUIT_BREAKERS_DEVICE_ID, 3001, 1384, PILOT_BREAKER_PANEL, "STAB Feel-Trim CB")
F_4E:defineToggleSwitch("PILOT_RIGHT_WALL_SPEED_BRAKE_CIRCUIT_BREAKER", CIRCUIT_BREAKERS_DEVICE_ID, 3001, 1385, PILOT_BREAKER_PANEL, "Speed Brake CB")
F_4E:defineToggleSwitch("PILOT_RIGHT_WALL_FLAPS_CIRCUIT_BREAKER", CIRCUIT_BREAKERS_DEVICE_ID, 3001, 1387, PILOT_BREAKER_PANEL, "Flaps CB")
F_4E:defineToggleSwitch("PILOT_RIGHT_WALL_TRIM_CONT_CIRCUIT_BREAKER", CIRCUIT_BREAKERS_DEVICE_ID, 3001, 1388, PILOT_BREAKER_PANEL, "Trim Controls CB")
F_4E:defineToggleSwitch("PILOT_RIGHT_WALL_RUD_TRIM_CIRCUIT_BREAKER", CIRCUIT_BREAKERS_DEVICE_ID, 3001, 1389, PILOT_BREAKER_PANEL, "Rudder Trim CB")
F_4E:defineToggleSwitch("PILOT_FLOODLIGHT_INSTRUMENTS", CIRCUIT_BREAKERS_DEVICE_ID, 3001, 2710, PILOT_BREAKER_PANEL, "Pilot Instruments Lights CB")
F_4E:defineToggleSwitch("PILOT_INDICATOR_WARNING_LIGHTS_BRIGHTNESS", CIRCUIT_BREAKERS_DEVICE_ID, 3001, 2889, PILOT_BREAKER_PANEL, "Pilot Warning Lights CB")
F_4E:defineToggleSwitch("PILOT_RIGHT_WALL_LANDING_GEAR_CIRCUIT_BREAKER", CIRCUIT_BREAKERS_DEVICE_ID, 3001, 1386, PILOT_BREAKER_PANEL, "Landing Gear CB")

F_4E:defineToggleSwitch("WSO_FLOODLIGHT_INSTRUMENTS", CIRCUIT_BREAKERS_DEVICE_ID, 3001, 2713, PILOT_BREAKER_PANEL, "WSO Instruments Lights CB")
F_4E:defineToggleSwitch("WSO_INDICATOR_WARNING_LIGHTS_BRIGHTNESS", CIRCUIT_BREAKERS_DEVICE_ID, 3001, 2890, PILOT_BREAKER_PANEL, "WSO Warning Lights CB")
