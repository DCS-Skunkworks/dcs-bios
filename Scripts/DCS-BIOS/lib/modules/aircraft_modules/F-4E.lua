...
F_4E:defineToggleSwitch("AIL Feel-Trim CB", CIRCUIT_BREAKERS_DEVICE_ID, 3001, 1383, PILOT_BREAKER_PANEL, "AIL Feel-Trim CB")
F_4E:defineToggleSwitch("STAB Feel-Trim CB", CIRCUIT_BREAKERS_DEVICE_ID, 3001, 1384, PILOT_BREAKER_PANEL, "STAB Feel-Trim CB")
F_4E:defineToggleSwitch("Speed Brake CB", CIRCUIT_BREAKERS_DEVICE_ID, 3001, 1385, PILOT_BREAKER_PANEL, "Speed Brake CB")
F_4E:defineToggleSwitch("Flaps CB", CIRCUIT_BREAKERS_DEVICE_ID, 3001, 1387, PILOT_BREAKER_PANEL, "Flaps CB")
F_4E:defineToggleSwitch("Trim Controls CB", CIRCUIT_BREAKERS_DEVICE_ID, 3001, 1388, PILOT_BREAKER_PANEL, "Trim Controls CB")
F_4E:defineToggleSwitch("Rudder Trim CB", CIRCUIT_BREAKERS_DEVICE_ID, 3001, 1389, PILOT_BREAKER_PANEL, "Rudder Trim CB")
F_4E:defineToggleSwitch("Pilot Instruments CB", CIRCUIT_BREAKERS_DEVICE_ID, 3001, 2710, PILOT_BREAKER_PANEL, "Pilot Instruments Lights CB")
F_4E:defineToggleSwitch("Pilot Warning Lights CB", CIRCUIT_BREAKERS_DEVICE_ID, 3001, 2889, PILOT_BREAKER_PANEL, "Pilot Warning Lights CB")
F_4E:defineToggleSwitch("Landing Gear CB", CIRCUIT_BREAKERS_DEVICE_ID, 3001, 1386, PILOT_BREAKER_PANEL, "Landing Gear CB")

F_4E:defineToggleSwitch("WSO Instruments CB", CIRCUIT_BREAKERS_DEVICE_ID, 3001, 2713, PILOT_BREAKER_PANEL, "WSO Instruments Lights CB")
F_4E:defineToggleSwitch("WSO Warning Lights CB", CIRCUIT_BREAKERS_DEVICE_ID, 3001, 2890, PILOT_BREAKER_PANEL, "WSO Warning Lights CB")
