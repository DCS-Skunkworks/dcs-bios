...
local PLT_TARGET_DESIGNATOR_SET_CONTROL = "PLT Target Designator Set Control"
...
-- Laser Coder Control
F_4E:definePushButton("WSO_LASER_CODE_ENTER", TARGET_DESIGNATOR_DEVICE_ID, 3015, 2504, WSO_TARGET_DESIGNATOR_SET_CONTROL, "Enter Laser Code")
F_4E:definePushButton("WSO_LASER_CODE_SET_THOUSANDS", TARGET_DESIGNATOR_DEVICE_ID, 3019, 2500, WSO_TARGET_DESIGNATOR_SET_CONTROL, "Next Laser Code (thousands)")
F_4E:definePushButton("WSO_LASER_CODE_SET_HUNDREDS", TARGET_DESIGNATOR_DEVICE_ID, 3018, 2501, WSO_TARGET_DESIGNATOR_SET_CONTROL, "Next Laser Code (hundreds)")
F_4E:definePushButton("WSO_LASER_CODE_SET_TENS", TARGET_DESIGNATOR_DEVICE_ID, 3017, 2502, WSO_TARGET_DESIGNATOR_SET_CONTROL, "Next Laser Code (tens)")
F_4E:definePushButton("WSO_LASER_CODE_SET_ONES", TARGET_DESIGNATOR_DEVICE_ID, 3016, 2503, WSO_TARGET_DESIGNATOR_SET_CONTROL, "Next Laser Code (ones)")

-- Range Indicator
F_4E:definePushButton("PLT_RANGE_INDICATOR_TEST", TARGET_DESIGNATOR_DEVICE_ID, 3020, 2764, PLT_TARGET_DESIGNATOR_SET_CONTROL, "Test Display")
F_4E:definePotentiometer("PLT_RANGE_INDICATOR_BRIGHTNESS", TARGET_DESIGNATOR_DEVICE_ID, 3021, 1211, { 0, 1 }, PLT_TARGET_DESIGNATOR_SET_CONTROL, "Display Brightness")
F_4E:definePotentiometer("PLT_RANGE_INDICATOR_DESIRED_RANGE", TARGET_DESIGNATOR_DEVICE_ID, 3023, 1212, { 0, 1 }, PLT_TARGET_DESIGNATOR_SET_CONTROL, "Desired Release Range")
F_4E:define3PosTumb0To1("PLT_RANGE_INDICATOR_MODE", TARGET_DESIGNATOR_DEVICE_ID, 3022, 1210, 3, PLT_TARGET_DESIGNATOR_SET_CONTROL, "Range Mode")
