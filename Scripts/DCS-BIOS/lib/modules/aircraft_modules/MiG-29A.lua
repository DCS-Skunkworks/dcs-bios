...
MiG_29A:defineFloat("CTRL_TEST_NAV_READY_LIGHT", 387, { 0, 1 }, CTRL_TEST, "Nav Ready Light (Green)")
MiG_29A:defineFloat("CTRL_TEST_FAST_PREP_LIGHT", 388, { 0, 1 }, CTRL_TEST, "Fast Prep Light (Green)")
MiG_29A:defineFloat("CTRL_TEST_TRANSFM_FAIL_LIGHT", 389, { 0, 1 }, CTRL_TEST, "Transfm Fail Light (Red)")
MiG_29A:defineFloat("CTRL_TEST_LH_INLET_LIGHT", 397, { 0, 1 }, CTRL_TEST, "Left Engine Inlet Check Light (Green)")
MiG_29A:defineFloat("CTRL_TEST_RH_INLET_LIGHT", 398, { 0, 1 }, CTRL_TEST, "Right Engine Inlet Check Light (Green)")
MiG_29A:defineFloat("CTRL_TEST_NO_COC_RESERVE_LIGHT", 399, { 0, 1 }, CTRL_TEST, "No COC Reserve Light (Red)")
MiG_29A:defineFloat("CTRL_TEST_FEEL_UNIT_LIGHT", 381, { 0, 1 }, CTRL_TEST, "Feel Unit OK Light (Red)")
