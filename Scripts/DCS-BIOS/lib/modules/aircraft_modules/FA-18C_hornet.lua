...
FA_18C_hornet:defineString("UFC_SCRATCHPAD_NUMBER_DISPLAY", function()
	return Functions.padLeft(ufc.UFC_ScratchPadNumberDisplay, 8)
...
FA_18C_hornet:defineFloat("SBY_COMPASS_HDG", 149, { -1, 1 }, "Standby Compass", "Standby Compass Heading")
...
FA_18C_hornet:defineString("IFEI_T", function()
	return Functions.padLeft(ifei.txt_T, 6)
