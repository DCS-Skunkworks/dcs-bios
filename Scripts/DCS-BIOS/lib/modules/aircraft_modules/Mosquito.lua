...
--Externals
Mosquito:defineIntegerFromGetter("EXT_POSITION_LIGHT_LEFT", function()
...
Mosquito:defineIntegerFromGetter("EXT_POSITION_LIGHT_RIGHT", function()
...
Mosquito:defineIntegerFromGetter("EXT_POSITION_LIGHT_TAIL", function()
...
Mosquito:defineIntegerFromGetter("EXT_POSITION_LIGHT_NOSE", function()
...
Mosquito:defineIntegerFromGetter("EXT_POSITION_LIGHT_WINGS", function()
...
Mosquito:defineIntegerFromGetter("EXT_BOTTOM_LIGHT_RED", function()
...
Mosquito:defineIntegerFromGetter("EXT_BOTTOM_LIGHT_YEL", function()
...
Mosquito:defineIntegerFromGetter("EXT_BOTTOM_LIGHT_GRN", function()
	if LoGetAircraftDrawArgumentValue(201) > 0 then
		return 1
	else
		return 0
...
Mosquito:defineIntegerFromGetter("EXT_LAND_LIGHT_L", function()
...
Mosquito:defineIntegerFromGetter("EXT_LAND_LIGHT_R", function()
...
Mosquito:defineIntegerFromGetter("EXT_WOW_TAIL", function()
...
Mosquito:defineIntegerFromGetter("EXT_WOW_RIGHT", function()
...
Mosquito:defineIntegerFromGetter("EXT_WOW_LEFT", function()
