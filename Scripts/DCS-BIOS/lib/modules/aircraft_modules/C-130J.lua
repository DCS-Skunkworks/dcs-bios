...
local APU_PANEL       = "APU Panel"
local FIRE_PANEL      = "Fire Panel"
local ICE_PROTECTION  = "Ice Protection"
local BLEED_AIR_PANEL = "Bleed Air"
local HYDRAULIC_PANEL = "Hydraulic Panel"
local LDG_GEAR_PANEL  = "Landing Gear"
local EXT_LIGHTING    = "Exterior Lighting"
local AC_PANEL        = "Air Conditioning"
local MECH            = "Mechanical Interface"

-- Engine Start Panel (manual page 79)
-- 4-position switch left-to-right: MOTOR / STOP / RUN / START
-- Per clickabledata.lua arg range is {-0.33, 1} step 0.5. Cockpit detents:
--   value 0 -> arg -0.33  = MOTOR (spring-loaded - returns to STOP)
--   value 1 -> arg  0.17  = STOP
--   value 2 -> arg  0.67  = RUN
--   value 3 -> arg  1.17  = START (cockpit clamps to 1.0; spring-loaded - returns to RUN)
-- Use defineTumb with limits {-0.33, 1.17} step 0.5 to give all four positions.
C_130J:defineTumb("ENG_1_START_SWITCH", devices.ENGINE_APU_CTRL, 3007, 310, 0.5, { -0.33, 1.17 }, nil, false, POWERPLANT, "Engine 1 Start Switch (MOTOR/STOP/RUN/START)")
C_130J:defineTumb("ENG_2_START_SWITCH", devices.ENGINE_APU_CTRL, 3008, 311, 0.5, { -0.33, 1.17 }, nil, false, POWERPLANT, "Engine 2 Start Switch (MOTOR/STOP/RUN/START)")
C_130J:defineTumb("ENG_3_START_SWITCH", devices.ENGINE_APU_CTRL, 3009, 312, 0.5, { -0.33, 1.17 }, nil, false, POWERPLANT, "Engine 3 Start Switch (MOTOR/STOP/RUN/START)")
C_130J:defineTumb("ENG_4_START_SWITCH", devices.ENGINE_APU_CTRL, 3010, 313, 0.5, { -0.33, 1.17 }, nil, false, POWERPLANT, "Engine 4 Start Switch (MOTOR/STOP/RUN/START)")
C_130J:definePushButton("ENG_1_STOP", devices.ENGINE_APU_CTRL, 3011, 310, POWERPLANT, "Engine 1 Stop Command")
C_130J:definePushButton("ENG_2_STOP", devices.ENGINE_APU_CTRL, 3012, 311, POWERPLANT, "Engine 2 Stop Command")
C_130J:definePushButton("ENG_3_STOP", devices.ENGINE_APU_CTRL, 3013, 312, POWERPLANT, "Engine 3 Stop Command")
C_130J:definePushButton("ENG_4_STOP", devices.ENGINE_APU_CTRL, 3014, 313, POWERPLANT, "Engine 4 Stop Command")
...
C_130J:definePushButton("ENG_2_FIRE_PULL", devices.ENGINE_APU_CTRL, 3023, 316, FIRE_PANEL, "Engine 2 Fire Handle Pull")
C_130J:definePushButton("ENG_3_FIRE_PULL", devices.ENGINE_APU_CTRL, 3024, 318, FIRE_PANEL, "Engine 3 Fire Handle Pull")
C_130J:definePushButton("ENG_4_FIRE_PULL", devices.ENGINE_APU_CTRL, 3025, 320, FIRE_PANEL, "Engine 4 Fire Handle Pull")
C_130J:definePushButton("APU_FIRE_PULL",   devices.ENGINE_APU_CTRL, 3026, 324, FIRE_PANEL, "APU Fire Handle Pull")
C_130J:defineMultipositionSwitch("ENG_1_FIRE_ROTATE", devices.ENGINE_APU_CTRL, 3017, 315, 3, 0.5, FIRE_PANEL, "Engine 1 Fire Bottle (NORM/1/2)")
C_130J:defineMultipositionSwitch("ENG_2_FIRE_ROTATE", devices.ENGINE_APU_CTRL, 3018, 317, 3, 0.5, FIRE_PANEL, "Engine 2 Fire Bottle (NORM/1/2)")
C_130J:defineMultipositionSwitch("ENG_3_FIRE_ROTATE", devices.ENGINE_APU_CTRL, 3019, 319, 3, 0.5, FIRE_PANEL, "Engine 3 Fire Bottle (NORM/1/2)")
C_130J:defineMultipositionSwitch("ENG_4_FIRE_ROTATE", devices.ENGINE_APU_CTRL, 3020, 321, 3, 0.5, FIRE_PANEL, "Engine 4 Fire Bottle (NORM/1/2)")
C_130J:defineMultipositionSwitch("APU_FIRE_ROTATE",   devices.ENGINE_APU_CTRL, 3021, 325, 3, 0.5, FIRE_PANEL, "APU Fire Bottle (NORM/1/2)")

-- FADEC Control Panel - 3-pos spring-loaded, arg range {-1, 1} (NORM = center = value 1)
C_130J:define3PosTumb("FADEC_1", devices.ENGINE_APU_CTRL, 3039, 412, POWERPLANT, "Engine 1 FADEC (ALT/NORM/RESET)")
C_130J:define3PosTumb("FADEC_2", devices.ENGINE_APU_CTRL, 3040, 413, POWERPLANT, "Engine 2 FADEC (ALT/NORM/RESET)")
C_130J:define3PosTumb("FADEC_3", devices.ENGINE_APU_CTRL, 3041, 414, POWERPLANT, "Engine 3 FADEC (ALT/NORM/RESET)")
C_130J:define3PosTumb("FADEC_4", devices.ENGINE_APU_CTRL, 3042, 415, POWERPLANT, "Engine 4 FADEC (ALT/NORM/RESET)")
-- FADEC switch guards (0 = closed/down, 1 = open/up)
C_130J:defineToggleSwitch("FADEC_GUARD_1", devices.ENGINE_APU_CTRL, 3035, 328, POWERPLANT, "Engine 1 FADEC Switch Guard", { positions = CommonPositions.COVER })
C_130J:defineToggleSwitch("FADEC_GUARD_2", devices.ENGINE_APU_CTRL, 3036, 329, POWERPLANT, "Engine 2 FADEC Switch Guard", { positions = CommonPositions.COVER })
C_130J:defineToggleSwitch("FADEC_GUARD_3", devices.ENGINE_APU_CTRL, 3037, 330, POWERPLANT, "Engine 3 FADEC Switch Guard", { positions = CommonPositions.COVER })
C_130J:defineToggleSwitch("FADEC_GUARD_4", devices.ENGINE_APU_CTRL, 3038, 331, POWERPLANT, "Engine 4 FADEC Switch Guard", { positions = CommonPositions.COVER })

-- Propeller Control Panel - 3-pos spring-loaded, arg range {-1, 1} (NORMAL = center = value 1)
C_130J:define3PosTumb("PROP_CTRL_1", devices.ENGINE_APU_CTRL, 3043, 372, POWERPLANT, "Propeller 1 Control (FEATHER/NORMAL/UNFEATHER)")
C_130J:define3PosTumb("PROP_CTRL_2", devices.ENGINE_APU_CTRL, 3044, 373, POWERPLANT, "Propeller 2 Control (FEATHER/NORMAL/UNFEATHER)")
C_130J:define3PosTumb("PROP_CTRL_3", devices.ENGINE_APU_CTRL, 3045, 374, POWERPLANT, "Propeller 3 Control (FEATHER/NORMAL/UNFEATHER)")
...
C_130J:define3PosTumb(  "BLEED_ISO_L",   devices.ENGINE_APU_CTRL, 3051, 394, BLEED_AIR_PANEL, "Left Wing Isolation (CLOSE/AUTO/OPEN)")
C_130J:define3PosTumb(  "BLEED_DIVIDER", devices.ENGINE_APU_CTRL, 3052, 395, BLEED_AIR_PANEL, "Divider Valve (CLOSE/AUTO/OPEN)")
C_130J:define3PosTumb(  "BLEED_ISO_R",   devices.ENGINE_APU_CTRL, 3053, 396, BLEED_AIR_PANEL, "Right Wing Isolation (CLOSE/AUTO/OPEN)")
C_130J:define3PosTumb(  "BLEED_NAC_1",   devices.ENGINE_APU_CTRL, 3054, 390, BLEED_AIR_PANEL, "Engine 1 Nacelle Shutoff (CLOSE/AUTO/OPEN)")
C_130J:define3PosTumb(  "BLEED_NAC_2",   devices.ENGINE_APU_CTRL, 3055, 391, BLEED_AIR_PANEL, "Engine 2 Nacelle Shutoff (CLOSE/AUTO/OPEN)")
C_130J:define3PosTumb(  "BLEED_NAC_3",   devices.ENGINE_APU_CTRL, 3056, 392, BLEED_AIR_PANEL, "Engine 3 Nacelle Shutoff (CLOSE/AUTO/OPEN)")
...
C_130J:defineToggleSwitch(       "ICE_PITOT_P", devices.ENGINE_APU_CTRL, 3065, 378, ICE_PROTECTION, "Pilot Pitot Heat")
C_130J:defineToggleSwitch(       "ICE_PITOT_CP",devices.ENGINE_APU_CTRL, 3066, 379, ICE_PROTECTION, "Copilot Pitot Heat")
C_130J:defineToggleSwitch(       "ICE_NESA_CTR", devices.ENGINE_APU_CTRL, 3067, 380, ICE_PROTECTION, "Center NESA Heat")
C_130J:defineToggleSwitch(       "ICE_NESA_SIDE",devices.ENGINE_APU_CTRL, 3068, 381, ICE_PROTECTION, "Side/Lower NESA Heat")

-- Anti-Skid
C_130J:defineToggleSwitch("ANTI_SKID", devices.ENGINE_APU_CTRL, 3029, 37, HYDRAULIC_PANEL, "Anti-Skid Switch")
...
C_130J:definePushButton(  "HYD_ENG_PUMP_4_BOOST",  devices.HYDRAULICS, 3006, 42, HYDRAULIC_PANEL, "Engine 4 Hydraulic Pump (Booster)")
C_130J:definePushButton(  "HYD_SUCT_BOOST_UTIL",   devices.HYDRAULICS, 3007, 43, HYDRAULIC_PANEL, "Suction Boost Pump (Utility)")
C_130J:definePushButton(  "HYD_SUCT_BOOST_BOOST",  devices.HYDRAULICS, 3008, 44, HYDRAULIC_PANEL, "Suction Boost Pump (Booster)")

-- Landing Gear and Parking Brake
C_130J:defineToggleSwitch("GEAR_LEVER",    devices.HYDRAULICS,     3022, 126, LDG_GEAR_PANEL, "Landing Gear Lever (UP/DN)")
C_130J:defineToggleSwitch("PARKING_BRAKE", devices.MECH_INTERFACE, 3037, 29,  MECH,           "Parking Brake Handle")
...
local CNBP_PANEL = "CNBP"
C_130J:definePushButton("CNBP_NUM_0",  devices.CNBP, 3001, 0,   CNBP_PANEL, "CNBP 0 Key")
C_130J:definePushButton("CNBP_NUM_1",  devices.CNBP, 3002, 162, CNBP_PANEL, "CNBP 1 Key")
C_130J:definePushButton("CNBP_NUM_2",  devices.CNBP, 3003, 163, CNBP_PANEL, "CNBP 2 Key")
C_130J:definePushButton("CNBP_NUM_3",  devices.CNBP, 3004, 164, CNBP_PANEL, "CNBP 3 Key")
C_130J:definePushButton("CNBP_NUM_4",  devices.CNBP, 3005, 165, CNBP_PANEL, "CNBP 4 Key")
C_130J:definePushButton("CNBP_NUM_5",  devices.CNBP, 3006, 166, CNBP_PANEL, "CNBP 5 Key")
C_130J:definePushButton("CNBP_NUM_6",  devices.CNBP, 3007, 167, CNBP_PANEL, "CNBP 6 Key")
C_130J:definePushButton("CNBP_NUM_7",  devices.CNBP, 3008, 168, CNBP_PANEL, "CNBP 7 Key")
C_130J:definePushButton("CNBP_NUM_8",  devices.CNBP, 3009, 169, CNBP_PANEL, "CNBP 8 Key")
C_130J:definePushButton("CNBP_NUM_9",  devices.CNBP, 3010, 170, CNBP_PANEL, "CNBP 9 Key")
C_130J:definePushButton("CNBP_NUM_DOT",devices.CNBP, 3011, 0,   CNBP_PANEL, "CNBP . Key")
C_130J:definePushButton("CNBP_CLR",    devices.CNBP, 3012, 0,   CNBP_PANEL, "CNBP CLR Key")
C_130J:definePushButton("CNBP_BTN_L1", devices.CNBP, 3013, 151, CNBP_PANEL, "CNBP LSK L1")
C_130J:definePushButton("CNBP_BTN_L2", devices.CNBP, 3014, 152, CNBP_PANEL, "CNBP LSK L2")
C_130J:definePushButton("CNBP_BTN_L3", devices.CNBP, 3015, 153, CNBP_PANEL, "CNBP LSK L3")
C_130J:definePushButton("CNBP_BTN_L4", devices.CNBP, 3016, 154, CNBP_PANEL, "CNBP LSK L4")
C_130J:definePushButton("CNBP_BTN_R1", devices.CNBP, 3017, 155, CNBP_PANEL, "CNBP LSK R1")
...
-- Indication IDs follow the order indicators are registered in
-- G:\DCS\DCS World\Mods\aircraft\C130J\Cockpit\Scripts\device_init.lua
-- Pattern (already established for 23, 24, 38-42):
--   23 = DC Volts             24 = Total Fuel
--   25 = Main Fuel 1          26 = Main Fuel 2
--   27 = Main Fuel 3          28 = Main Fuel 4
--   29 = Aux Fuel L           30 = Aux Fuel R
--   31 = Ext Fuel L           32 = Ext Fuel R
--   33 = APU NG               34 = APU EGT
--   35 = Bleed Air PSI        36 = Cabin Air Temp
--   37 = Cargo Air Temp       38 = Press Rate
--   39 = Press Cabin Alt      40 = Press Differential
--   41 = Press Landing/Const  42 = Fuel Pressure
--   43 = Hyd Aux Pressure
-- =====================================================================
...
-- bytes have arrived, the leading "0" guarantees the partial value still
-- parses as integer 0.  Also strips dashes from valid readings (e.g. "1-3" for
-- old data could become "13").
local function safe_numeric_lcd(indication_id, length)
	local val = parse_overhead_lcd_line(indication_id, { length })
	if val:find("%-") or not val:find("%d") then
		return "0" .. string.rep(" ", length - 1)
	end
	return val
end

C_130J:defineString("APU_NG", function()
