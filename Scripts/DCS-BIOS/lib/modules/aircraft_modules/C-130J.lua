...
local CP_CNI_MU = "Copilot Communication/Navigation/Identification Management Unit"
C_130J:definePushButton("CP_CNI_LSK_L1", devices.C_CNI, 3001, 1170, CP_CNI_MU, "Copilot CNI-MU LSK L1")
C_130J:definePushButton("CP_CNI_LSK_L2", devices.C_CNI, 3002, 1171, CP_CNI_MU, "Copilot CNI-MU LSK L2")
C_130J:definePushButton("CP_CNI_LSK_L3", devices.C_CNI, 3003, 1172, CP_CNI_MU, "Copilot CNI-MU LSK L3")
C_130J:definePushButton("CP_CNI_LSK_L4", devices.C_CNI, 3004, 1173, CP_CNI_MU, "Copilot CNI-MU LSK L4")
C_130J:definePushButton("CP_CNI_LSK_L5", devices.C_CNI, 3005, 1174, CP_CNI_MU, "Copilot CNI-MU LSK L5")
C_130J:definePushButton("CP_CNI_LSK_L6", devices.C_CNI, 3006, 1175, CP_CNI_MU, "Copilot CNI-MU LSK L6")
C_130J:definePushButton("CP_CNI_LSK_R1", devices.C_CNI, 3007, 1176, CP_CNI_MU, "Copilot CNI-MU L1169SK R1")
C_130J:definePushButton("CP_CNI_LSK_R2", devices.C_CNI, 3008, 1177, CP_CNI_MU, "Copilot CNI-MU LSK R2")
C_130J:definePushButton("CP_CNI_LSK_R3", devices.C_CNI, 3009, 1178, CP_CNI_MU, "Copilot CNI-MU LSK R3")
C_130J:definePushButton("CP_CNI_LSK_R4", devices.C_CNI, 3010, 1179, CP_CNI_MU, "Copilot CNI-MU LSK R4")
C_130J:definePushButton("CP_CNI_LSK_R5", devices.C_CNI, 3011, 1180, CP_CNI_MU, "Copilot CNI-MU LSK R5")
C_130J:definePushButton("CP_CNI_LSK_R6", devices.C_CNI, 3012, 1181, CP_CNI_MU, "Copilot CNI-MU LSK R6")
C_130J:definePushButton("CP_CNI_COMM_TUNE", devices.C_CNI, 3013, 1182, CP_CNI_MU, "Copilot CNI-MU COMM TUNE Key")
C_130J:definePushButton("CP_CNI_NAV_TUNE", devices.C_CNI, 3022, 1183, CP_CNI_MU, "Copilot CNI-MU NAV TUNE Key")
C_130J:definePushButton("CP_CNI_IFF", devices.C_CNI, 3021, 1184, CP_CNI_MU, "Copilot CNI-MU IFF Key")
C_130J:definePushButton("CP_CNI_NAV_CTRL", devices.C_CNI, 3015, 1185, CP_CNI_MU, "Copilot CNI-MU NAV CTRL Key")
C_130J:definePushButton("CP_CNI_MSN", devices.C_CNI, 3023, 1186, CP_CNI_MU, "Copilot CNI-MU MSN Key")
C_130J:definePushButton("CP_CNI_DIR_INTC", devices.C_CNI, 3018, 1187, CP_CNI_MU, "Copilot CNI-MU DIR INTC Key")
C_130J:definePushButton("CP_CNI_TOLD", devices.C_CNI, 3014, 1188, CP_CNI_MU, "Copilot CNI-MU TOLD Key")
C_130J:definePushButton("CP_CNI_INDX", devices.C_CNI, 3016, 1189, CP_CNI_MU, "Copilot CNI-MU INDX Key")
C_130J:definePushButton("CP_CNI_MC_INDX", devices.C_CNI, 3017, 1190, CP_CNI_MU, "Copilot CNI-MU MC INDX Key")
C_130J:definePushButton("CP_CNI_CAPS", devices.C_CNI, 3024, 1191, CP_CNI_MU, "Copilot CNI-MU CAPS Key")
C_130J:definePushButton("CP_CNI_EXEC", devices.C_CNI, 3025, 1192, CP_CNI_MU, "Copilot CNI-MU EXEC Key")
C_130J:definePushButton("CP_CNI_LEGS", devices.C_CNI, 3019, 1193, CP_CNI_MU, "Copilot CNI-MU LEGS Key")
C_130J:definePushButton("CP_CNI_MARK", devices.C_CNI, 3020, 1194, CP_CNI_MU, "Copilot CNI-MU MARK Key")
C_130J:definePushButton("CP_CNI_PREV_PAGE", devices.C_CNI, 3027, 1195, CP_CNI_MU, "Copilot CNI-MU PREV PAGE Key")
C_130J:definePushButton("CP_CNI_NEXT_PAGE", devices.C_CNI, 3026, 1196, CP_CNI_MU, "Copilot CNI-MU NEXT PAGE Key")
C_130J:defineRockerSwitch("CP_CNI_BRT_ROCKER", devices.C_CNI, 3070, 3070, 3071, 3071, 1197, CP_CNI_MU, "Copilot CNI-MU BRT")
C_130J:definePushButton("CP_CNI_KBD_1", devices.C_CNI, 3031, 1198, CP_CNI_MU, "Copilot CNI-MU 1 Key")
C_130J:definePushButton("CP_CNI_KBD_2", devices.C_CNI, 3032, 1199, CP_CNI_MU, "Copilot CNI-MU 2 Key")
C_130J:definePushButton("CP_CNI_KBD_3", devices.C_CNI, 3033, 1200, CP_CNI_MU, "Copilot CNI-MU 3 Key")
C_130J:definePushButton("CP_CNI_KBD_4", devices.C_CNI, 3034, 1201, CP_CNI_MU, "Copilot CNI-MU 4 Key")
C_130J:definePushButton("CP_CNI_KBD_5", devices.C_CNI, 3035, 1202, CP_CNI_MU, "Copilot CNI-MU 5 Key")
C_130J:definePushButton("CP_CNI_KBD_6", devices.C_CNI, 3036, 1203, CP_CNI_MU, "Copilot CNI-MU 6 Key")
C_130J:definePushButton("CP_CNI_KBD_7", devices.C_CNI, 3037, 1204, CP_CNI_MU, "Copilot CNI-MU 7 Key")
C_130J:definePushButton("CP_CNI_KBD_8", devices.C_CNI, 3038, 1205, CP_CNI_MU, "Copilot CNI-MU 8 Key")
C_130J:definePushButton("CP_CNI_KBD_9", devices.C_CNI, 3039, 1206, CP_CNI_MU, "Copilot CNI-MU 9 Key")
C_130J:definePushButton("CP_CNI_KBD_0", devices.C_CNI, 3030, 1207, CP_CNI_MU, "Copilot CNI-MU 0 Key")
C_130J:definePushButton("CP_CNI_KBD_DOT", devices.C_CNI, 3040, 1208, CP_CNI_MU, "Copilot CNI-MU . Key")
C_130J:definePushButton("CP_CNI_KBD_PLUSMINUS", devices.C_CNI, 3041, 1209, CP_CNI_MU, "Copilot CNI-MU +/- Key")
C_130J:definePushButton("CP_CNI_KBD_A", devices.C_CNI, 3042, 1210, CP_CNI_MU, "Copilot CNI-MU A Key")
C_130J:definePushButton("CP_CNI_KBD_B", devices.C_CNI, 3043, 1211, CP_CNI_MU, "Copilot CNI-MU B Key")
C_130J:definePushButton("CP_CNI_KBD_C", devices.C_CNI, 3044, 1212, CP_CNI_MU, "Copilot CNI-MU C Key")
C_130J:definePushButton("CP_CNI_KBD_D", devices.C_CNI, 3045, 1213, CP_CNI_MU, "Copilot CNI-MU D Key")
C_130J:definePushButton("CP_CNI_KBD_E", devices.C_CNI, 3046, 1214, CP_CNI_MU, "Copilot CNI-MU E Key")
C_130J:definePushButton("CP_CNI_KBD_F", devices.C_CNI, 3047, 1215, CP_CNI_MU, "Copilot CNI-MU F Key")
C_130J:definePushButton("CP_CNI_KBD_G", devices.C_CNI, 3048, 1216, CP_CNI_MU, "Copilot CNI-MU G Key")
C_130J:definePushButton("CP_CNI_KBD_H", devices.C_CNI, 3049, 1217, CP_CNI_MU, "Copilot CNI-MU H Key")
C_130J:definePushButton("CP_CNI_KBD_I", devices.C_CNI, 3050, 1218, CP_CNI_MU, "Copilot CNI-MU I Key")
C_130J:definePushButton("CP_CNI_KBD_J", devices.C_CNI, 3051, 1219, CP_CNI_MU, "Copilot CNI-MU J Key")
C_130J:definePushButton("CP_CNI_KBD_K", devices.C_CNI, 3052, 1220, CP_CNI_MU, "Copilot CNI-MU K Key")
C_130J:definePushButton("CP_CNI_KBD_L", devices.C_CNI, 3053, 1221, CP_CNI_MU, "Copilot CNI-MU L Key")
C_130J:definePushButton("CP_CNI_KBD_M", devices.C_CNI, 3054, 1222, CP_CNI_MU, "Copilot CNI-MU M Key")
C_130J:definePushButton("CP_CNI_KBD_N", devices.C_CNI, 3055, 1223, CP_CNI_MU, "Copilot CNI-MU N Key")
C_130J:definePushButton("CP_CNI_KBD_O", devices.C_CNI, 3056, 1224, CP_CNI_MU, "Copilot CNI-MU O Key")
C_130J:definePushButton("CP_CNI_KBD_P", devices.C_CNI, 3057, 1225, CP_CNI_MU, "Copilot CNI-MU P Key")
C_130J:definePushButton("CP_CNI_KBD_Q", devices.C_CNI, 3058, 1226, CP_CNI_MU, "Copilot CNI-MU Q Key")
C_130J:definePushButton("CP_CNI_KBD_R", devices.C_CNI, 3059, 1227, CP_CNI_MU, "Copilot CNI-MU R Key")
C_130J:definePushButton("CP_CNI_KBD_S", devices.C_CNI, 3060, 1228, CP_CNI_MU, "Copilot CNI-MU S Key")
C_130J:definePushButton("CP_CNI_KBD_T", devices.C_CNI, 3061, 1229, CP_CNI_MU, "Copilot CNI-MU T Key")
C_130J:definePushButton("CP_CNI_KBD_U", devices.C_CNI, 3062, 1230, CP_CNI_MU, "Copilot CNI-MU U Key")
C_130J:definePushButton("CP_CNI_KBD_V", devices.C_CNI, 3063, 1231, CP_CNI_MU, "Copilot CNI-MU V Key")
C_130J:definePushButton("CP_CNI_KBD_W", devices.C_CNI, 3064, 1232, CP_CNI_MU, "Copilot CNI-MU W Key")
C_130J:definePushButton("CP_CNI_KBD_X", devices.C_CNI, 3065, 1233, CP_CNI_MU, "Copilot CNI-MU X Key")
C_130J:definePushButton("CP_CNI_KBD_Y", devices.C_CNI, 3066, 1234, CP_CNI_MU, "Copilot CNI-MU Y Key")
C_130J:definePushButton("CP_CNI_KBD_Z", devices.C_CNI, 3067, 1235, CP_CNI_MU, "Copilot CNI-MU Z Key")
C_130J:definePushButton("CP_CNI_KBD_SLASH", devices.C_CNI, 3068, 1238, CP_CNI_MU, "Copilot CNI-MU / Key")
C_130J:definePushButton("CP_CNI_KBD_DEL", devices.C_CNI, 3028, 1237, CP_CNI_MU, "Copilot CNI-MU DEL Key")
C_130J:definePushButton("CP_CNI_KBD_CLR", devices.C_CNI, 3029, 1239, CP_CNI_MU, "Copilot CNI-MU CLR Key")
C_130J:defineIndicatorLight("CP_CNI_DSPY_LED", 4141, CP_CNI_MU, "Copilot CNI-MU DSPY Light (Green)")
C_130J:defineIndicatorLight("CP_CNI_MSG_LED", 4142, CP_CNI_MU, "Copilot CNI-MU MSG Light (Green)")
C_130J:defineIndicatorLight("CP_CNI_FAIL_LED", 4143, CP_CNI_MU, "Copilot CNI-MU FAIL Light (Yellow)")
C_130J:defineIndicatorLight("CP_CNI_OFSET_LED", 4144, CP_CNI_MU, "Copilot CNI-MU OFSET Light (Green)")
C_130J:defineIndicatorLight("CP_CNI_EXEC_LED", 3392, CP_CNI_MU, "Copilot CNI-MU EXEC Light (Green)")
...
C_130J:defineIndicatorLight("AUG_CNI_DSPY_LED", 4145, CP_CNI_MU, "Aug Crew CNI-MU DSPY Light (Green)")
C_130J:defineIndicatorLight("AUG_CNI_MSG_LED", 4146, CP_CNI_MU, "Aug Crew CNI-MU MSG Light (Green)")
C_130J:defineIndicatorLight("AUG_CNI_FAIL_LED", 4147, CP_CNI_MU, "Aug Crew CNI-MU FAIL Light (Yellow)")
C_130J:defineIndicatorLight("AUG_CNI_OFSET_LED", 4148, CP_CNI_MU, "Aug Crew CNI-MU OFSET Light (Green)")
