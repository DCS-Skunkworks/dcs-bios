...
local CPLT_ISC_PANEL = "CPLT Intercommunications System Control Panel"
C_130J:definePotentiometer("CPLT_ISC_INT_VOLUME", devices.VOLUME_MANAGER, 3030, 227, { 0, 1 }, CPLT_ISC_PANEL, "Copilot INT Volume Knob")
C_130J:definePushButton("CPLT_ISC_INT_BUTTON", devices.VOLUME_MANAGER, 3044, 226, CPLT_ISC_PANEL, "Copilot INT Pull to Monitor")
C_130J:definePotentiometer("CPLT_ISC_H1_VOLUME", devices.VOLUME_MANAGER, 3031, 229, { 0, 1 }, CPLT_ISC_PANEL, "Copilot HF 1 Volume Knob")
C_130J:definePushButton("CPLT_ISC_H1_BUTTON", devices.VOLUME_MANAGER, 3045, 228, CPLT_ISC_PANEL, "Copilot HF 1 Pull to Monitor")
C_130J:definePotentiometer("CPLT_ISC_H2_VOLUME", devices.VOLUME_MANAGER, 3032, 231, { 0, 1 }, CPLT_ISC_PANEL, "Copilot HF 2 Volume Knob")
C_130J:definePushButton("CPLT_ISC_H2_BUTTON", devices.VOLUME_MANAGER, 3046, 230, CPLT_ISC_PANEL, "Copilot HF 2 Pull to Monitor")
C_130J:definePotentiometer("CPLT_ISC_PA_VOLUME", devices.VOLUME_MANAGER, 3033, 233, { 0, 1 }, CPLT_ISC_PANEL, "Copilot PA Volume Knob")
C_130J:definePushButton("CPLT_ISC_PA_BUTTON", devices.VOLUME_MANAGER, 3047, 232, CPLT_ISC_PANEL, "Copilot PA Pull to Monitor")
C_130J:definePotentiometer("CPLT_ISC_PA_GAIN", devices.VOLUME_MANAGER, 3034, 1356, { 0, 1 }, CPLT_ISC_PANEL, "Copilot PA GAIN Knob")
C_130J:definePotentiometer("CPLT_ISC_VOX_SENSITIVITY", devices.VOLUME_MANAGER, 3035, 1357, { 0, 1 }, CPLT_ISC_PANEL, "Copilot VOX Sensitivity Knob")
C_130J:definePotentiometer("CPLT_ISC_V1_VOLUME", devices.VOLUME_MANAGER, 3036, 235, { 0, 1 }, CPLT_ISC_PANEL, "Copilot VHF 1 Volume Knob")
C_130J:definePushButton("CPLT_ISC_V1_BUTTON", devices.VOLUME_MANAGER, 30348, 234, CPLT_ISC_PANEL, "Copilot VHF 1 Pull to Monitor")
C_130J:definePotentiometer("CPLT_ISC_V2_VOLUME", devices.VOLUME_MANAGER, 3037, 237, { 0, 1 }, CPLT_ISC_PANEL, "Copilot VHF 2 Volume Knob")
C_130J:definePushButton("CPLT_ISC_V2_BUTTON", devices.VOLUME_MANAGER, 3049, 236, CPLT_ISC_PANEL, "Copilot VHF 2 Pull to Monitor")
C_130J:definePotentiometer("CPLT_ISC_SATCOM_VOLUME", devices.VOLUME_MANAGER, 3038, 239, { 0, 1 }, CPLT_ISC_PANEL, "Copilot SAT Volume Knob")
C_130J:definePushButton("CPLT_ISC_SATCOM_BUTTON", devices.VOLUME_MANAGER, 3050, 238, CPLT_ISC_PANEL, "Copilot SAT Pull to Monitor")
C_130J:definePotentiometer("CPLT_ISC_PVT_VOLUME", devices.VOLUME_MANAGER, 3039, 241, { 0, 1 }, CPLT_ISC_PANEL, "Copilot PVT Volume Knob")
C_130J:definePushButton("CPLT_ISC_PVT_BUTTON", devices.VOLUME_MANAGER, 3051, 240, CPLT_ISC_PANEL, "Copilot PVT Pull to Monitor")
C_130J:definePotentiometer("CPLT_ISC_VOXHM_VOLUME", devices.VOLUME_MANAGER, 3040, 243, { 0, 1 }, CPLT_ISC_PANEL, "Copilot VOX/HM Volume Knob")
C_130J:definePushButton("CPLT_ISC_VOXHM_BUTTON", devices.VOLUME_MANAGER, 3052, 242, CPLT_ISC_PANEL, "Copilot VOX/HM Pull to Monitor")
C_130J:definePotentiometer("CPLT_ISC_U1_VOLUME", devices.VOLUME_MANAGER, 3041, 245, { 0, 1 }, CPLT_ISC_PANEL, "Copilot UHF 1 Volume Knob")
C_130J:definePushButton("CPLT_ISC_U1_BUTTON", devices.VOLUME_MANAGER, 3053, 244, CPLT_ISC_PANEL, "Copilot UHF 1 Pull to Monitor")
C_130J:definePotentiometer("CPLT_ISC_U2_VOLUME", devices.VOLUME_MANAGER, 3042, 247, { 0, 1 }, CPLT_ISC_PANEL, "Copilot UHF 2 Volume Knob")
C_130J:definePushButton("CPLT_ISC_U2_BUTTON", devices.VOLUME_MANAGER, 3054, 246, CPLT_ISC_PANEL, "Copilot UHF 2 Pull to Monitor")
C_130J:defineRockerSwitch("CPLT_ISC_INT_RADIO_ROCKER", devices.VOLUME_MANAGER, 3043, 3043, 3043, 3043, 292, CPLT_ISC_PANEL, "Copilot Intercom/Radio Transmit")
C_130J:defineMultipositionSwitch("CPLT_ISC_INTERPHONE_MODE", devices.VOLUME_MANAGER, 3055, 295, 4, 0.3, CPLT_ISC_PANEL, "Copilot Interphone Mode Switch")
C_130J:defineTumb("CPLT_ISC_TRANSMISSION_SELECTOR", devices.VOLUME_MANAGER, 3056, 296, 0.11, { -2, 7 }, nil, false, CPLT_ISC_PANEL, "Copilot Transmission Selector Switch")
C_130J:definePotentiometer("CPLT_ISC_MASTER_VOLUME", devices.VOLUME_MANAGER, 3029, 1358, { 0, 1 }, CPLT_ISC_PANEL, "Copilot Master Volume Knob")
