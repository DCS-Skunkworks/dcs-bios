...
local PLT_ISC_PANEL = "PLT Intercommunications System Control Panel"
C_130J:definePotentiometer("PLT_ISC_INT_VOLUME", devices.VOLUME_MANAGER, 3002, 205, { 0, 1 }, PLT_ISC_PANEL, "Pilot INT Volume Knob")
C_130J:definePushButton("PLT_ISC_INT_BUTTON", devices.VOLUME_MANAGER, 3016, 204, PLT_ISC_PANEL, "Pilot INT Pull to Monitor")
C_130J:definePotentiometer("PLT_ISC_H1_VOLUME", devices.VOLUME_MANAGER, 3003, 207, { 0, 1 }, PLT_ISC_PANEL, "Pilot HF 1 Volume Knob")
C_130J:definePushButton("PLT_ISC_H1_BUTTON", devices.VOLUME_MANAGER, 3017, 206, PLT_ISC_PANEL, "Pilot HF 1 Pull to Monitor")
C_130J:definePotentiometer("PLT_ISC_H2_VOLUME", devices.VOLUME_MANAGER, 3004, 209, { 0, 1 }, PLT_ISC_PANEL, "Pilot HF 2 Volume Knob")
...
C_130J:definePushButton("PLT_ISC_V2_BUTTON", devices.VOLUME_MANAGER, 3021, 214, PLT_ISC_PANEL, "Pilot VHF 2 Pull to Monitor")
C_130J:definePotentiometer("PLT_ISC_SATCOM_VOLUME", devices.VOLUME_MANAGER, 3010, 217, { 0, 1 }, PLT_ISC_PANEL, "Pilot SAT Volume Knob")
C_130J:definePushButton("PLT_ISC_SATCOM_BUTTON", devices.VOLUME_MANAGER, 3022, 216, PLT_ISC_PANEL, "Pilot SAT Pull to Monitor")
C_130J:definePotentiometer("PLT_ISC_PVT_VOLUME", devices.VOLUME_MANAGER, 3011, 219, { 0, 1 }, PLT_ISC_PANEL, "Pilot PVT Volume Knob")
C_130J:definePushButton("PLT_ISC_PVT_BUTTON", devices.VOLUME_MANAGER, 3023, 218, PLT_ISC_PANEL, "Pilot PVT Pull to Monitor")
C_130J:definePotentiometer("PLT_ISC_VOXHM_VOLUME", devices.VOLUME_MANAGER, 3012, 221, { 0, 1 }, PLT_ISC_PANEL, "Pilot VOX/HM Volume Knob")
C_130J:definePushButton("PLT_ISC_VOXHM_BUTTON", devices.VOLUME_MANAGER, 3024, 220, PLT_ISC_PANEL, "Pilot VOX/HM Pull to Monitor")
C_130J:definePotentiometer("PLT_ISC_U1_VOLUME", devices.VOLUME_MANAGER, 3013, 223, { 0, 1 }, PLT_ISC_PANEL, "Pilot UHF 1 Volume Knob")
C_130J:definePushButton("PLT_ISC_U1_BUTTON", devices.VOLUME_MANAGER, 3025, 222, PLT_ISC_PANEL, "Pilot UHF 1 Pull to Monitor")
C_130J:definePotentiometer("PLT_ISC_U2_VOLUME", devices.VOLUME_MANAGER, 3014, 225, { 0, 1 }, PLT_ISC_PANEL, "Pilot UHF 2 Volume Knob")
C_130J:definePushButton("PLT_ISC_U2_BUTTON", devices.VOLUME_MANAGER, 3026, 224, PLT_ISC_PANEL, "Pilot UHF 2 Pull to Monitor")
