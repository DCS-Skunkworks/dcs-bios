...
Mi_8MT:define3PosTumb("INV_115V_SWITCH", 1, 3012, 541, "Electrical system", "Inverter Switch 115V", { positions = { "MANUAL", "OFF", "AUTO" } })
Mi_8MT:define3PosTumb("INV_36V_SWITCH", 1, 3013, 542, "Electrical system", "Inverter Switch 36V", { positions = { "MANUAL", "OFF", "AUTO" } })
...
Mi_8MT:define3PosTumb("TRANS_36V_SWITCH", 1, 3020, 149, "Electrical system", "Transformer Switch 36V", { positions = { "MAIN", "OFF", "AUXILIARY" } })
...
Mi_8MT:defineTumb("FUEL_REFUEL", 2, 3014, 437, 0.5, { 0, 1 }, nil, false, "Fuel System", "Refueling Control Switch", { positions = { "REFUEL", "OFF", "CHECK" } })

--Engine start panel - APU Launch Panel
Mi_8MT:define3PosTumb("APU_START_MODE", 3, 3012, 412, "APU Launch Panel", "APU Start Mode Switch", { positions = { "START", "COLD CRANKING", "FALSE START" } })
...
Mi_8MT:define3PosTumb("ENG_SEL", 3, 3008, 422, "Engines Launch Panel", "Engine Selector Switch", { positions = { "LEFT", "OFF", "RIGHT" } })
Mi_8MT:define3PosTumb("ENG_START_MODE", 3, 3027, 423, "Engines Launch Panel", "Engine Start Mode Switch", { positions = { "START", "OFF", "COLD CRANKING" } })
Mi_8MT:define3PosTumb("ENG_IGN_CHK", 3, 3074, 425, "Engines Launch Panel", "Engine Ignition Check Switch", { positions = { "LEFT", "OFF", "RIGHT" } })
...
Mi_8MT:define3PosTumb("ENG_LEFT_FREE_TURB_RPM", 3, 3063, 202, "Engines management", "Readjust Left Free Turbine RPM Switch", { positions = { "MORE", "OFF", "LESS" } })
Mi_8MT:define3PosTumb("ENG_RIGHT_FREE_TURB_RPM", 3, 3064, 867, "Engines management", "Readjust Right Free Turbine RPM Switch", { positions = { "MORE", "OFF", "LESS" } })
...
Mi_8MT:define3PosTumb("ENG_LEFT_FT_CHECK", 3, 3050, 169, "Center Console", "Left Engine FT Check Switch", { positions = { "ST1", "WORK", "ST2" } })
Mi_8MT:define3PosTumb("ENG_RIGHT_FT_CHECK", 3, 3051, 171, "Center Console", "Right Engine FT Check Switch", { positions = { "ST1", "WORK", "ST2" } })
Mi_8MT:define3PosTumb("ENG_CT_CHECK", 3, 3054, 170, "Center Console", "CT Check Switch", { positions = { "RIGHT", "WORK", "LEFT" } })
...
Mi_8MT:define3PosTumb("SAS_CHK", 21, 3007, 150, "SAS", "Check Switch", { positions = { "LAMPS", "OFF", "FLASHER" } })
...
Mi_8MT:define3PosTumb("LGHT_ANO", 9, 3012, 513, "Lights", "ANO Switch", { positions = { "BRIGHT", "OFF", "DIM" } })
Mi_8MT:define3PosTumb("LGHT_FRM", 9, 3013, 514, "Lights", "Formation Lights Switch", { positions = { "BRIGHT", "OFF", "DIM" } })
...
Mi_8MT:define3PosTumb("LGHT_L_LAND", 9, 3018, 837, "Lights", "Left Landing Light Switch", { positions = { "LIGHT", "OFF", "RETRACT" } })
Mi_8MT:define3PosTumb("LGHT_R_LAND", 9, 3019, 838, "Lights", "Right Landing Light Switch", { positions = { "LIGHT", "OFF", "RETRACT" } })

Mi_8MT:define3PosTumb("LGHT_L_CEIL", 46, 3002, 333, "Lights", "Left Ceiling Light Switch", { positions = { "RED", "OFF", "WHITE" } })
Mi_8MT:define3PosTumb("LGHT_R_CEIL", 46, 3003, 489, "Lights", "Right Ceiling Light Switch", { positions = { "RED", "OFF", "WHITE" } })
...
Mi_8MT:define3PosTumb("KO50_MODE", 53, 3003, 465, "KO-50", "KO-50 Heater Mode Switch", { positions = { "MANUAL", "OFF", "AUTO" } })
Mi_8MT:define3PosTumb("KO50_REGIME", 53, 3004, 466, "KO-50", "KO-50 Heater Regime Switch", { positions = { "FILLING", "FULL", "MEDIUM" } })
...
Mi_8MT:defineTumb("FUEL_METER_SWITCH", 2, 3008, 61, 0.1, { 0, 0.5 }, nil, false, "FUEL", "Fuel Meter Switch", { positions = { "OFF", "SUM", "LEFT", "RIGHT", "FEED", "ADDITIONAL" } })
...
Mi_8MT:defineTumb("PYRO_L", 12, 3044, 350, 0.1, { 0, 0.3 }, nil, false, "PODS", "Left PYROCARTRIDGE Switch", { positions = { "OFF", "I", "II", "III" } })
Mi_8MT:defineTumb("PYRO_R", 12, 3045, 351, 0.1, { 0, 0.3 }, nil, false, "PODS", "Right PYROCARTRIDGE Switch", { positions = { "OFF", "I", "II", "III" } })
Mi_8MT:defineTumb("FIRE_CHECK_CIRC", 19, 3012, 401, 0.1, { 0, 0.7 }, nil, false, "FIRE", "Check Fire Circuits Switch", { positions = { "OFF", "CONTROL", "1", "2", "3", "4", "5", "6" } })
...
Mi_8MT:defineTumb("RADIO_SEL_L", 36, 3003, 550, 0.1, { 0, 0.5 }, nil, false, "SPU-7", "Radio Source Selector Switch", { positions = { "R-863", "JADRO-1A", "R-828", "NF", "ARC-9", "ARC-UD Left" } })
Mi_8MT:defineTumb("RADIO_SEL_R", 36, 3011, 842, 0.1, { 0, 0.5 }, nil, false, "SPU-7", "Radio Source Selector Switch", { positions = { "R-863", "JADRO-1A", "R-828", "NF", "ARC-9", "ARC-UD Right" } })
Mi_8MT:defineMultipositionSwitch("JADR1A_MODE", 37, 3001, 744, 3, 0.5, "YaDRO-1A", "YaDRO-1A, Mode Switch", { positions = { "OFF", "OM", "AM" } })
Mi_8MT:defineTumb("ARCUD_MODE", 41, 3001, 456, 0.1, { 0, 0.4 }, nil, false, "ARC-UD", "ARC-UD, Mode Switch", { positions = { "OFF", "NARROW", "WIDE", "PULSE", "RC" } })
Mi_8MT:defineTumb("ARCUD_CHL", 41, 3004, 457, 0.1, { 0, 0.5 }, nil, false, "ARC-UD", "ARC-UD, Channel Selector Switch", { positions = { "1", "2", "3", "4", "5", "6" } })
Mi_8MT:defineTumb("ARC9_MODE", 40, 3003, 446, 0.1, { 0, 0.3 }, nil, false, "ARC-9", "ARC-9, Mode Selector Switch", { positions = { "OFF", "COMP", "ANT", "LOOP" } })
...
Mi_8MT:define3PosTumb("GMC_CTRL_SWITCH", 14, 3003, 476, "GMC", "GMC Control Switch", { positions = { "0", "CONTROL", "300" } })
...
Mi_8MT:defineTumb("STC_PRS_SYSTEM", 25, 3001, 839, 0.1, { 0, 0.2 }, nil, false, "Pitot", "Static Pressure System Mode Selector", { positions = { "LEFT", "COMMON", "RIGHT" } })
Mi_8MT:defineTumb("CMD_FLARE_SEL", 48, 3002, 859, 0.5, { 0, 1 }, nil, false, "Dispenser", "CMD Board Flares Dispensers Switch", { positions = { "LEFT", "BOTH", "RIGHT" } })
...
Mi_8MT:define3PosTumb("ARC_9_LOOP", 40, 3010, 447, "ARC-9", "ARC-9, Loop Control Switch", { positions = { "LEFT", "OFF", "RIGHT" } })
...
Mi_8MT:defineTumb("IFF_MODE_SELECTOR", 57, 3001, 304, 0.1, { 0, 0.3 }, nil, false, "IFF", "IFF Transponder Mode Selector Switch", { positions = { "AUTO", "KD", "+-15", "KP" } })
