...
P_51D:define3PosTumb("WING_LTS", 14, 3008, 106, "Right Switch Panel", "Wing Position Lights", { positions = { "Bright", "Off", "Dim" } })
P_51D:define3PosTumb("TAIL_LTS", 14, 3009, 107, "Right Switch Panel", "Tail Position Lights", { positions = { "Bright", "Off", "Dim" } })
P_51D:define3PosTumb("RED_REC_LT", 14, 3021, 108, "Right Switch Panel", "Red Recognition Light", { positions = { "Key", "Off", "Steady" } })
P_51D:define3PosTumb("GRN_REC_LT", 14, 3022, 109, "Right Switch Panel", "Green Recognition Light", { positions = { "Key", "Off", "Steady" } })
P_51D:define3PosTumb("AMBR_REC_LT", 14, 3023, 110, "Right Switch Panel", "Amber Recognition Light", { positions = { "Key", "Off", "Steady" } })
...
P_51D:defineTumb("IGNITION", 13, 3005, 66, 0.1, { 0.0, 0.3 }, nil, false, "Front Switch Box", "Ignition", { positions = { "Off", "Right", "Left", "Both" } })
...
P_51D:defineTumb("SUPERCHARGER_AUTO_LOW_HIGH", 15, 3001, 57, 0.1, { 0.0, 0.2 }, nil, false, "Engine Control Panel", "Supercharger", { positions = { "Auto", "Low", "High" } })
...
P_51D:define3PosTumb("IFF_TIME_OFF_ON", 27, 3003, 141, "IFF", "IFF", { positions = { "Time", "Off", "On" } })
