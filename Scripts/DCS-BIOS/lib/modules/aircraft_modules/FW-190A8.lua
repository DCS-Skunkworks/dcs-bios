...
FW_190A8:defineTumb("FUEL_TNK_SEL", 6, 3001, 90, 0.1, { 0, 0.3 }, nil, false, "Cockpit", "Fuel Tank Selector Valve", { positions = { "CLOSE", "FORWARD", "BOTH", "AFT" } })
FW_190A8:defineTumb("FUEL_GAUGE_SEL", 6, 3002, 99, 0.5, { 0, 1 }, nil, false, "Cockpit", "Fuel Gauge Selector", { positions = { "FORWARD", "NONE", "AFT" } })
