...
local ERROR_PANEL = "Error Panel"

AJS37:defineIndicatorLight("BRAND_1", 406, ERROR_PANEL, "Engine Fire 1 (red)")
AJS37:defineIndicatorLight("BRAND_2", 407, ERROR_PANEL, "Engine Fire 2 (red)")
AJS37:defineIndicatorLight("BRA_UPPF", 408, ERROR_PANEL, "Fuel Distribution Low Pressure (yellow)")
AJS37:defineIndicatorLight("X_TANK_BRA", 409, ERROR_PANEL, "External Fuel Tank Feed System (yellow)")
AJS37:defineIndicatorLight("TANK_PUMP", 410, ERROR_PANEL, "Fuel Pump (yellow)")
AJS37:defineIndicatorLight("LANDSTALL", 411, ERROR_PANEL, "Landing Gear (yellow)")
AJS37:defineIndicatorLight("FORV_FORB", 412, ERROR_PANEL, "Thrust Reverser Warning (red)")
AJS37:defineIndicatorLight("NOSSTALL", 413, ERROR_PANEL, "Nose Gear (green)")
AJS37:defineIndicatorLight("VSTALL", 414, ERROR_PANEL, "Left Gear (green)")
AJS37:defineIndicatorLight("HSTALL", 415, ERROR_PANEL, "Right Gear (green)")
AJS37:defineIndicatorLight("TIPPVAXEL", 416, ERROR_PANEL, "Pitch Gearing (red)")
AJS37:defineIndicatorLight("ELFEL", 417, ERROR_PANEL, "Electrical System (red)")
AJS37:defineIndicatorLight("RESERVEFF", 418, ERROR_PANEL, "Backup Hydraulic (red)")
AJS37:defineIndicatorLight("HYDRA_TA_2", 419, ERROR_PANEL, "Hydraulic System 2 Pressure (red)")
AJS37:defineIndicatorLight("HYDRA_TA_1", 420, ERROR_PANEL, "Hydraulic System 1 Pressure (red)")
AJS37:defineIndicatorLight("AFK_FEL", 421, ERROR_PANEL, "Autothrottle (red)")
AJS37:defineIndicatorLight("EJ_REV", 422, ERROR_PANEL, "Thrust Reverser Inoperable (red)")
AJS37:defineIndicatorLight("OLJETRYCK", 423, ERROR_PANEL, "Oil Pressure (red)")
AJS37:defineIndicatorLight("SPAK_ERROR", 424, ERROR_PANEL, "SPAK Error (yellow)")
AJS37:defineIndicatorLight("HALL_FUNK", 425, ERROR_PANEL, "Autopilot Hold (yellow)")
AJS37:defineIndicatorLight("RHM_FEL", 426, ERROR_PANEL, "Radar Altimeter (yellow)")
AJS37:defineIndicatorLight("ROLL_VAXEL", 427, ERROR_PANEL, "Roll Gearing (yellow)")
AJS37:defineIndicatorLight("CK", 428, ERROR_PANEL, "Computer (yellow)")
AJS37:defineIndicatorLight("KABINHOJD", 429, ERROR_PANEL, "Cabin Pressure (yellow)")
AJS37:defineIndicatorLight("HUV_O_STOL", 430, ERROR_PANEL, "Ejection Seat/Canopy (yellow)")
AJS37:defineIndicatorLight("TANDSYST", 431, ERROR_PANEL, "Ignition System (yellow)")
AJS37:defineIndicatorLight("STARTSYST", 432, ERROR_PANEL, "Starter System (yellow)")
AJS37:defineIndicatorLight("MAN_BG_REG", 433, ERROR_PANEL, "Manual Fuel Regulator (yellow)")
AJS37:defineIndicatorLight("SYRGAS", 434, ERROR_PANEL, "Oxygen (yellow)")
AJS37:defineIndicatorLight("BRA_24", 435, ERROR_PANEL, "Low Fuel (yellow)")
AJS37:defineIndicatorLight("BRAND_GTS", 436, ERROR_PANEL, "Turbine Starter Fire (red)")
AJS37:defineIndicatorLight("TILS", 437, ERROR_PANEL, "TILS (green)")
AJS37:defineIndicatorLight("NAV_SYST", 438, ERROR_PANEL, "Navigation System (yellow)")
AJS37:defineIndicatorLight("KB_V_SLUT", 439, ERROR_PANEL, "Left Countermeasures Pod Empty (yellow)")
AJS37:defineIndicatorLight("KB_H_KA_SL", 440, ERROR_PANEL, "Right Countermeasures Pod Empty/ECM Failure (yellow)")
AJS37:defineIndicatorLight("FACKL_SL", 441, ERROR_PANEL, "Flares Empty (yellow)")
AJS37:defineIndicatorLight("MOTVERK", 442, ERROR_PANEL, "Countermeasures/RWR (yellow)")
AJS37:defineIndicatorLight("LUFTBROMS", 443, ERROR_PANEL, "Airbrakes (green)")
