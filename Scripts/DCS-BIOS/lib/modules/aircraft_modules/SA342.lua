...
--Electric System
SA342:definePushButton("WIPER_ONCE", 36, 3018, 53, "Electric System", "Wiper Once")
SA342:defineToggleSwitch("BATTERY", 36, 3001, 264, "Electric System", "Battery")
SA342:defineToggleSwitch("ALTERNATOR", 36, 3002, 265, "Electric System", "Alternator")
SA342:defineToggleSwitch("GENERATOR", 36, 3003, 268, "Electric System", "Generator")
SA342:definePushButton("VOLTMETER_TEST", 36, 3004, 62, "Electric System", "Voltmeter Test")
SA342:defineToggleSwitch("PITOT", 36, 3005, 170, "Electric System", "Pitot")
SA342:defineToggleSwitch("FUEL_PUMP", 36, 3006, 271, "Electric System", "Fuel Pump")
SA342:defineToggleSwitch("ADDITIONAL_FUEL_TANK", 36, 3007, 267, "Electric System", "Additional Fuel Tank")
SA342:define3PosTumb("STARTER", 36, 3008, 56, "Electric System", "Starter Start/Stop/Air")
SA342:definePushButton("WARNING_PANEL_TEST", 36, 3009, 57, "Electric System", "Warning Panel Test")
SA342:define3PosTumb("COPILOT_WIPER", 36, 3010, 48, "Electric System", "Copilot Wiper")
SA342:define3PosTumb("PILOT_WIPER", 36, 3011, 49, "Electric System", "Pilot Wiper")
SA342:defineToggleSwitch("UNASSIGNED_SWITCH", 36, 3012, 61, "Electric System", "Unassigned Switch")
SA342:definePushButton("HYD_TEST", 36, 3013, 59, "Electric System", "HYD Test")
SA342:definePushButton("REARM_ALTER", 36, 3014, 66, "Electric System", "Alter Rearm")
SA342:definePushButton("REARM_GENE", 36, 3015, 67, "Electric System", "Gene Rearm")
SA342:defineToggleSwitch("CONVOY_TANK", 36, 3016, 63, "Electric System", "Convoy Tank On/Off")
SA342:defineToggleSwitch("SAND_FILTER", 36, 3017, 64, "Electric System", "Sand Filter On/Off")

--Intercom Pilot
SA342:defineRotary("VHF_AM_RADIO_VOLUME_1", 36, 3221, 68, "Intercom", "VHF AM Radio Volume 1")
SA342:defineRotary("FM_RADIO_VOLUME_1", 36, 3222, 70, "Intercom", "FM Radio Volume 1")
SA342:defineRotary("UHF_RADIO_VOLUME_1", 36, 3223, 69, "Intercom", "UHF Radio Volume 1")

--Intercom Copilot
SA342:defineRotary("VHF_AM_RADIO_VOLUME_2", 36, 3251, 79, "Intercom", "VHF AM Radio Volume 2")
SA342:defineRotary("FM_RADIO_VOLUME_2", 36, 3252, 81, "Intercom", "FM Radio Volume 2")
SA342:defineRotary("UHF_RADIO_VOLUME_2", 36, 3253, 80, "Intercom", "UHF Radio Volume 2")

--AM Radio
SA342:defineTumb("AM_RADIO_SELECTOR", 36, 3141, 128, 0.33, { 0, 1 }, nil, false, "AM Radio", "AM Radio Selector")
SA342:defineRotary("AM_RADIO_FREQUENCY_DIAL_RIGHT", 36, 3142, 129, "AM Radio", "AM Radio Frequency Dial Right")
SA342:defineToggleSwitch("AM_FREQUENCY_SELECTOR", 36, 3143, 130, "AM Radio", "AM Radio 25/50kHz Selector")
SA342:defineRotary("AM_RADIO_FREQUENCY_DIAL_LEFT", 36, 3144, 131, "AM Radio", "AM Radio Frequency Dial Left")
...
--Rotors
SA342:defineToggleSwitch("ROTOR_BRAKE", 39, 3001, 556, "Rotors", "Rotor Brake")

--TV
SA342:defineToggleSwitch("TV_ON_OFF", 36, 3081, 124, "TV", "TV On/Off")
SA342:definePotentiometer("TV_CONTRAST", 36, 3082, 125, { 0, 1 }, "TV", "TV Contrast")
SA342:definePotentiometer("TV_BRIGHTNESS", 36, 3083, 123, { 0, 1 }, "TV", "TV Brightness")
SA342:defineToggleSwitch("TV_COVER", 36, 3084, 126, "TV", "TV Cover")
...
SA342:defineTumb("IMAGE_FOCUS_DOWN", 36, 3307, 261, 1, { -1, 0 }, nil, false, "PE", "Image Focus Down")
SA342:defineToggleSwitch("IMAGE_FOCUS_UP", 36, 3308, 261, "PE", "Image Focus Up")
SA342:defineTumb("IMAGE_GAIN_LEFT", 36, 3310, 262, 1, { -1, 0 }, nil, false, "PE", "Image Gain Left")
SA342:defineToggleSwitch("IMAGE_GAIN_RIGHT", 36, 3310, 262, "PE", "Image Gain Right")
SA342:defineTumb("IMAGE_BRIGHTNESS_DOWN", 36, 3312, 263, 1, { -1, 0 }, nil, false, "PE", "Image Brightness Down")
SA342:defineToggleSwitch("IMAGE_BRIGHTNESS_UP", 36, 3311, 263, "PE", "Symbology Brightness Left")
SA342:defineToggleSwitch("SYMBOLOGY_BRIGHTNESS_RIGHT", 36, 3314, 219, "PE", "Symbology Brightness Right")
SA342:definePushButton("CAMERA_CENTERING", 36, 3281, 362, "PE", "Camera Centering")
SA342:definePushButton("TOGGLE_VDO_VTH", 36, 3282, 364, "PE", "Toggle VDO/VTH")
...
--ADF
SA342:defineToggleSwitch("ADF1_ADF2_SELECT", 36, 3101, 166, "ADF", "ADF1/ADF2 Select")
SA342:defineToggleSwitch("ADF_TONE_ON_OFF", 36, 3102, 167, "ADF", "ADF Tone On/Off")
SA342:defineTumb("ADF_MODE", 36, 3103, 178, 0.33, { 0, 1 }, nil, false, "ADF", "ADF Mode")
SA342:defineRotary("ADF_GAIN", 36, 3104, 179, "ADF", "ADF Gain")
SA342:defineRotary("ADF_NAV1_100", 36, 3105, 168, "ADF", "ADF NAV1 100s")
SA342:defineRotary("ADF_NAV1_10", 36, 3106, 169, "ADF", "ADF NAV1 10s")
SA342:defineRotary("ADF_NAV1_1", 36, 3107, 173, "ADF", "ADF NAV1 1s")
SA342:defineRotary("ADF_NAV2_100", 36, 3108, 174, "ADF", "ADF NAV2 100s")
SA342:defineRotary("ADF_NAV2_10", 36, 3109, 175, "ADF", "ADF NAV2 10s")
SA342:defineRotary("ADF_NAV2_1", 36, 3110, 176, "ADF", "ADF NAV2 1s")
...
--RWR
SA342:define3PosTumb("RWR_OFF_ON_CROC", 36, 3061, 148, "RWR", "RWR Off/On/Croc")
SA342:definePushButton("RWR_MARKER", 36, 3062, 149, "RWR", "RWR Marker")
SA342:definePushButton("RWR_PAGE", 36, 3063, 150, "RWR", "RWR Page")
SA342:definePotentiometer("RWR_AUDIO", 36, 3064, 121, { 0, 1 }, "RWR", "RWR Audio Volume")
SA342:definePotentiometer("RWR_BRIGHTNESS", 36, 3065, 122, { 0, 1 }, "RWR", "RWR Brightness")
...
--FM Radio
SA342:defineTumb("FM_RADIO_MODE", 36, 3191, 272, 0.25, { 0, 1 }, nil, false, "FM Radio", "FM Radio Mode Select")
SA342:defineTumb("FM_RADIO_CHANNEL", 36, 3192, 273, 0.143, { 0, 1 }, nil, false, "FM Radio", "FM Radio Channel Select")
...
--UHF Radio
SA342:defineTumb("UHF_RADIO_MODE", 36, 3161, 383, 0.167, { 0, 1 }, nil, false, "UHF Radio", "UHF Radio Mode Select")
SA342:definePushButton("UHF_RADIO_BUTTON_DRW", 30, 3002, 384, "UHF Radio", "UHF Radio Button DRW")
SA342:definePushButton("UHF_RADIO_BUTTON_VLD", 36, 3163, 385, "UHF Radio", "UHF Radio Button VLD")
...
SA342:definePushButton("UHF_RADIO_BUTTON_1", 36, 3166, 388, "UHF Radio", "UHF Radio Button 1")
SA342:definePushButton("UHF_RADIO_BUTTON_2", 36, 3167, 389, "UHF Radio", "UHF Radio Button 2")
SA342:definePushButton("UHF_RADIO_BUTTON_3", 36, 3168, 390, "UHF Radio", "UHF Radio Button 3")
SA342:definePushButton("UHF_RADIO_BUTTON_4", 36, 3169, 391, "UHF Radio", "UHF Radio Button 4")
SA342:definePushButton("UHF_RADIO_BUTTON_5", 36, 3170, 392, "UHF Radio", "UHF Radio Button 5")
SA342:definePushButton("UHF_RADIO_BUTTON_6", 36, 3171, 393, "UHF Radio", "UHF Radio Button 6")
SA342:definePushButton("UHF_RADIO_BUTTON_7", 36, 3172, 394, "UHF Radio", "UHF Radio Button 7")
SA342:definePushButton("UHF_RADIO_BUTTON_8", 36, 3173, 395, "UHF Radio", "UHF Radio Button 8")
SA342:definePushButton("UHF_RADIO_BUTTON_9", 36, 3174, 396, "UHF Radio", "UHF Radio Button 9")
SA342:definePushButton("UHF_RADIO_BUTTON_0", 36, 3175, 397, "UHF Radio", "UHF Radio Button 0")
...
SA342:definePushButton("VHF_AM_RADIO_VOL_1_P", 36, 3241, 452, "Intercom", "VHF AM Radio Volume 1 (Push)")
SA342:definePushButton("FM_RADIO_VOL_1_P", 36, 3242, 453, "Intercom", "FM Radio Volume 1 (Push)")
SA342:definePushButton("UHF_RADIO_VOL_1_P", 36, 3243, 454, "Intercom", "UHF Radio Volume 1 (Push)")
SA342:definePushButton("VHF_AM_RADIO_VOL_2_P", 36, 3271, 455, "Intercom", "VHF AM Radio Volume 2 (Push)")
SA342:definePushButton("FM_RADIO_VOL_2_P", 36, 3272, 456, "Intercom", "FM Radio Volume 2 (Push)")
SA342:definePushButton("UHF_RADIO_VOL_2_P", 36, 3273, 457, "Intercom", "UHF Radio Volume 2 (Push)")
...
--IFF
SA342:defineMultipositionSwitch("IFF_CODE", 42, 3007, 244, 4, 0.33, "IFF", "IFF Code")
SA342:defineMultipositionSwitch("IFF_MASTER", 42, 3008, 245, 4, 0.33, "IFF", "IFF Master")
SA342:defineTumb("IFF_M1_D1", 42, 3001, 234, 10, { 0, 1 }, nil, false, "IFF", "IFF Mode 1 Digit 1")
SA342:defineTumb("IFF_M1_D2", 42, 3002, 235, 10, { 0, 1 }, nil, false, "IFF", "IFF Mode 1 Digit 2")
SA342:defineTumb("IFF_M3A_D1", 42, 3003, 236, 10, { 0, 1 }, nil, false, "IFF", "IFF Mode 3A Digit 1")
SA342:defineTumb("IFF_M3A_D2", 42, 3004, 237, 10, { 0, 1 }, nil, false, "IFF", "IFF Mode 3A Digit 2")
SA342:defineTumb("IFF_M3A_D3", 42, 3005, 238, 10, { 0, 1 }, nil, false, "IFF", "IFF Mode 3A Digit 3")
SA342:defineTumb("IFF_M3A_D4", 42, 3006, 239, 10, { 0, 1 }, nil, false, "IFF", "IFF Mode 3A Digit 4")
SA342:define3PosTumb("IFF_IDENT_OFF_MIC", 42, 3015, 240, "IFF", "IFF IDENT/OFF/MIC")
SA342:defineToggleSwitch("IFF_IDENT_PW", 42, 3016, 246, "IFF", "IFF Power ON/OFF")
SA342:define3PosTumb("IFF_ANT", 42, 3019, 247, "IFF", "IFF Antenna")
SA342:defineToggleSwitch("IFF_TEST_M1", 42, 3010, 248, "IFF", "IFF Test M-1")
SA342:defineToggleSwitch("IFF_TEST_M2", 42, 3011, 249, "IFF", "IFF Test M-2")
SA342:defineToggleSwitch("IFF_TEST_M3A", 42, 3012, 250, "IFF", "IFF Test M-3A")
SA342:defineToggleSwitch("IFF_TEST_MC", 42, 3013, 251, "IFF", "IFF Test M-C")
SA342:defineIndicatorLight("IFF_TEST_L", 252, "Indicator Lights", "IFF Test Lamp (green)")

--ATHOS
SA342:defineToggleSwitch("ATHOS", 41, 3011, 172, "ATHOS", "Deploy/Stow Periscope")
SA342:defineToggleSwitch("PCB_ZOOM", 41, 3008, 590, "ATHOS", "PCB Zoom Toggle")
SA342:defineMultipositionSwitch("PCB_RETICLE", 36, 3352, 591, 4, 0.33, "ATHOS", "PCB Reticle Selector")
SA342:defineToggleSwitch("PCB_STABI", 36, 3353, 592, "ATHOS", "PCB Stabilization ON/OFF")
SA342:defineToggleSwitch("PCB_WIPER", 36, 3354, 593, "ATHOS", "PCB Wipers ON/OFF")

--OTHER
SA342:defineToggleSwitch("COLLECTIVE_SHOW", 25, 3037, 601, "Flight Controls", "Show/Hide Collective")

--MINIGUN
SA342:definePushButton("MG_SIGHT_BRIGHT_INC", 43, 3001, 597, "Minigun", "Sight Brightness Increase/On")
SA342:definePushButton("MG_SIGHT_BRIGHT_DEC", 43, 3002, 598, "Minigun", "Sight Brightness Decrease/Off")
SA342:defineToggleSwitch("MG_IZLID_PW", 43, 3003, 596, "Minigun", "IZLID On/Off")
...
--Tablet
SA342:definePushButton("TABLET_PW", 44, 3001, 0, "Tablet", "Tablet Power")
SA342:define3PosTumb("TABLET_SCREEN", 44, 3002, 0, "Tablet", "Tablet Screen")
SA342:definePushButton("TABLET_SHOW", 44, 3003, 0, "Tablet", "Deploy/Stow Tablet")
SA342:definePushButton("TABLET_BRIGHT_INC", 44, 3004, 0, "Tablet", "Tablet Brightness Increase")
SA342:definePushButton("TABLET_BRIGHT_DEC", 44, 3005, 0, "Tablet", "Tablet Brightness Decrease")
SA342:definePushButton("TABLET_ZOOM_INC", 44, 3006, 0, "Tablet", "Tablet Zoom Increase")
SA342:definePushButton("TABLET_ZOOM_DEC", 44, 3007, 0, "Tablet", "Tablet Zoom Decrease")
