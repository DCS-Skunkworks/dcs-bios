...
-- 5. Sensor Panel
defineTumb("FLIR_SW", 62, 3110, 439, 0.5, {0.0, 1.0}, nil, false, "Sensor Panel", "FLIR Switch, ON/STBY/OFF")
defineTumb("LTD_R_SW", 62, 3111, 441, 0.5, {0.0, 1.0}, nil, false, "Sensor Panel", "LTD/R Switch, ARM/SAFE/AFT")
defineToggleSwitch("LST_NFLR_SW", 62, 3112, 442, "Sensor Panel", "LST/NFLR Switch, ON/OFF")
