...
defineIndicatorLight("PLT_JETT_R_TIP_L", 410, "PLT Internal Lights", "Pilot Jettison Right Tip Indicator (green)")
defineIndicatorLight("PLT_JETT_R_OUTBOARD_L", 412, "PLT Internal Lights", "Pilot Jettison Right Outboard Indicator (green)")
