...
-- pilot lights
defineIndicatorLight("PLT_MASTER_WARNING_L", 424, "PLT Internal Light System", "PLT Master Warning Indicator (yellow)")
defineIndicatorLight("PLT_MASTER_CAUTION_L", 425, "PLT Internal Light System", "PLT Master Caution Indicator (green)")
defineIndicatorLight("PLT_ENG_1_FIRE_L", 416, "PLT Internal Light System", "PLT Engine 1 Fire Indicator (yellow)")
defineIndicatorLight("PLT_APU_FIRE_L", 418, "PLT Internal Light System", "PLT APU Fire Indicator (yellow)")
defineIndicatorLight("PLT_ENG_2_FIRE_L", 420, "PLT Internal Light System", "PLT Engine 2 Fire Indicator (yellow)")
defineIndicatorLight("PLT_ENG_1_READY_L", 417, "PLT Internal Light System", "PLT Engine 1 Ready Indicator (green)")
defineIndicatorLight("PLT_APU_READY_L", 419, "PLT Internal Light System", "PLT APU Ready Indicator (green)")
defineIndicatorLight("PLT_ENG_2_READY_L", 421, "PLT Internal Light System", "PLT Engine 2 Ready Indicator (green)")
defineIndicatorLight("PLT_FIRE_EXT_DISCH_PRI_L", 422, "PLT Internal Light System", "PLT Primary Fire Extinguisher Discharge Indicator (green)")
defineIndicatorLight("PLT_FIRE_EXT_DISCH_RES_L", 423, "PLT Internal Light System", "PLT Reserve Fire Extinguisher Discharge Indicator (green)")
defineIndicatorLight("PLT_EMERGENCY_GUARD_L", 403, "PLT Internal Light System", "PLT Emergency Guard Indicator (green)")
defineIndicatorLight("PLT_EMERGENCY_XPNDR_L", 404, "PLT Internal Light System", "PLT Emergency Transponder Indicator (green)")
defineIndicatorLight("PLT_EMERGENCY_HYD_L", 405, "PLT Internal Light System", "PLT Emergency Hydraulics Indicator (green)")
defineIndicatorLight("PLT_TAIL_WHEEL_UNLOCK_L", 402, "PLT Internal Light System", "PLT Tail Wheel Unlock Indicator (green)")
defineIndicatorLight("PLT_JETT_L_TIP_L", 411, "PLT Internal Light System", "PLT Jettison Left Tip Indicator (green)")
defineIndicatorLight("PLT_JETT_L_OUTBOARD_L", 407, "PLT Internal Light System", "PLT Jettison Left Outboard Indicator (green)")
defineIndicatorLight("PLT_JETT_L_INBOARD_L", 408, "PLT Internal Light System", "PLT Jettison Left Inboard Indicator (green)")
defineIndicatorLight("PLT_JETT_R_INBOARD_L", 409, "PLT Internal Light System", "PLT Jettison Right Inboard Indicator (green)")
defineIndicatorLight("PLT_JETT_R_TIP_L", 410, "PLT Internal Light System", "PLT Jettison Right Tip Indicator (green)")
defineIndicatorLight("PLT_JETT_R_OUTBOARD_L", 412, "PLT Internal Light System", "PLT Jettison Right Outboard Indicator (green)")
defineIndicatorLight("PLT_MASTER_ARM_ARM_L", 413, "PLT Internal Light System", "PLT Master Arm Armed Indicator (yellow)")
defineIndicatorLight("PLT_MASTER_ARM_SAFE_L", 414, "PLT Internal Light System", "PLT Master Arm Safe Indicator (green)")
defineIndicatorLight("PLT_GROUND_OVERRIDE_L", 415, "PLT Internal Light System", "PLT Ground Override Indicator (green)")
defineIndicatorLight("PLT_APU_L", 406, "PLT Internal Light System", "PLT APU On Indicator (green)")

-- CP/G lights
defineIndicatorLight("CPG_MASTER_WARNING_L", 806, "CPG Internal Light System", "CPG Master Warning Indicator (yellow)")
defineIndicatorLight("CPG_MASTER_CAUTION_L", 808, "CPG Internal Light System", "CPG Master Caution Indicator (green)")
defineIndicatorLight("CPG_ENG_1_FIRE_L", 441, "CPG Internal Light System", "CPG Engine 1 Fire Indicator (yellow)")
defineIndicatorLight("CPG_APU_FIRE_L", 443, "CPG Internal Light System", "CPG APU Fire Indicator (yellow)")
defineIndicatorLight("CPG_ENG_2_FIRE_L", 445, "CPG Internal Light System", "CPG Engine 2 Fire Indicator (yellow)")
defineIndicatorLight("CPG_ENG_1_READY_L", 442, "CPG Internal Light System", "CPG Engine 1 Ready Indicator (green)")
defineIndicatorLight("CPG_APU_READY_L", 444, "CPG Internal Light System", "CPG APU Ready Indicator (green)")
defineIndicatorLight("CPG_ENG_2_READY_L", 446, "CPG Internal Light System", "CPG Engine 2 Ready Indicator (green)")
defineIndicatorLight("CPG_FIRE_EXT_DISCH_PRI_L", 447, "CPG Internal Light System", "CPG Primary Fire Extinguisher Discharge Indicator (green)")
defineIndicatorLight("CPG_FIRE_EXT_DISCH_RES_L", 448, "CPG Internal Light System", "CPG Reserve Fire Extinguisher Discharge Indicator (green)")
defineIndicatorLight("CPG_EMERGENCY_GUARD_L", 427, "CPG Internal Light System", "CPG Emergency Guard Indicator (green)")
defineIndicatorLight("CPG_EMERGENCY_XPNDR_L", 428, "CPG Internal Light System", "CPG Emergency Transponder Indicator (green)")
defineIndicatorLight("CPG_EMERGENCY_HYD_L", 429, "CPG Internal Light System", "CPG Emergency Hydraulics Indicator (green)")
defineIndicatorLight("CPG_TAIL_WHEEL_UNLOCK_L", 426, "CPG Internal Light System", "CPG Tail Wheel Unlock Indicator (green)")
defineIndicatorLight("CPG_JETT_L_TIP_L", 434, "CPG Internal Light System", "CPG Jettison Left Tip Indicator (green)")
defineIndicatorLight("CPG_JETT_L_OUTBOARD_L", 430, "CPG Internal Light System", "CPG Jettison Left Outboard Indicator (green)")
defineIndicatorLight("CPG_JETT_L_INBOARD_L", 431, "CPG Internal Light System", "CPG Jettison Left Inboard Indicator (green)")
defineIndicatorLight("CPG_JETT_R_INBOARD_L", 432, "CPG Internal Light System", "CPG Jettison Right Inboard Indicator (green)")
defineIndicatorLight("CPG_JETT_R_TIP_L", 433, "CPG Internal Light System", "CPG Jettison Right Tip Indicator (green)")
defineIndicatorLight("CPG_JETT_R_OUTBOARD_L", 435, "CPG Internal Light System", "CPG Jettison Right Outboard Indicator (green)")
defineIndicatorLight("CPG_MASTER_ARM_ARM_L", 438, "CPG Internal Light System", "CPG Master Arm Armed Indicator (yellow)")
defineIndicatorLight("CPG_MASTER_ARM_SAFE_L", 439, "CPG Internal Light System", "CPG Master Arm Safe Indicator (green)")
defineIndicatorLight("CPG_GROUND_OVERRIDE_L", 440, "CPG Internal Light System", "CPG Ground Override Indicator (green)")
defineIndicatorLight("CPG_PROCESSOR_SP_1_L", 436, "CPG Internal Light System", "CPG Processor Select SP 1 Indicator (green)")
defineIndicatorLight("CPG_PROCESSOR_SP_2_L", 437, "CPG Internal Light System", "CPG Processor Select SP 2 Indicator (green)")
