...
defineToggleSwitch("3F_INVERTER",1, 3015, 763, "Electrics", "CB 3f Inverter")
...
defineIndicatorLight("LEFTGEAR", 39, {-1, 1}, "Indicator", "HYDRO Left Gear")
defineIndicatorLight("RIGHTGEAR", 41, {-1, 1}, "Indicator", "HYDRO Right Gear")
defineIndicatorLight("NOSEGEAR", 40, {-1, 1}, "Indicator", "HYDRO Nose Gear")
