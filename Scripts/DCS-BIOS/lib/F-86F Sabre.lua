...
defineToggleSwitch("INSTR_PWR",1, 3002, 643, "Electrics", "Instrument Power Switch, ALTERNATE/NORMAL")
defineToggleSwitch("STOP_START",1, 3003, 664, "Electrics", "Stop-Starter Button (Push to de-energize starter in case of malfunction)")
defineToggleSwitch("ENG_MASTER",1, 3004, 652, "Electrics", "Engine Master Switch, ON/OFF")
...
defineToggleSwitch("GEN_WARN_LGHT_TEST",1, 3007, 687, "Electrics", "Generator Warning Light (Push To Test)")
defineToggleSwitch("MAIN_INV_FAIL_TEST",1, 3008, 680, "Electrics", "Main Instrument (Three-phase) Inverter Failure Warning Light (Push to test)")
defineToggleSwitch("BOTH_INV_FAIL_TEST",1, 3009, 681, "Electrics", "Both Instrument (Main and alternate three-phase) Inverter Failure Warning Light (Push to test)")
...
defineToggleSwitch("BMB_RKT_SALVO",1, 3011, 760, "Electrics", "Bomb Rocket Tank Salvo")
defineToggleSwitch("BMB_SEL",1, 3012, 761, "Electrics", "Bomb Sel.")
defineToggleSwitch("GYR_SYN",1, 3013, 762, "Electrics", "Gyr'Syn Compass")
defineToggleSwitch("3F_INVERTER",1, 3015, 763, "Electrics", "3f Inverter")
defineToggleSwitch("TURN_BNK_IND",1, 3016, 764, "Electrics", "Turn Bank Ind.")
defineToggleSwitch("RUDDER_IND",1, 3017, 765, "Electrics", "Rudder Trim & Take-Off Ind.")
defineToggleSwitch("ALT_AIL_TRIM",1, 3018, 766, "Electrics", "Alt Ail. Trim")
defineToggleSwitch("AIL_ALT_HRZ_TRIM",1, 3019, 767, "Electrics", "Ail & Horiz. Trim & Alt Horiz. Trim")
defineToggleSwitch("LDG_LGHTS_CONT",1, 3020, 768, "Electrics", "LDG Light Control")
defineToggleSwitch("LDG_LGHTS",1, 3021, 769, "Electrics", "LDG Lights")
defineToggleSwitch("FIRE_WARN",1, 3023, 770, "Electrics", "Fire Warn.")
defineToggleSwitch("BUS_TIE_CTRL",1, 3024, 771, "Electrics", "Bus Tie-In Control")
defineToggleSwitch("SPD_BRAKE_CB",1, 3025, 772, "Electrics", "Speed Brake Circuit Breaker")
defineToggleSwitch("AIR_OIL_TMP_SEL",1, 3026, 773, "Electrics", "Free Air & Oil Temp & Air Sel.")
defineToggleSwitch("LDG_GEAR_WARN",1, 3027, 774, "Electrics", "LDG Gear Warn.")
defineToggleSwitch("LDG_GEAR_WARN_CTRL",1, 3028, 775, "Electrics", "LDG Gear Control")
defineToggleSwitch("LDG_GEAR_POS_IND",1, 3029, 776, "Electrics", "LDG Gear Pos Ind.")
defineToggleSwitch("FUEL_BOOST_AFT",1, 3030, 777, "Electrics", "Fuel Booster AFT")
defineToggleSwitch("ALT_EMG_HYD_IND",1, 3031, 778, "Electrics", "Alt Emerg. Hyd. Cont. & Hyd. Press Ind.")
defineToggleSwitch("SGHT_PWR",1, 3032, 779, "Electrics", "Sight Power")
defineToggleSwitch("SGHT_HEATER",1, 3033, 780, "Electrics", "Sight Heater")
defineToggleSwitch("SGHT_AC_PWR",1, 3034, 781, "Electrics", "Sight A.C. Power Unit")
defineToggleSwitch("ARN_6_RDO_COMP",1, 3035, 782, "Electrics", "AN/ARN-6 Radio Compass")
defineToggleSwitch("ENG_MASTER_FUEL",1, 3036, 783, "Electrics", "Eng. Master Fuel Shut-Off")
defineToggleSwitch("ENG_IGN",1, 3037, 784, "Electrics", "Eng. Ign.")
defineToggleSwitch("FUEL_LVL",1, 3038, 785, "Electrics", "Fuel Level")
defineToggleSwitch("INV_GEN_OV_TEST",1, 3039, 786, "Electrics", "Inv Gen. Failure Overvolt LTS Test")
defineToggleSwitch("LGHT_PST_CODE",1, 3040, 787, "Electrics", "Light Post IndCode")
defineToggleSwitch("CONS_PED_LTS",1, 3041, 788, "Electrics", "Console & Ped LTS")
defineToggleSwitch("FUEL_BOOST_FWD",1, 3042, 789, "Electrics", "Fuel Boost FWD")
defineToggleSwitch("WNG_FLAP_LH",1, 3043, 790, "Electrics", "Wing Flap LH.")
defineToggleSwitch("WNG_FLAP_RH",1, 3044, 791, "Electrics", "Wing Flap RH.")
defineToggleSwitch("LGHT_FLUOR",1, 3045, 792, "Electrics", "Light Fluor")
defineToggleSwitch("SGHT_CTRL",1, 3046, 793, "Electrics", "Sight Control")
defineToggleSwitch("APC_3_RADIO",1, 3047, 794, "Electrics", "AN/APC 3 Radio")
defineToggleSwitch("APX_6_IFF",1, 3048, 795, "Electrics", "AN/APX-6 Radio IFF")
defineToggleSwitch("LDG_GEAR_EMG_UP",2, 3002, 710, "Hydraulics", "Landing Gear Emergency-up Button (Ground-use only! Hold in until gear retracts completely)")
define3PosTumb("HYD_PRESS_SEL",2, 3004, 631, "Hydraulics", "Hydraulic Pressure Gage and Selector Switch, UTILITY/NORMAL/ALTERNATE")
defineToggleSwitch("ALT_ON_TEST",2, 3007, 684, "Hydraulics", "Alternate-on Warning Light (Push to test)")
...
defineToggleSwitch("LDG_GEAR_HORN",2, 3009, 815, "Hydraulics", "Landing Gear Warning Horn Cutout Button (Push to silence horn)")
define3PosTumb("SPD_BRAKE_SW",2, 3005, 211, "Hydraulics", "Speed Brake Switch, OUT/HOLD/IN")
...
defineToggleSwitch("DRP_TNK_JETT",3, 3004, 701, "Fuel", "Drop Tank Jettison Button - Push to release drop tank(s)")
defineToggleSwitch("OUT_DRP_TNK_IND_TEST",3, 3005, 695, "Fuel", "Outboard Drop Tank Empty Indicator Light (Push to test)")
...
defineToggleSwitch("FWD_ENG_FIRE_TEST",15, 3002, 685, "Fire Alarms", "Forward Engine Compartment Fire-warning Light (Push to test)")
defineToggleSwitch("AFT_ENG_FIRE_TEST",15, 3003, 686, "Fire Alarms", "Aft Engine Compartment Fire-warning Light (Push to test)")
defineToggleSwitch("CPIT_PRESS_CTRL",16, 3001, 650, "Cockpit Air", "Cockpit Pressure Control Switch, PRESS/RAM")
defineToggleSwitch("CPIT_PRESS_SEL",16, 3002, 651, "Cockpit Air", "Cockpit Pressure Schedule Selector Switch, 5 PSI/2.75 PSI")
...
defineToggleSwitch("CMPS_LGHT",17, 3004, 654, "Lights", "Compass Light Switch, ON/OFF")
...
defineToggleSwitch("EXT_LGHT_DIM",18, 3003, 655, "Navigation Lights", "Exterior Lighting Dimmer Switch, BRIGHT/DIM")
defineToggleSwitch("EMG_FUEL",4, 3003, 630, "Engines", "Emergency Fuel Switch, ON/OFF")
defineToggleSwitch("EMG_IGN_CVR",4, 3002, 732, "Engines", "Emergency (In-air) Ignition Switch Cover")
defineToggleSwitch("LONG_ALT_TRM_CVR",13, 3011, 738, "Steering", "Longitudinal Alternate Trim Switch Cover")
defineToggleSwitch("TO_TRIM_LGHT_TEST",13, 3012, 683, "Steering", "Take-off (Trim) Position Indicator Light (Push to test)")
defineToggleSwitch("N_WHEEL_STEER",2, 3016, 209, "Hydraulics", "Nose Wheel Steering Button")
defineToggleSwitch("MIC_BUT",26, 3004, 213, "Radio", "Microphone Button")
...
define3PosTumb("APX_6_IFF_2",29, 3002, 659, "Radio", "AN/APX-6 IFF Mode 2 Switch, MODE 2/OUT/I/P")
defineToggleSwitch("APX_6_IFF_3",29, 3003, 660, "Radio", "AN/APX-6 IFF Mode 3 Switch, MODE 3/OUT")
defineToggleSwitch("APX_6_DESTR_CVR",29, 3005, 808, "Radio", "AN/APX-6 IFF Destruct Switch Cover")
...
defineToggleSwitch("DRP_TANK_SEL",3, 3003, 662, "Cockpit", "Drop Tank Selector Switch")
defineToggleSwitch("OXY_EMG_LEVER",14, 3010, 229, "Cockpit", "Oxygen Regulator Emergency Lever")
defineToggleSwitch("PIT_HEAT",16, 3003, 646, "Cockpit", "Pitot Heater Switch, ON/OFF")
...
define3PosTumb("ENG_EMG_IGN_SWITCH",4, 3001, 733, "Cockpit", "Emergency (In-air) Ignition Switch, ON/OFF")
...
defineToggleSwitch("TRIM_RIGHT_OFF",13, 3005, 205, "Cockpit", "Right Trim Switch, LEFT/OFF")
defineTumb("TRIM_UP_OFF",13, 3007, 204, 1, {-1,0}, nil, false, "Cockpit", "Up Trim Switch, LEFT/OFF")
defineToggleSwitch("TRIM_DOWN_OFF",13, 3006, 204, "Cockpit", "Down Trim Switch, LEFT/OFF")
...
define3PosTumb("APX6_DESTRUCT",29, 3004, 809, "Radio", "AN/APX-6 IFF Destruct Switch, OFF/ON")
...
defineToggleSwitch("WPN_RKT_RLS_CVR",5, 3010, 750, "Weapon System", "Rocket Release Selector Switch Cover")
...
definePotentiometer("WPN_PIP_KNOB", 5, 3005, 797,  {-1, 1}, "Weapon System", "Manual Pip Control Knob")
definePotentiometer("WPN_BMB_TRGT_ALT_TRG_KNOB", 5, 3021, 729,  {0, 1}, "Weapon System", "A-4 Sight Bombing Altimeter Target Altitude Knob")
definePotentiometer("WPN_BMB_TRGT_ALT_IND_HNDL", 5, 3022, 731,  {0, 1}, "Weapon System", "A-4 Sight Bombing Altimeter Index Altitude Handle")
...
defineToggleSwitch("WPN_SAFE_LAUNCH",5, 3020, 822, "Weapon System", "Safe Launch Button")
defineToggleSwitch("WPN_SAFE_G_LIMIT_TEST",5, 3053, 225, "Weapon System", "G-Limit Light - Push to test")
