...
defineFloat("FLAPS_G", 81, {0, 0.7}, "Main Panel Gauges", "Flaps Gauge")
...
defineTumb("T1154_C2_B", 25, 3017, 212, 0.1, {0, 0.7}, nil, true, "T1154", "T.1154 Condenser C2 Presets Knob")
defineTumb("T1154_C4_B", 25, 3020, 211, 0.1, {0, 0.7}, nil, true, "T1154", "T.1154 Condenser C4 Presets Knob")
defineTumb("T1154_C15_B", 25, 3023, 213, 0.1, {0, 0.7}, nil, true, "T1154", "T.1154 Condenser C15 Presets Knob")
defineTumb("T1154_C16_B", 25, 3026, 214, 0.1, {0, 0.7}, nil, true, "T1154", "T.1154 Condenser C16 Presets Knob")
defineTumb("T1154_C17_B", 25, 3029, 210, 0.1, {0, 0.7}, nil, true, "T1154", "T.1154 Condenser C17 Presets Knob")
