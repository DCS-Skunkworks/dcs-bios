...
defineTumb("GUNSIGHT_FIXED_GYRO", 1, 3016, 40, 0.1, {0, 0.2}, nil, false, "K14 Gunsight", "Fixed Fixed-Gyro Gyro")
...
defineTumb("RKT_REL_MODE", 4, 3007, 73, 0.1,  {0, 0.2}, nil, false, "Weapon Control", "Rockets Release Mode")
...
defineTumb("COOLANT_CONTROL", 5, 3001, 87, 0.1, {0, 0.3}, nil, false, "Engine System", "Coolant Control")
defineToggleSwitch("OIL_CONTROL_COVER", 5, 3004, 169, "Engine System", "Oil Control Cover")
defineTumb("OIL_CONTROL", 5, 3002, 88, 0.1, {0, 0.3}, nil, false, "Engine System", "Oil Control")
...
defineTumb("MIXTURE_CONTROL", 5, 3019, 47, 0.1,  {0, 0.2}, nil, false, "Engine System", "Mixture Control")
...
defineFloat("AHORIZON_BANK", 14, {1, -1}, "Artificial Horizon", "Artificial Horizon - Bank")
defineFloat("AHORIZON_PITCH", 15, {1, -1}, "Artificial Horizon", "Artificial Horizon - Pitch")
defineFloat("AHORIZON_PITCH_SHIFT", 16, {-1, 1}, "Artificial Horizon", "Artificial Horizon - Pitch Shift")
defineFloat("AHORIZON_CAGED", 20, {0, 1}, "Artificial Horizon", "Artificial Horizon - Caged")
...
defineFloat("DIRECTIONAL_GYRO", 12, {0, 1}, "Directional Gyro", "Directional Gyro Heading")
...
defineFloat("TURN_INDICATOR", 27, {-1, 1}, "Turn Indicator", "Turn Indicator")
...
defineFloat("REMOTE_COMPASS_HDG", 1, {0, 1}, "Remote Compass", "Remote Compass Heading")
defineFloat("REMOTE_COMPASS_CRS", 2, {0, 1}, "Remote Compass", "Remote Compass Course")
...
defineTumb("HOMING_ADAPTER_MODE", 28, 3001, 152, 0.1, {0, 0.2}, nil, false, "Homing Adapter", "Homing Adapter Mode Switch")
defineFloat("ACCELEROMETER_MAIN", 175, {0, 1}, "Accelerometer", "Accelerometer Main")
defineFloat("ACCELEROMETER_MIN", 177, {0, 1}, "Accelerometer", "Accelerometer Min")
defineFloat("ACCELEROMETER_MAX", 178, {0, 1}, "Accelerometer", "Accelerometer Max")
definePushButton("ACCELEROMETER_RST", 30, 3001, 176, "Accelerometer", "G-meter Reset")
defineFloat("ENGINE_RPM", 23, {0, 1}, "Engine System", "Engine RPM")
defineFloat("FUEL_PRESSURE", 32, {0, 1}, "Fuel System", "Fuel Pressure")
defineFloat("HYDRAULIC_PRESSURE", 78, {0, 1}, "Hydraulic System", "Hydraulic Pressure")
defineFloat("MANIFOLD_PRESSURE", 10, {0, 1}, "Engine System", "Manifold Pressure")
defineFloat("ROCKET_COUNTER", 77, {0, 1}, "Weapon System", "Rocket Counter")
defineFloat("VACUUM_SUCTION", 9, {0, 1}, "Engine System", "Vacuum System")
...
defineFloat("AMMETER", 101, {0, 1}, "Electric System", "Ammeter")
defineFloat("WINDSHIELD_OIL", 147, {0, 1}, "Environment System", "Windshield Oil")
defineFloat("OXYGEN_PRES", 34, {0, 1}, "Oxygen System", "Oxygen Pressure")
defineFloat("OXYGEN_FLOW", 33, {0, 1}, "Oxygen System", "Oxygen Flow Blinker")
defineFloat("SLIPBALL", 28, {-1, 1}, "Turn Indicator", "Slipball")
defineFloat("FUEL_TANK_LEFT", 155, {0, 1}, "Fuel System", "Fuel Tank Left")
defineFloat("FUEL_TANK_RIGHT", 156, {0, 1}, "Fuel System", "Fuel Tank Right")
defineFloat("FUEL_TANK_FUSELAGE", 160, {0, 1}, "Fuel System", "Fuel Tank Fuselage")
...
defineFloat("AILERON_TRIM_G", 170, {-1, 1}, "Control System", "Aileron Trim Gauge")
