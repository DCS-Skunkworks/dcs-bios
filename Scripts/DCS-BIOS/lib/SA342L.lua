BIOS.protocol.beginModule("SA342L", 0x6200)
...
--[[--Warning Panel--]]--
defineIndicatorLight("PITOT", 1, "Warning Panel", "Pitot Tube Warning")
...
defineIndicatorLight("GENERATOR", 5, "Warning Panel", "Generator Warning")
defineIndicatorLight("ALTERNATOR", 6, "Warning Panel", "Alternator Warning")
defineIndicatorLight("BATTERY", 7, "Warning Panel", "Battery Warning")
...
defineIndicatorLight("SAND_FILTER", 13, "Warning Panel", "Sand Filter Warning")
...
defineFloat("TV_BRIGHTNESS", 371, {0, 1}, "Raw Gauge Values", "TV Brightness")
...
defineFloat("ADF_NAV1_FREQ_10s", 164, {0, 1}, "Raw Gauge Values", "ADF NAV2 Frequency 1s")
