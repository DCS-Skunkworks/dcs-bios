...
defineTumb("RIO_DATALINK_FREQ_10", 52, 3586, 196, 0.1, {0.0, 1.0}, nil, false, "Datalink", "RIO Datalink Freq 10MHz")
defineTumb("RIO_DATALINK_FREQ_1", 52, 3587, 195, 0.1, {0.0, 1.0}, nil, false, "Datalink", "RIO Datalink Freq 1MHz")
defineTumb("RIO_DATALINK_FREQ_100", 52, 3588, 197, 0.1, {0.0, 1.0}, nil, false, "Datalink", "RIO Datalink Freq 100kHz")
defineTumb("RIO_DATALINK_ADDR_HI", 52, 3593, 222, 0.1, {0.0, 1.0}, nil, false, "Datalink", "RIO Datalink Address High")
defineTumb("RIO_DATALINK_ADDR_LO", 52, 3594, 223, 0.1, {0.0, 1.0}, nil, false, "Datalink", "RIO Datalink Address Low")
...
defineTumb("RIO_IFF_M3_1", 64, 3625, 2262, 0.1, {0.0, 1.0}, nil, false, "IFF", "RIO IFF M3 Code 1s")
defineTumb("RIO_IFF_M3_10", 64, 3626, 2261, 0.1, {0.0, 1.0}, nil, false, "IFF", "RIO IFF M3 Code 10s")
defineTumb("RIO_IFF_M3_100", 64, 3627, 198, 0.1, {0.0, 1.0}, nil, false, "IFF", "RIO IFF M3 Code 100s")
defineTumb("RIO_IFF_M3_1000", 64, 3628, 199, 0.1, {0.0, 1.0}, nil, false, "IFF", "RIO IFF M3 Code 1000s")
defineTumb("RIO_IFF_M1_1", 64, 3629, 200, 0.1, {0.0, 1.0}, nil, false, "IFF", "RIO IFF M1 Code 1s")
defineTumb("RIO_IFF_M1_10", 64, 3630, 201, 0.1, {0.0, 1.0}, nil, false, "IFF", "RIO IFF M1 Code 10s")
