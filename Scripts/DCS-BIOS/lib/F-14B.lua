...
defineFixedStepTumb("RIO_WEAPON_INTER_10", 55, 3148, 9960, 10, {0, 1}, {-1, 1}, nil, "Armament Panel", "RIO Weapon Interval x10ms")
defineFixedStepTumb("RIO_WEAPON_INTER_100", 55, 3147, 9961, 10, {0, 1}, {-1, 1}, nil, "Armament Panel", "RIO Weapon Interval x100ms")
defineFixedStepTumb("RIO_WEAPON_QUANT_10", 55, 3149, 9962, 10, {0, 1}, {-1, 1}, nil, "Armament Panel", "RIO Weapon Quantity 10s")
defineFixedStepTumb("RIO_WEAPON_QUANTR_1", 55, 3150, 9963, 10, {0, 1}, {-1, 1}, nil, "Armament Panel", "RIO Weapon Quantity 1s")
...
defineFixedStepTumb("RIO_DATALINK_FREQ_10", 52, 3586, 196, 10, {0, 1}, {-1, 1}, nil, "Datalink", "RIO Datalink Freq 10MHz")
defineFixedStepTumb("RIO_DATALINK_FREQ_1", 52, 3587, 195, 10, {0, 1}, {-1, 1}, nil, "Datalink", "RIO Datalink Freq 1MHz")
defineFixedStepTumb("RIO_DATALINK_FREQ_100", 52, 3588, 197, 10, {0, 1}, {-1, 1}, nil, "Datalink", "RIO Datalink Freq 100kHz")
defineFixedStepTumb("RIO_DATALINK_ADDR_HI", 52, 3593, 222, 10, {0, 1}, {-1, 1}, nil, "Datalink", "RIO Datalink Address High")
defineFixedStepTumb("RIO_DATALINK_ADDR_LO", 52, 3594, 223, 10, {0, 1}, {-1, 1}, nil, "Datalink", "RIO Datalink Address Low")
...
defineFixedStepTumb("RIO_IFF_M3_1", 64, 3625, 2262, 10, {0, 1}, {-1, 1}, nil, "Datalink", "RIO IFF M3 Code 1s")
defineFixedStepTumb("RIO_IFF_M3_10", 64, 3626, 2261, 10, {0, 1}, {-1, 1}, nil, "Datalink", "RIO IFF M3 Code 10s")
defineFixedStepTumb("RIO_IFF_M3_100", 64, 3627, 198, 10, {0, 1}, {-1, 1}, nil, "Datalink", "RIO IFF M3 Code 100s")
defineFixedStepTumb("RIO_IFF_M3_1000", 64, 3628, 199, 10, {0, 1}, {-1, 1}, nil, "Datalink", "RIO IFF M3 Code 1000s")
defineFixedStepTumb("RIO_IFF_M1_1", 64, 3629, 200, 10, {0, 1}, {-1, 1}, nil, "Datalink", "RIO IFF M1 Code 1s")
defineFixedStepTumb("RIO_IFF_M1_10", 64, 3630, 201, 10, {0, 1}, {-1, 1}, nil, "Datalink", "RIO IFF M1 Code 10s")
