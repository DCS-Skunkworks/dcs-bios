...
defineIndicatorLight("CL_A0", 101, "Caution Lights Panel", "AUX FUEL LOW")
defineIndicatorLight("CL_B0", 102, "Caution Lights Panel", "XMSN OIL PRESS")
defineIndicatorLight("CL_C0", 103, "Caution Lights Panel", "XMSN OIL HOT")
defineIndicatorLight("CL_D0", 104, "Caution Lights Panel", "HYD PRESSURE")
defineIndicatorLight("CL_E0", 105, "Caution Lights Panel", "ENGINE INLET AIR")
defineIndicatorLight("CL_F0", 106, "Caution Lights Panel", "INST INVERTER")
defineIndicatorLight("CL_G0", 107, "Caution Lights Panel", "DC GENERATOR")
defineIndicatorLight("CL_H0", 108, "Caution Lights Panel", "EXTERNAL POWER")
defineIndicatorLight("CL_I0", 109, "Caution Lights Panel", "CHIP DETECTOR")
defineIndicatorLight("CL_J0", 110, "Caution Lights Panel", "IFF")
