...
definePotentiometer("RADAR_VOL", 7, 3068, 123, {-1,1}, "RadarControlPanel", "Radar Warning Volume")
...
--Gunpods
defineMultipositionSwitch("GUNPOD_CLEAR", 2, 3012, 390, 3, 1, "Gunpods", "Charge/Off/Clear")
...
--Countermeasures
defineMultipositionSwitch("CM_BANK", 34, 3106, 522, 3, 1, "Countermeasures", "CM Bank Select")
definePushButton("CM_AUTO", 34, 3107, 523, "Countermeasures", "CM Auto Pushbutton")
defineRotary("CM_ADJ1", 34, 3108, 524, "Countermeasures", "CM Bank 1 Adjust")
defineRotary("CM_ADJ2", 34, 3109, 525, "Countermeasures", "CM Bank 2 Adjust")
defineToggleSwitch("CM_PWR", 34, 3110, 530, "Countermeasures", "CM Power Toggle")

--Armament Panel
defineMultipositionSwitch("ARM_EMERG_SEL", 2, 3025, 700, 7, 0.1, "ArmamentPanel", "Emergency Release Selector")
...
defineMultipositionSwitch("ARM_FUNC_SEL", 2, 3008, 708, 6, 0.1, "ArmamentPanel", "Function Selector")
defineMultipositionSwitch("AWRS_QUANT", 2, 3031, 740, 12, 0.05, "ArmamentPanel", "AWRS Quantity Selector")
definePotentiometer("AWRS_DROP_INT", 2, 3032, 742, {0,0.9}, "ArmamentPanel", "AWRS Drop Interval")
defineToggleSwitch("AWRS_MULTI", 2, 3033, 743, "ArmamentPanel", "AWRS Multiplier")
defineMultipositionSwitch("AWRS_MODE", 2, 3034, 744, 6, 0.1, "ArmamentPanel", "AWRS mode")
defineToggleSwitch("ARM_MASTER", 3, 3002, 709, "ArmamentPanel", "Master Armament")
defineToggleSwitch("RADAR_PROFILE", 7, 3055, 721, "RadarScope", "Radar Plan/Profile")
...
defineMultipositionSwitch("SHRIKE_SEL_KNB", 2, 3137, 725, 5, 0.1, "ArmamentPanel", "Shrike Selector Knob")
definePotentiometer("SIDEWINDER_VOL", 2, 3125, 726, {-1,1}, "ArmamentPanel", "Sidewinder Volume Knob")

--AFCS Panel
defineToggleSwitch("AFCS_STBY", 26, 3088, 160, "AFCS", "AFCS Standby")
...
defineMultipositionSwitch("APC_ENABLE", 26, 3095, 135, 3, 1.0, "ApproachPowerCompensator", "APC Enable/Stby/Off")
defineMultipositionSwitch("APS_COLD_STD_HOT", 26, 3096, 136, 3, 1.0, "ApproachPowerCompensator", "APC Cold/Std/Hot")

--Mechanical Systems
defineToggleSwitch("GEAR HANDLE", 12, 3020, 8, "Mechanical Systems", "Landing Gear Handle")
...
defineTumb("SPEEDBRAKE_EMERG", 10, 3035, 128, 1, {-1,1}, nil, false, "Mechanical Systems", "Speedbrake Emergency")
...
definePushButton("STARTER_BTN", 17, 3013, 100, "Mechanical Systems", "Starter Button")
defineToggleSwitch("JATO_ARM", 21, 3158, 133, "Mechanical Systems", "JATO ARM-OFF Switch")
defineToggleSwitch("JATO_JETT_SAFE", 21, 3159, 134, "Mechanical Systems", "JATO JETTISON-SAFE Switch")
defineToggleSwitch("HIDE_STICK_SW", 14, 10141, 153, "Mechanical Systems", "Hide Stick Toggle")

--Fuel Systems
defineTumb("DROP_PRESS_REFUEL", 17, 3144, 101, 1, {-1,1}, nil, false, "Fuel Systems", "Drop Tanks Pressurization and Flight Refuel Switch")
defineTumb("EMERG_TRANS_FUEL_DUMP", 17, 3143, 103, 1, {-1,1}, nil, false, "Fuel Systems", "Emergency Transfer and Wing Fuel Dump Switch")
defineToggleSwitch("FUEL_CONTROL", 17, 3145, 104, "Fuel Systems", "Fuel Control Switch")
defineToggleSwitch("MAN_FUEL_OFF_LV", 17, 3146, 130, "Fuel Systems", "Manual Fuel Shutoff Lever")
defineToggleSwitch("MAN_FUEL_OFF_CATCH", 17, 3147, 131, "Fuel Systems", "Manual Fuel Shutoff Catch")

-- OXYGEN and ANTI-G PANEL
defineToggleSwitch("OXY_SW", 21, 3138, 125, "Avionics", "Oxygen Switch")

--Avionics
definePushButton("ACCEL_RESET", 21, 3111, 139, "Avionics", "Reset Accelerometer")
definePushButton("STOPWATCH", 5, 3105, 146, "Clock", "Stopwatch Start/Stop")
definePushButton("RADAR_ALT_SW", 16, 3038, 603, "Avionics", "Radar Altitude Warning Button")
defineRotary("RADAR_ALT_INDEX", 16, 3037, 602, "Avionics", "Radar Altitude Warning Knob")
definePushButton("STBY_ATT_INDEX_BTN", 21, 3042, 663, "Avionics", "Standby Attitude Horizon Button")
defineRotary("STBY_ATT_INDEX_KNB", 21, 3043, 662, "Avionics", "Standby Attitude Horizon Knob")
definePushButton("FUEL_EXT_BTN", 21, 3018, 720, "Avionics", "Show EXT Fuel")
definePushButton("MASTER_TEST", 21, 3039, 723, "Avionics", "Master Test")
defineRotary("ALT_PRESS_KNB", 21, 3019, 827, "Avionics", "Altimeter Setting")
definePushButton("IAS_INDEX_BTN", 21, 3040, 885, "Avionics", "IAS Index Button")
definePotentiometer("IAS_INDEX_KNB", 21, 3041, 884, {0,1}, "Avionics", "IAS Index Knob")
definePotentiometer("AOA_INDEX_DIM", 21, 3164, 853, {-1,1}, "Avionics", "AOA Indexer Dimming Wheel")

--Gunsight
defineRotary("GUNSIGHT_BRIGHT", 19, 3030, 895, "Gunsight", "Gunsight Light Control")
defineToggleSwitch("GUNSIGHT_DAY_NIGHT", 19, 3029, 891, "Gunsight", "Gunsight Day/Night Switch")
definePotentiometer("GUNSIGHT_KNB", 19, 3028, 892, {0,1}, "Gunsight", "Gunsight Elevation Control")

--TACAN
defineMultipositionSwitch("TACAN_MODE", 20, 3069, 900, 4, 0.1, "TACAN", "TACAN Mode")
defineMultipositionSwitch("TACAN_CHAN_MAJ", 20, 3070, 901, 13, 0.05, "TACAN", "TACAN Channel Major")
defineMultipositionSwitch("TACAN_CHAN_MIN", 20, 3071, 902, 10, 0.1, "TACAN", "TACAN Channel Minor")
definePotentiometer("TACAN_VOL", 20, 3072, 903, {-1,1}, "TACAN", "TACAN Volume")

--Doppler Navigation Computer
defineMultipositionSwitch("DOPPLER_SEL", 20, 3045, 170, 5, 0.1, "DopplerNav", "APN-153 Doppler Radar Mode")
definePushButton("DOPPLER_MEM_TEST", 20, 3046, 247, "DopplerNav", "APN-153 Memory Light Test")
defineMultipositionSwitch("NAV_SEL", 20, 3047, 176, 5, 0.1, "DopplerNav", "ASN-41 Function Selector Switch")
defineRotary("PPOS_LAT_KNB", 20, 3051, 177, "DopplerNav Position", "ASN-41 Present Position - Latitude Knob")
definePushButton("PPOS_LAT_BTN", 20, 3150, 236, "DopplerNav Position", "ASN-41 Present Position - Latitude Button")
defineRotary("PPOS_LON_KNB", 20, 3052, 183, "DopplerNav Position", "ASN-41 Present Position - Longitude Knob")
definePushButton("PPOS_LON_BTN", 20, 3151, 237, "DopplerNav Position", "ASN-41 Present Position - Longitude Button")
defineRotary("DEST_LAT_KNB", 20, 3053, 190, "DopplerNav Destination", "ASN-41 Destination - Latitude Knob")
definePushButton("DEST_LAT_BTN", 20, 3152, 238, "DopplerNav Destination", "ASN-41 Destination - Latitude Button")
defineRotary("DEST_LON_KNB", 20, 3054, 196, "DopplerNav Destination", "ASN-41 Destination - Longitude Knob")
definePushButton("DEST_LON_BTN", 20, 3153, 239, "DopplerNav Destination", "ASN-41 Destination - Longitude Button")
defineRotary("ASN41_MAGVAR_KNB", 20, 3048, 203, "DopplerNav", "ASN-41 Magnetic Variation Knob")
definePushButton("ASN41_MAGVAR_BTN", 20, 3154, 240, "DopplerNav", "ASN-41 Magnetic Variation Button")
defineRotary("ASN41_WINDSPEED_KNB", 20, 3049, 209, "DopplerNav", "ASN-41 Wind Speed Knob")
definePushButton("ASN41_WINDSPEED_BTN", 20, 3155, 241, "DopplerNav", "ASN-41 Wind Speed Button")
defineRotary("ASN41_WINDDIR_KNB", 20, 3050, 213, "DopplerNav", "ASN-41 Wind Direction Knob")
definePushButton("ASN41_WINDDIR_BTN", 20, 3156, 242, "DopplerNav", "ASN-41 Wind Bearing Button")

--Lights
defineMultipositionSwitch("LIGHT_EXT_MASTER", 24, 3073, 83, 3, 1, "Lights", "Master Lighting ON/OFF/Momentary")
defineMultipositionSwitch("LIGHT_EXT_PROBE", 24, 3074, 217, 3, 1, "Lights", "Probe Light")
defineToggleSwitch("LIGHT_EXT_TAXI", 24, 3075, 218, "Lights", "Taxi Light")
defineToggleSwitch("LIGHT_EXT_ANTICOLL", 24, 3076, 219, "Lights", "Anti-Collision Lights")
defineMultipositionSwitch("LIGHT_EXT_FUSELAGE", 24, 3077, 220, 3, 1, "Lights", "Fuselage Lights")
defineToggleSwitch("LIGHT_EXT_FLASH_MODE", 24, 3078, 221, "Lights", "Lighting Flash/Steady Mode")
defineMultipositionSwitch("LIGHT_EXT_NAV", 24, 3079, 222, 3, 1, "Lights", "Navigation Lights")
defineMultipositionSwitch("LIGHT_EXT_TAIL", 24, 3080, 223, 3, 1, "Lights", "Tail Light")
definePotentiometer("LIGHT_INT_INSTR", 21, 3082, 106, {0,1}, "Lights", "Instrument Lighting")
definePotentiometer("LIGHT_INT_CONSOLE", 21, 3083, 107, {0,1}, "Lights", "Console Lighting")
defineMultipositionSwitch("LIGHT_INT_BRIGHT", 24, 3084, 108, 3, 1, "Lights", "Console Light Intensity")
definePotentiometer("LIGHT_INT_FLOOD_WHT", 21, 3081, 110, {0,1}, "Lights", "White FloodLight Control")

--UHF Radio
defineMultipositionSwitch("ARC51_FREQ_PRE", 27, 3101, 361, 20, 0.05, "UHF Radio", "ARC-51 UHF Preset Channel")
definePotentiometer("ARC51_VOL", 27, 3099, 365, {0,1}, "UHF Radio", "ARC-51 UHF Volume")
defineMultipositionSwitch("ARC51_XMIT_MODE", 27, 3098, 366, 3, 1, "UHF Radio", "ARC-51 UHF Frequency Mode")
defineMultipositionSwitch("ARC51_FREQ_10MHZ", 27, 3102, 367, 18, 0.05, "UHF Radio", "ARC-51 UHF Manual Frequency 10 MHz")
defineMultipositionSwitch("ARC51_FREQ_1MHZ", 27, 3103, 368, 10, 0.1, "UHF Radio", "ARC-51 UHF Manual Frequency 1 MHz")
defineMultipositionSwitch("ARC51_FREQ_50KHZ", 27, 3104, 369, 20, 0.05, "UHF Radio", "ARC-51 UHF Manual Frequency 50 kHz")
...
--T Handles
defineToggleSwitch("EMERG_GEAR_REL", 12, 3036, 1240, "T Handles", "Emergency Gear Release")
defineToggleSwitch("EMERG_BOMB_REL", 2, 3027, 1241, "T Handles", "Emergency Bomb Release")
defineToggleSwitch("EMERG_GEN_DEPLOY", 3, 3023, 1243, "T Handles", "Emergency Generator Deploy")
defineToggleSwitch("EMERG_GEN_BYPASS", 3, 3022, 1061, "T Handles", "Emergency Generator Bypass")
defineToggleSwitch("MAN_FLIGHT_CONTROL", 4, 3136, 1242, "T Handles", "Manual Flight Control Override")
...
--ECM Panel
defineToggleSwitch("ECM_AUDIO", 33, 3114, 503, "ECM Panel", "Audio APR/25 - APR/27")
defineToggleSwitch("ECM_APR25_PW", 33, 3113, 504, "ECM Panel", "APR/25 On/Off")
defineToggleSwitch("ECM_APR27_PW", 33, 3115, 501, "ECM Panel", "APR/27 On/Off")
definePushButton("ECM_APR27_TEST", 33, 3116, 507, "ECM Panel", "APR/27 Test")
definePushButton("ECM_APR27_LIGHT", 33, 3117, 510, "ECM Panel", "APR/27 Light")
definePotentiometer("ECM_PRF_VOL", 33, 3118, 506, {-0.8,0.8}, "ECM Panel", "PRF Volume (Inner Knob)")
definePotentiometer("ECM_MSL_VOL", 33, 3119, 505, {-0.8,0.8}, "ECM Panel", "MSL Volume (Outer Knob)")
defineMultipositionSwitch("ECM_SEL", 33, 3120, 502, 4, 0.33, "ECM Panel", "ECM Selector Knob")

--AIR CONDITIONING PANEL
defineToggleSwitch("CABIN_PRESS", 3, 3133, 224, "Air Condition", "Cabin Pressure Switch")
defineTumb("WINDSHLD_DEFROST", 3, 3134, 225, 1, {-1,1}, nil, false, "Air Condition", "Windshield Defrost")
definePotentiometer("CABIN_TEMP", 3, 3135, 226, {0,1}, "Air Condition", "Cabin Temp Knob")

--EJECTION SEAT
defineToggleSwitch("HARNESS_REEL_CONTR", 21, 3148, 24, "Ejection Seat", "Shoulder Harness Inertia Reel Control")
defineToggleSwitch("SEC_EJECT_HANDLE", 21, 3149, 25, "Ejection Seat", "Secondary Ejection Handle")
