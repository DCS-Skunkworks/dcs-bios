...
definePotentiometer("RADAR_ANGLE", 9, 3065, 122, {0,1}, "RadarControlPanel", "Radar Antenna Elevation")
definePotentiometer("RADAR_VOL", 9, 3068, 123, {-1,1}, "RadarControlPanel", "Radar Warning Volume")
...
defineRotary("PPOS_LAT_KNB", 22, 3051, 177, "DopplerNav Position", "ASN-41 Present Position - Latitude Knob")
definePushButton("PPOS_LAT_BTN", 22, 3150, 236, "DopplerNav Position", "ASN-41 Present Position - Latitude Button")
defineRotary("PPOS_LON_KNB", 22, 3052, 183, "DopplerNav Position", "ASN-41 Present Position - Longitude Knob")
definePushButton("PPOS_LON_BTN", 22, 3151, 237, "DopplerNav Position", "ASN-41 Present Position - Longitude Button")
defineRotary("DEST_LAT_KNB", 22, 3053, 190, "DopplerNav Destination", "ASN-41 Destination - Latitude Knob")
definePushButton("DEST_LAT_BTN", 22, 3152, 238, "DopplerNav Destination", "ASN-41 Destination - Latitude Button")
defineRotary("DEST_LON_KNB", 22, 3054, 196, "DopplerNav Destination", "ASN-41 Destination - Longitude Knob")
definePushButton("DEST_LON_BTN", 22, 3153, 239, "DopplerNav Destination", "ASN-41 Destination - Longitude Button")
...
defineToggleSwitch("EMERG_GEN_BYPASS", 2, 3022, 1061, "T Handles", "Emergency Generator Bypass")
