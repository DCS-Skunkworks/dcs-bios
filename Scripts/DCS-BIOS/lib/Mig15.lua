...
-- ASP-3N Gunsight
defineToggleSwitch("ASP3_MODE", 25, 3003, 101, "ASP-3N Gunsight", "ASP-3N Gunsight Mode")
defineToggleSwitch("ASP3_MASK_LEVER", 25, 3011, 106, "ASP-3N Gunsight", "ASP-3N Gunsight Fixed Reticle Mask Lever")
definePotentiometer("ASP3_WINGSPAN_ADJ", 25, 3001, 103, {-0.5, 1.0}, "ASP-3N Gunsight", "ASP-3N Gunsight Target Wingspan Adjustment Dial")
...
defineTumb("ARC5_BAND", 28, 3004, 177, 0.5, {0.0, 1.0}, nil, false,"ARC-5" ,"ARC-5 Frequency Band Switch")
defineTumb("ARC5_SELECT", 28, 3003, 174, 0.1, {0.0, 0.4}, nil, false,"ARC-5" ,"ARC-5 Function Selector Switch")
define3PosTumb("ARC5_LOOP", 28, 3006, 178, "ARC-5", "ARC-5 LOOP L-R Switch")
definePotentiometer("ARC5_TUNE", 28, 3005, 175, {0.0, 1.0}, "ARC-5 Tuning Crank")
definePotentiometer("ARC5_LIGHT", 28, 3007, 181, {0.0, 1.0}, "ARC-5", "ARC-5 Scale Light Knob")
defineToggleSwitch("ARC5_TGL_TFL", 28, 3002, 173, "ARC-5", "ARC-5 TLG-TLF Switch")
definePushButton("ARC5_CONTROL", 28, 3008, 182, "ARC-5", "ARC-5 Take Control Button")
defineToggleSwitch("ARC5_NEAR_FAR_NBD", 28, 3009, 123, "ARC-5", "ARC-5 Near/Far NDB Switch")
...
defineRotary("RSI6K_TRAS_FREQ", 29, 3004, 232, "RSI-6K", "RSI-6K Wave Control Handle")
defineRotary("RSI6K_ANT_FREQ", 29, 3006, 230, "RSI-6K", "RSI-6K Antenna Control Handle")
defineRotary("RSI6K_TRAS_FREQ_FIX", 29, 3006, 233, "RSI-6K", "RSI-6K Wave Control Handle")
defineRotary("RSI6K_ANT_FREQ_FIX", 29, 3007, 231, "RSI-6K", "RSI-6K Antenna Control Handle")
defineRotary("RSI6K_RECEIVE_FREQ", 29, 3003, 128, "RSI-6K", "RSI-6K Receiver Tuning Knob")
