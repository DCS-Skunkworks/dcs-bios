...
defineToggleSwitch("FL_TR_HOR_PWR_ON",1, 3005, 141, "Electric System", "Flaps, Trimmer, Artificial Horizon Power CB On")
definePushButton("FL_TR_HOR_PWR_OFF",1, 3018, 142, "Electric System", "Flaps, Trimmer, Artificial Horizon Power CB Off")
defineToggleSwitch("LG_PWF_ON",1, 3006, 143, "Electric System", "Landing Gear Power CB On")
definePushButton("LG_PWF_OFF",1, 3019, 144, "Electric System", "Landing Gear Power CB Off")
defineToggleSwitch("PIT_HEAT_ON",1, 3007, 145, "Electric System", "Pitot and Heating Cover CB On")
definePushButton("PIT_HEAT_OFF",1, 3020, 146, "Electric System", "Pitot and Heating Cover CB Off")
...
defineToggleSwitch("INST_LGHTS_ON",1, 3010, 151, "Electric System", "Instrument Lights, Gun-sight, Indicators, Compass, Starter CB On")
definePushButton("INST_LGHTS_OFF",1, 3023, 152, "Electric System", "Instrument Lights, Gun-sight, Indicators, Compass, Starter CB Off")
defineToggleSwitch("GEN_PWR_ON",1, 3011, 153, "Electric System", "Generator CB On")
definePushButton("GEN_PWR_OFF",1, 3024, 154, "Electric System", "Generator CB Off")
defineToggleSwitch("BATT_ON",1, 3012, 155, "Electric System", "Battery CB On")
definePushButton("BATT_OFF",1, 3025, 156, "Electric System", "Battery CB Off")
defineToggleSwitch("NAV_LGHTS_ON",1, 3013, 121, "Electric System", "Navigation Lights CB On")
definePushButton("NAV_LGHTS_OFF",1, 3026, 120, "Electric System", "Navigation Lights CB Off")
defineToggleSwitch("FW_TNK_PMP_ON",1, 3014, 123, "Electric System", "Forward Tank Pump CB On")
definePushButton("FW_TNK_PMP_OFF",1, 3027, 122, "Electric System", "Forward Tank Pump CB Off")
defineToggleSwitch("AFT_TNK_PMP_ON",1, 3015, 125, "Electric System", "Aft Tank Pump CB On")
definePushButton("AFT_TNK_PMP_OFF",1, 3028, 124, "Electric System", "Aft Tank Pump CB Off")
defineToggleSwitch("AUX_TNK_PMP_ON",1, 3016, 127, "Electric System", "Auxiliary Tank Pump CB On")
definePushButton("AUX_TNK_PMP_OFF",1, 3029, 126, "Electric System", "Auxiliary Tank Pump CB Off")
defineToggleSwitch("MW50_ON",1, 3017, 129, "Electric System", "MW-50 CB On")
definePushButton("MW50_OFF",1, 3030, 128, "Electric System", "MW-50 CB Off")
