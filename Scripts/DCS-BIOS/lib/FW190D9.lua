...
defineIndicatorLight("GUN_FIRE_1", 50, {0.0, 1.0}, "Indicator", "Gun_Fire_1")
defineIndicatorLight("GUN_FIRE_2", 164, {0.0, 1.0}, "Indicator", "Gun_Fire_2")
defineIndicatorLight("GUN_FIRE_3", 165, {0.0, 1.0}, "Indicator", "Gun_Fire_3")
defineIndicatorLight("GUN_FIRE_4", 166, {0.0, 1.0}, "Indicator", "Gun_Fire_4")
defineFloat("TARGETDIST", 133, {0.0, 1.0}, "Indicator", "TargetDist")
defineIndicatorLight("BOMB_LAMP_1", 196, {0.0, 1.0}, "Indicator", "Bomb_Lamp_1")
defineIndicatorLight("BOMB_LAMP_2", 197, {0.0, 1.0}, "Indicator", "Bomb_Lamp_2")
defineIndicatorLight("BOMB_LAMP_3", 198, {0.0, 1.0}, "Indicator", "Bomb_Lamp_3")
defineIndicatorLight("BOMB_LAMP_4", 199, {0.0, 1.0}, "Indicator", "Bomb_Lamp_4")
