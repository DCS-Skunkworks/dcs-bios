...
defineIndicatorLight("PLT_DC_SOCK_ON", 64, "Engine Lights","PILOT DC Socket ON Light (yellow)")
defineIndicatorLight("PLT_AC_SOCK_ON", 86, "Engine Lights","PILOT AC Socket ON Light (yellow)")
defineIndicatorLight("PLT_PO750A_ON", 92, "Engine Lights","PILOT PO750A ON Light (yellow)")
defineIndicatorLight("PLT_PT125TS_OFF", 93, "Engine Lights","PILOT PT125TS OFF Light (yellow)")
...
defineIndicatorLight("PLT_PUVL_L_USLP_LOAD", 533, "PUVL Lights", "PILOT PUVL USLP Loaded Light (yellow)")
defineIndicatorLight("PLT_PUVL_L_USLP_FINISHED", 532, "PUVL Lights", "PILOT PUVL USLP Finished Light (yellow)")
defineIndicatorLight("PLT_PUVL_L_LH_SIDE", 535, "PUVL Lights", "PILOT PUVL LH Side Light (yellow)")
defineIndicatorLight("PLT_PUVL_L_RH_SIDE", 534, "PUVL Lights", "PILOT PUVL RH Side Light (yellow)")
...
defineIndicatorLight("PLT_ASP17_L_KMG", 559, "ASP17 Lights", "PILOT ASP17 KMG (USLP) Light (yellow)")
defineIndicatorLight("PLT_ASP17_L_GUV", 560, "ASP17 Lights", "PILOT ASP17 GUV (FXD MG) Light (yellow)")
defineIndicatorLight("PLT_ASP17_L_BOMBS", 561, "ASP17 Lights", "PILOT ASP17 BOMBS Light (yellow)")
defineIndicatorLight("PLT_ASP17_L_30", 562, "ASP17 Lights", "PILOT ASP17 30 Light (yellow)")
defineIndicatorLight("PLT_ASP17_L_NRS", 563, "ASP17 Lights", "PILOT ASP17 NRS (RKT) Light (yellow)")
...
defineToggleSwitch("PLT_DISS_DVS", 8, 3002, 370, "DISS-15", "PILOT Airspeed to DISS-15 ON/OFF")
definePushButton("PLT_DISS_COORD_OFF", 8, 3003, 818, "DISS-15", "PILOT DISS-15 coordinates OFF")
definePushButton("PLT_DISS_COORD_ON", 8, 3004, 819, "DISS-15", "PILOT DISS-15 coordinates ON")
definePushButton("PLT_DISS_DEC_MAPANGLE", 8, 3005, 815, "DISS-15", "PILOT DISS-15 decrease map angle")
definePushButton("PLT_DISS_INC_MAPANGLE", 8, 3006, 816, "DISS-15", "PILOT DISS-15 increase map angle")
definePushButton("PLT_DISS_DEC_PATH", 8, 3007, 809, "DISS-15", "PILOT DISS-15 decrease path")
definePushButton("PLT_DISS_INC_PATH", 8, 3008, 810, "DISS-15", "PILOT DISS-15 increase path")
definePushButton("PLT_DISS_DEC_DEVIATION", 8, 3009, 803, "DISS-15", "PILOT DISS-15 decrease deviation")
definePushButton("PLT_DISS_INC_DEVIATION", 8, 3010, 804, "DISS-15", "PILOT DISS-15 increase deviation")
defineToggleSwitch("PLT_DISS_MODE_WORK", 8, 3011, 797, "DISS-15", "PILOT DISS-15 Mode WORK/CHECK")
defineToggleSwitch("PLT_DISS_MODE_LAND", 8, 3012, 798, "DISS-15", "PILOT DISS-15 Mode LAND/SEA")
defineMultipositionSwitch("PLT_DISS_SEL_KNB", 8, 3013, 826, 5, 0.1, "DISS-15", "PILOT DISS-15 select mode IDK/IDK/IDK/MEM/OPER")

defineFloat("PLT_DISS_HOVER_X", 830, {-1, 1}, "DISS-15 Gauges", "PILOT DISS-15 Hover X Indicator")
defineFloat("PLT_DISS_HOVER_Y", 828, {-1, 1}, "DISS-15 Gauges", "PILOT DISS-15 Hover Y Indicator")
defineFloat("PLT_DISS_HOVER_Z", 829, {-1, 1}, "DISS-15 Gauges", "PILOT DISS-15 Hover Z Indicator")
defineFloat("PLT_DISS_DRIFT", 791, {-1, 1}, "DISS-15 Gauges", "PILOT DISS-15 Drift Angle")
defineFloat("PLT_DISS_W_SHUTTER", 795, {0, 1}, "DISS-15 Gauges", "PILOT DISS-15 W Shutter")
defineFloat("PLT_DISS_W_100", 792, {0, 1}, "DISS-15 Gauges", "PILOT DISS-15 W 100")
defineFloat("PLT_DISS_W_10", 793, {0, 1}, "DISS-15 Gauges", "PILOT DISS-15 W 10")
defineFloat("PLT_DISS_W_1", 794, {0, 1}, "DISS-15 Gauges", "PILOT DISS-15 W 1")
defineFloat("PLT_COORD_FWD", 805, {1, 0}, "DISS-15 Gauges", "PILOT DISS-15 Coord Forward")
defineFloat("PLT_COORD_R", 802, {1, 0}, "DISS-15 Gauges", "PILOT DISS-15 Coord Right")
defineFloat("PLT_COORD_X_100", 806, {0, 1}, "DISS-15 Gauges", "PILOT DISS-15 Coord X 100")
defineFloat("PLT_COORD_X_10", 807, {0, 1}, "DISS-15 Gauges", "PILOT DISS-15 Coord X 10")
defineFloat("PLT_COORD_X_1", 808, {0, 1}, "DISS-15 Gauges", "PILOT DISS-15 Coord X 1")
defineFloat("PLT_COORD_Z_100", 799, {0, 1}, "DISS-15 Gauges", "PILOT DISS-15 Coord Z 100")
defineFloat("PLT_COORD_Z_10", 800, {0, 1}, "DISS-15 Gauges", "PILOT DISS-15 Coord Z 10")
defineFloat("PLT_COORD_Z_1", 801, {0, 1}, "DISS-15 Gauges", "PILOT DISS-15 Coord Z 1")
defineFloat("PLT_COORD_ANG_100", 811, {0, 1}, "DISS-15 Gauges", "PILOT DISS-15 Coord Angle 100")
defineFloat("PLT_COORD_ANG_10", 812, {0, 1}, "DISS-15 Gauges", "PILOT DISS-15 Coord Angle 10")
defineFloat("PLT_COORD_ANG_1", 813, {0, 1}, "DISS-15 Gauges", "PILOT DISS-15 Coord Angle 1")
defineFloat("PLT_COORD_ANG_M", 814, {0, 1}, "DISS-15 Gauges", "PILOT DISS-15 Coord Angle Minutes")

defineIndicatorLight("PLT_DISS_HOVER_LAMP", 831, "DISS-15 Lights", "PILOT DISS-15 Hover Light (red)")
defineIndicatorLight("PLT_DISS_W_MEMORY_LAMP", 975, "DISS-15 Lights", "PILOT DISS-15 W Memory Light (green)")
defineIndicatorLight("PLT_DISS_COORD_LAMP", 817, "DISS-15 Lights", "PILOT DISS-15 Coord ON Light (yellow)")
defineIndicatorLight("PLT_DISS_CHK_WORK_LAMP", 823, "DISS-15 Lights", "PILOT DISS-15 Check Work Light (green)")
defineIndicatorLight("PLT_DISS_CHK_FAILM_LAMP", 824, "DISS-15 Lights", "PILOT DISS-15 Check Fail M Light (red)")
defineIndicatorLight("PLT_DISS_CHK_FAILC_LAMP", 825, "DISS-15 Lights", "PILOT DISS-15 Check Fail C Light (red)")
...
defineIndicatorLight("OP_GYRO2_FAIL", 320, "Warning, Caution and IndicatorLights OP","OPERATOR failure Gyro 2 Lamp (red)")
...
defineIndicatorLight("PLT_L_VU_OFF", 63, "Warning, Caution and IndicatorLights PLT","PILOT Left VU OFF (yellow)")
defineIndicatorLight("PLT_R_VU_OFF", 64, "Warning, Caution and IndicatorLights PLT","PILOT Right VU OFF (yellow)")
