...
defineIndicatorLight("PLT_PUVL_EXPL_ARM_L", 548, "PUVL Lights", "PILOT PUVL Explosion on Jettison ARMED Light (red)")
defineIndicatorLight("PLT_PUVL_PYLON_1_L", 544, "PUVL Lights", "PILOT PUVL Pylon 1 Light (yellow)")
defineIndicatorLight("PLT_PUVL_PYLON_2_L", 543, "PUVL Lights", "PILOT PUVL Pylon 2 Light (yellow)")
defineIndicatorLight("PLT_PUVL_PYLON_3_L", 540, "PUVL Lights", "PILOT PUVL Pylon 3 Light (yellow)")
defineIndicatorLight("PLT_PUVL_PYLON_4_L", 539, "PUVL Lights", "PILOT PUVL Pylon 4 Light (yellow)")
defineIndicatorLight("PLT_PUVL_USLP_LOAD_L", 533, "PUVL Lights", "PILOT PUVL USLP Loaded Light (yellow)")
defineIndicatorLight("PLT_PUVL_USLP_FINISHED_L", 532, "PUVL Lights", "PILOT PUVL USLP Finished Light (yellow)")
defineIndicatorLight("PLT_PUVL_LH_SIDE_L", 535, "PUVL Lights", "PILOT PUVL LH Side Light (yellow)")
defineIndicatorLight("PLT_PUVL_RH_SIDE_L", 534, "PUVL Lights", "PILOT PUVL RH Side Light (yellow)")
...
defineIndicatorLight("PLT_DISS_HOVER_L", 831, "DISS-15 Lights", "PILOT DISS-15 Hover Light (red)")
defineIndicatorLight("PLT_DISS_W_MEMORY_L", 975, "DISS-15 Lights", "PILOT DISS-15 W Memory Light (green)")
defineIndicatorLight("PLT_DISS_COORD_L", 817, "DISS-15 Lights", "PILOT DISS-15 Coord ON Light (yellow)")
defineIndicatorLight("PLT_DISS_CHK_WORK_L", 823, "DISS-15 Lights", "PILOT DISS-15 Check Work Light (green)")
defineIndicatorLight("PLT_DISS_CHK_FAILM_L", 824, "DISS-15 Lights", "PILOT DISS-15 Check Fail M Light (red)")
defineIndicatorLight("PLT_DISS_CHK_FAILC_L", 825, "DISS-15 Lights", "PILOT DISS-15 Check Fail C Light (red)")
