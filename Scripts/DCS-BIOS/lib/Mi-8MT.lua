...
defineTumb("INV_115V_SWITCH", 1, start_command + 12, 541, 1, {-1, 1}, nil, false, "Electrical system", "Inverter Switch 115V MANUAL/OFF/AUTO")
defineTumb("INV_36V_SWITCH", 1, start_command + 13, 542, 1, {-1, 1}, nil, false, "Electrical system", "Inverter Switch 36V MANUAL/OFF/AUTO")
...
defineTumb("TRANS_36V_SWITCH", 1, start_command + 20, 149, 1, {-1, 1}, nil, false, "Electrical system", "Transformer Switch 36V, MAIN/OFF/AUXILIARY")
...
definePotentiometer("LGHT_55V",46, start_command + 11, 924, {0.0, 1.0},"Lights", "Lights Brightness 5.5V Rheostat")
