...
--System Page Buttons
definePushButton("SYS_NAV_BTN", 4, 3001, 0, "System Page", "System Page - Navigation Lights")
definePushButton("SYS_FLOOD_BTN", 4, 3012, 0, "System Page", "System Page - Flood Lights")
...
defineToggleSwitch("CONF_CUSTOM_1_BTN", 8, 3010, 0, "Config Page", "Config Page - Attach/Remove Winglets")
defineToggleSwitch("CONF_CUSTOM_2_BTN", 8, 3011, 0, "Config Page", "Config Page - Attach/Remove Spades")
defineToggleSwitch("CONF_CUSTOM_3_BTN", 8, 3012, 0, "Config Page", "Config Page - Attach/Remove Lights")
defineTumb("CONF_PILOT_SEL", 8, 3013, 0, 0.1, {0.0, 0.6}, nil, false, "Config Page", "Config Page - Select Pilot")
