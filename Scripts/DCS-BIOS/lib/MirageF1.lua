...
--TACAN Control Box
definePushButton("P_TCN_TEST", 1, 3349, 480, "COMMON TACAN Control Box", "Pilot TACAN Test Button")
...
defineMultipositionSwitch("P_VOR_MODE", 1, 3346, 544, 3, 0.5, "COMMON VOR ILS Control Box", "Pilot VOR/ILS/OFF/TACAN Selector")
defineRotary("P_VOR_HDG_SEL", 1, 3348, 547, "COMMON VOR ILS Control Box", "Pilot Heading Selector Knob")
...
defineRotary("P_CE_NAV_BRG_DIST", 1, 3559, 1207, "CE/BE Navigation Indicator", "CE/BE Pilot Navigation Bearing/Distance Selector Knob")
definePushButton("P_CE_NAV_TEST", 1, 3560, 1208, "CE/BE Navigation Indicator", "CE/BE Pilot Navigation Test Button")
...
defineToggleSwitch("P_CE_ARM_MATRA_JETT_CV", 1, 3561, 962, "CE/BE Armament Control", "CE/BE Pilot MATRA 550 or Sidewinder Jettison Button Guard")
definePushButton("P_CE_ARM_MATRA_JETT", 1, 3562, 963, "CE/BE Armament Control", "CE/BE Pilot MATRA 550 or Sidewinder Jettison Button")
