...
-- dofile(lfs.writedir()..[[Scripts/DCS-BIOS/archive/old_format_planes/MetadataEnd.lua]])
local MetadataEnd = require "MetadataEnd"
BIOS.protocol.writeNewModule(MetadataEnd)
-- dofile(lfs.writedir()..[[Scripts/DCS-BIOS/archive/old_format_planes/MetadataStart.lua]])
local MetadataStart = require "MetadataStart"
BIOS.protocol.writeNewModule(MetadataStart)
-- dofile(lfs.writedir()..[[Scripts/DCS-BIOS/archive/old_format_planes/CommonData.lua]])
...
-- dofile(lfs.writedir()..[[Scripts/DCS-BIOS/archive/old_format_planes/A-29B.lua]]) -- ID = 41, ProperName = A-29B Super Tucano
local A_29B = require "A-29B"
BIOS.protocol.writeNewModule(A_29B)
-- dofile(lfs.writedir()..[[Scripts/DCS-BIOS/archive/old_format_planes/A-4E-C.lua]]) -- ID = 6, ProperName = A-4E Skyhawk
local A_4E_C = require "A-4E-C"
BIOS.protocol.writeNewModule(A_4E_C)
-- dofile(lfs.writedir()..[[Scripts/DCS-BIOS/archive/old_format_planes/AH-6J.lua]]) -- ID = 7, ProperName = AH-6J Littlebird
...
-- dofile(lfs.writedir()..[[Scripts/DCS-BIOS/archive/old_format_planes/Alphajet.lua]]) -- ID = 9, ProperName = Alphajet
...
-- dofile(lfs.writedir()..[[Scripts/DCS-BIOS/archive/old_format_planes/Bf-109K-4.lua]]) -- ID = 11, ProperName = Bf 109 K-4 Kurfurst
local Bf_109K_4 = require "Bf-109K-4"
BIOS.protocol.writeNewModule(Bf_109K_4)
-- dofile(lfs.writedir()..[[Scripts/DCS-BIOS/archive/old_format_planes/C-101.lua]]) -- ID = 12, ProperName = C-101 Aviojet
local C_101 = require "C-101"
BIOS.protocol.writeNewModule(C_101)
-- dofile(lfs.writedir()..[[Scripts/DCS-BIOS/archive/old_format_planes/Christen Eagle II.lua]]) -- ID = 14, ProperName = Christen Eagle II
local Christen_Eagle_II = require "Christen Eagle II"
BIOS.protocol.writeNewModule(Christen_Eagle_II)
-- dofile(lfs.writedir()..[[Scripts/DCS-BIOS/archive/old_format_planes/Edge540.lua]]) -- ID = 15, ProperName = Edge 540
local Edge540 = require "Edge540"
BIOS.protocol.writeNewModule(Edge540)
-- dofile(lfs.writedir()..[[Scripts/DCS-BIOS/archive/old_format_planes/F-14.lua]]) -- ID = 16, ProperName = F-14A/B Tomcat
...
-- dofile(lfs.writedir()..[[Scripts/DCS-BIOS/archive/old_format_planes/F-22A.lua]]) -- ID = 40, ProperName = F-22A Raptor
...
-- dofile(lfs.writedir()..[[Scripts/DCS-BIOS/archive/old_format_planes/F-86F Sabre.lua]]) -- ID = 19, ProperName = F-86F Sabre
...
-- dofile(lfs.writedir()..[[Scripts/DCS-BIOS/archive/old_format_planes/FC3.lua]]) -- ID = 4, ProperName = Flaming Cliffs 3
local FC3 = require "FC3"
BIOS.protocol.writeNewModule(FC3)
-- dofile(lfs.writedir()..[[Scripts/DCS-BIOS/archive/old_format_planes/FW-190A8.lua]]) -- ID = 21, ProperName = Fw 190 A-8 Anton
local FW_190A8 = require "FW-190A8"
BIOS.protocol.writeNewModule(FW_190A8)
-- dofile(lfs.writedir()..[[Scripts/DCS-BIOS/archive/old_format_planes/FW-190D9.lua]]) -- ID = 22, ProperName = Fw 190 D-9 Dora
local FW_190D9 = require "FW-190D9"
BIOS.protocol.writeNewModule(FW_190D9)
-- dofile(lfs.writedir()..[[Scripts/DCS-BIOS/archive/old_format_planes/I-16.lua]]) -- ID = 23, ProperName = I-16 
...
-- dofile(lfs.writedir()..[[Scripts/DCS-BIOS/archive/old_format_planes/L-39.lua]]) -- ID = 26, ProperName = L-39 Albatros
...
-- dofile(lfs.writedir()..[[Scripts/DCS-BIOS/archive/old_format_planes/Mi-24P.lua]]) -- ID = 42, ProperName = Mi-24P HIND
...
-- dofile(lfs.writedir()..[[Scripts/DCS-BIOS/archive/old_format_planes/MiG-15bis.lua]]) -- ID = 30, ProperName = MiG-15bis
local MiG_15bis = require "MiG-15bis"
BIOS.protocol.writeNewModule(MiG_15bis)
-- dofile(lfs.writedir()..[[Scripts/DCS-BIOS/archive/old_format_planes/MiG-19P.lua]]) -- ID = 31, ProperName = MiG-19P Farmer
local MiG_19P = require "MiG-19P"
BIOS.protocol.writeNewModule(MiG_19P)
-- dofile(lfs.writedir()..[[Scripts/DCS-BIOS/archive/old_format_planes/MiG-21Bis.lua]]) -- ID = 32, ProperName = MiG-21bis
...
-- dofile(lfs.writedir()..[[Scripts/DCS-BIOS/archive/old_format_planes/NS430.lua]]) -- ID = 33, ProperName = NS 430 GPS
local NS430 = require "NS430"
BIOS.protocol.writeNewModule(NS430)
-- dofile(lfs.writedir()..[[Scripts/DCS-BIOS/archive/old_format_planes/P-47D.lua]]) -- ID = 34, ProperName = P-47D Thunderbolt
local P_47D = require "P-47D"
BIOS.protocol.writeNewModule(P_47D)
-- dofile(lfs.writedir()..[[Scripts/DCS-BIOS/archive/old_format_planes/P-51D.lua]]) -- ID = 35, ProperName = TF/P-51D Mustang
...
-- dofile(lfs.writedir()..[[Scripts/DCS-BIOS/archive/old_format_planes/SpitfireLFMkIX.lua]]) -- ID = 37, ProperName = Spitfire LF Mk. IX
...
-- dofile(lfs.writedir()..[[Scripts/DCS-BIOS/archive/old_format_planes/UH-1H.lua]]) -- ID = 38, ProperName = UH-1H Huey
local UH_1H = require "UH-1H"
BIOS.protocol.writeNewModule(UH_1H)
-- dofile(lfs.writedir()..[[Scripts/DCS-BIOS/archive/old_format_planes/VNAO_Room.lua]])
local VNAO_Room = require "VNAO_Room"
BIOS.protocol.writeNewModule(VNAO_Room)
-- dofile(lfs.writedir()..[[Scripts/DCS-BIOS/archive/old_format_planes/VNAO_T-45.lua]]) -- ID = 43, ProperName = T-45 Goshawk
local VNAO_T_45 = require "VNAO_T-45"
BIOS.protocol.writeNewModule(VNAO_T_45)
-- dofile(lfs.writedir()..[[Scripts/DCS-BIOS/archive/old_format_planes/Yak-52.lua]]) -- ID = 39, ProperName = Yak-52
