...
If you don't see a `Scripts` subfolder, copy the entire `Scripts` from folder where you extracted DCS-BIOS to this directory and skip to the next step.
...
It will also interpret the data that DCS-BIOS sends to control outputs like LEDs or servo motors.
