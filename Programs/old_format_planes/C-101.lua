...
defineSpringloaded_3PosTumb("FRONT_UHF_TEST_SW", 11, 3012, 3013, 207, "UHF Radio", "C-101EB FRONT UHF Frequency/Test Switch")
...
defineIndicatorLight("CC_FRONT_WARN_LOW_FUEL", 150, "Warning, Caution and IndicatorLights", "C-101CC FRONT Warning Panel LOW FUEL Lamp (red)")
defineIndicatorLight("CC_FRONT_WARN_FIRE", 151, "Warning, Caution and IndicatorLights", "C-101CC FRONT Warning Panel FIRE Lamp (red)")
defineIndicatorLight("CC_FRONT_WARN_OXY_P", 152, "Warning, Caution and IndicatorLights", "C-101CC FRONT Warning Panel OXY PRESS Lamp (red)")
defineIndicatorLight("CC_FRONT_WARN_CANOPY", 153, "Warning, Caution and IndicatorLights", "C-101CC FRONT Warning Panel CANOPY Lamp (red)")
defineIndicatorLight("CC_FRONT_WARN_CKPT_P", 154, "Warning, Caution and IndicatorLights", "C-101CC FRONT Warning Panel CKPT RESS Lamp (red)")
defineIndicatorLight("CC_FRONT_WARN_HYD_P", 155, "Warning, Caution and IndicatorLights", "C-101CC FRONT Warning Panel HYD PRESS Lamp (red)")
defineIndicatorLight("CC_FRONT_WARN_OIL_P", 156, "Warning, Caution and IndicatorLights", "C-101CC FRONT Warning Panel OIL PRESS Lamp (red)")
defineIndicatorLight("CC_FRONT_WARN_CHP_DECT", 157, "Warning, Caution and IndicatorLights", "C-101CC FRONT Warning Panel CHP DETECT Lamp (red)")
defineIndicatorLight("CC_FRONT_WARN_BAT", 158, "Warning, Caution and IndicatorLights", "C-101CC FRONT Warning Panel BATTERY Lamp (red)")
defineIndicatorLight("CC_FRONT_WARN_GEN", 159, "Warning, Caution and IndicatorLights", "C-101CC FRONT Warning Panel GENERATOR Lamp (red)")
defineIndicatorLight("CC_FRONT_WARN_FUEL_P", 160, "Warning, Caution and IndicatorLights", "C-101CC FRONT Warning Panel FUEL PRESS Lamp (yellow)")
defineIndicatorLight("CC_FRONT_WARN_FUEL_V", 161, "Warning, Caution and IndicatorLights", "C-101CC FRONT Warning Panel FUEL VALVE Lamp (yellow)")
defineIndicatorLight("CC_FRONT_WARN_AIR", 162, "Warning, Caution and IndicatorLights", "C-101CC FRONT Warning Panel AIR COND Lamp (yellow)")
defineIndicatorLight("CC_FRONT_WARN_GEAR", 163, "Warning, Caution and IndicatorLights", "C-101CC FRONT Warning Panel GEAR^ Lamp (yellow)")
defineIndicatorLight("CC_FRONT_WARN_PITOT", 164, "Warning, Caution and IndicatorLights", "C-101CC FRONT Warning Panel PITOT HEAT Lamp (yellow)")
defineIndicatorLight("CC_FRONT_WARN_COMP", 165, "Warning, Caution and IndicatorLights", "C-101CC FRONT Warning Panel COMPUTER Lamp (yellow)")
defineIndicatorLight("CC_FRONT_WARN_AICE", 166, "Warning, Caution and IndicatorLights", "C-101CC FRONT Warning Panel ANTI-ICE Lamp (yellow)")
defineIndicatorLight("CC_FRONT_WARN_AOA", 167, "Warning, Caution and IndicatorLights", "C-101CC FRONT Warning Panel AOA/STALL Lamp (yellow)")
defineIndicatorLight("CC_FRONT_WARN_NORM", 168, "Warning, Caution and IndicatorLights", "C-101CC FRONT Warning Panel NORM INV Lamp (yellow)")
defineIndicatorLight("CC_FRONT_WARN_STBY", 169, "Warning, Caution and IndicatorLights", "C-101CC FRONT Warning Panel STBY INV Lamp (yellow)")
defineIndicatorLight("CC_FRONT_WARN_BUS_ON", 175, "Warning, Caution and IndicatorLights", "C-101CC FRONT Warning Panel Bus Transfer ON Lamp (yellow)")
