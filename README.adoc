...
Problems/Infos see our Wiki: https://github.com/DCSSKUNKWORKS/dcs-bios/wiki[DCSSKUNKWORKS DCS-BIOS Wiki]

https://github.com/DCSSKUNKWORKS/dcs-bios/blob/master/Scripts/DCS-BIOS/doc/DCS-BIOS-FLIGHTPANELS_Install%20Guide.pdf[Quick Setup Guide]
...
If you have a question or found a bug, please https://github.com/DCSSKUNKWORKS/dcs-bios/issues[open an issue on the GitHub issue tracker].
...
* Here you find our https://discord.gg/5svGwKX[DCSSKUNKWORKS Discord Server]
* Here you find the https://github.com/DCSSKUNKWORKS/DCSFlightpanels[DCSFlightpanels Software]
* Here you find the https://github.com/DCSSKUNKWORKS/DCS-Flightpanels-Profiles[DCSFlightpanels-Profiles]
* Here you find the https://github.com/DCSSKUNKWORKS/dcs-bios-arduino-library[DCSFlightpanels arduino-library]
* Here you find the https://github.com/DCSSKUNKWORKS/dcs-bios-arduino_examples[DCSFlightpanels arduino-Examples
