...
Works also for Pit Builders and Arduino users!
  ...
  If want to support us to use BIOS with new Planes! You find infos at the bottom of this page.

<p align="center">
<a href="https://www.paypal.me/FPDCSBIOS"><img src="./Scripts/DCS-BIOS/doc/images/paypal-donate-button.png" width="200"></a>
</p>
<br/>
