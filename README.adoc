...
* Christen Eagle II (contributed by BlackLibrary)
...
* UH-1H (FSF-Ian)
* Yak-52 (contributed by BlackLibrary)
* All Flaming Cliffs 3 Modules (FC3) (A-10A;F-15C;J-11A;MiG-29A;
  MiG-29S;Su-25;Su-25T;Su-27;Su-33)
* Mods (FC3 Level):All VSN-Mods, PAK-FA Project, Civil Aircraft Mod, Upuaut's Bell-47G,Mirage F.1
  
  
  But they are only supported with Keyemulator and CommonData export like ALT, HDG,... 
